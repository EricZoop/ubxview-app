...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Fo(){return new ke({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ga(),fragmentShader:`
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Oo(){return new ke({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ga(),fragmentShader:`
	...
	`}function Yf(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Zs||l===js,d=l===wi||l===Ci;if(c||d){let f=t.get(o);const p=f!==void 0?f.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==p)return e===null&&(e=new Uo(i)),f=c?e.fromEquirectangular(o,f):e.fromCubemap(o,f),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),f.texture;if(f!==void 0)return f.texture;{const m=o.image;return c&&m&&m.height>0||d&&m&&r(m)?(e===null&&(e=new Uo(i)),f=c?e.fromEquirectangular(o):e.fromCubemap(o),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),o.addEventListener("dispose",s),f.texture):null}}}return o}function r(o){let l=0;const c=6;for(let d=0;d<c;d++)o[d]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function Kf(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&Dl("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Zf(i,t,e,n){const r={},s=new WeakMap;function a(f){const p=f.target;p.index!==null&&t.remove(p.index);for(const g in p.attributes)t.remove(p.attributes[g]);for(const g in p.morphAttributes){const _=p.morphAttributes[g];for(let h=0,u=_.length;h<u;h++)t.remove(_[h])}p.removeEventListener("dispose",a),delete r[p.id];const m=s.get(p);m&&(t.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,e.memory.geometries--}function o(f,p){return r[p.id]===!0||(p.addEventListener("dispose",a),r[p.id]=!0,e.memory.geometries++),p}function l(f){const p=f.attributes;for(const g in p)t.update(p[g],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const g in m){const _=m[g];for(let h=0,u=_.length;h<u;h++)t.update(_[h],i.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,g=f.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let y=0,T=E.length;y<T;y+=3){const B=E[y+0],w=E[y+1],b=E[y+2];p.push(B,w,w,b,b,B)}}else if(g!==void 0){const E=g.array;_=g.version;for(let y=0,T=E.length/3-1;y<T;y+=3){const B=y+0,w=y+1,b=y+2;p.push(B,w,w,b,b,B)}}else return;const h=new(Ll(p)?Bl:Ol)(p,1);h.version=_;const u=s.get(f);u&&t.remove(u),s.set(f,h)}function d(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:d}}function jf(i,t,e){let n;function r(p){n=p}let s,a;function o(p){s=p.type,a=p.bytesPerElement}function l(p,m){i.drawElements(n,m,s,p*a),e.update(m,n,1)}function c(p,m,g){g!==0&&(i.drawElementsInstanced(n,m,s,p*a,g),e.update(m,n,g))}function d(p,m,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let h=0;h<g;h++)this.render(p[h]/a,m[h]);else{_.multiDrawElementsWEBGL(n,m,0,s,p,0,g);let h=0;for(let u=0;u<g;u++)h+=m[u];e.update(h,n,1)}}function f(p,m,g,_){if(g===0)return;const h=t.get("WEBGL_multi_draw");if(h===null)for(let u=0;u<p.length;u++)c(p[u]/a,m[u],_[u]);else{h.multiDrawElementsInstancedWEBGL(n,m,0,s,p,0,_,0,g);let u=0;for(let E=0;E<g;E++)u+=m[E];for(let E=0;E<_.length;E++)e.update(u,n,_[E])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=f}function Jf(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function Qf(i,t,e){const n=new WeakMap,r=new ce;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=d!==void 0?d.length:0;let p=n.get(o);if(p===void 0||p.count!==f){let x=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;p!==void 0&&p.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,h=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],E=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let T=0;g===!0&&(T=1),_===!0&&(T=2),h===!0&&(T=3);let B=o.attributes.position.count*T,w=1;B>t.maxTextureSize&&(w=Math.ceil(B/t.maxTextureSize),B=t.maxTextureSize);const b=new Float32Array(B*w*4*f),I=new Ul(b,B,w,f);I.type=Tn,I.needsUpdate=!0;const v=T*4;for(let C=0;C<f;C++){const z=u[C],F=E[C],X=y[C],q=B*w*4*C;for(let W=0;W<z.count;W++){const Y=W*v;g===!0&&(r.fromBufferAttribute(z,W),b[q+Y+0]=r.x,b[q+Y+1]=r.y,b[q+Y+2]=r.z,b[q+Y+3]=0),_===!0&&(r.fromBufferAttribute(F,W),b[q+Y+4]=r.x,b[q+Y+5]=r.y,b[q+Y+6]=r.z,b[q+Y+7]=0),h===!0&&(r.fromBufferAttribute(X,W),b[q+Y+8]=r.x,b[q+Y+9]=r.y,b[q+Y+10]=r.z,b[q+Y+11]=X.itemSize===4?r.w:1)}}p={count:f,texture:I,size:new zt(B,w)},n.set(o,p),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let g=0;for(let h=0;h<c.length;h++)g+=c[h];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",p.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}return{update:s}}function tp(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,d=l.geometry,f=t.get(l,d);if(r.get(f)!==c&&(t.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class Vl extends ge{constructor(t,e,n,r,s,a,o,l,c,d=yi){if(d!==yi&&d!==Li)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===yi&&(n=Ri),n===void 0&&d===Li&&(n=Pi),super(null,r,s,a,o,l,d,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ue,this.minFilter=l!==void 0?l:Ue,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Wl=new ge,Xl=new Vl(1,1);Xl.compareFunction=Pl;const ql=new Ul,$l=new zd,Yl=new Gl,Bo=[],zo=[],Ho=new Float32Array(16),Go=new Float32Array(9),ko=new Float32Array(4);function Fi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=Bo[r];if(s===void 0&&(s=new Float32Array(r),Bo[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function re(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function se(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ns(i,t){let e=zo[t];e===void 0&&(e=new Int32Array(t),zo[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function ep(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function np(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(re(e,t))return;i.uniform2fv(this.addr,t),se(e,t)}}function ip(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(re(e,t))return;i.uniform3fv(this.addr,t),se(e,t)}}function rp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(re(e,t))return;i.uniform4fv(this.addr,t),se(e,t)}}function sp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(re(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),se(e,t)}else{if(re(e,n))return;ko.set(n),i.uniformMatrix2fv(this.addr,!1,ko),se(e,n)}}function ap(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(re(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),se(e,t)}else{if(re(e,n))return;Go.set(n),i.uniformMatrix3fv(this.addr,!1,Go),se(e,n)}}function op(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(re(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),se(e,t)}else{if(re(e,n))return;Ho.set(n),i.uniformMatrix4fv(this.addr,!1,Ho),se(e,n)}}function lp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function cp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(re(e,t))return;i.uniform2iv(this.addr,t),se(e,t)}}function dp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(re(e,t))return;i.uniform3iv(this.addr,t),se(e,t)}}function up(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(re(e,t))return;i.uniform4iv(this.addr,t),se(e,t)}}function hp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function fp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(re(e,t))return;i.uniform2uiv(this.addr,t),se(e,t)}}function pp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(re(e,t))return;i.uniform3uiv(this.addr,t),se(e,t)}}function mp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(re(e,t))return;i.uniform4uiv(this.addr,t),se(e,t)}}function gp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Xl:Wl;e.setTexture2D(t||s,r)}function _p(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||$l,r)}function vp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||Yl,r)}function xp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||ql,r)}function Mp(i){switch(i){case 5126:return ep;case 35664:return np;case 35665:return ip;case 35666:return rp;case 35674:return sp;case 35675:return ap;case 35676:return op;case 5124:case 35670:return lp;case 35667:case 35671:return cp;case 35668:case 35672:return dp;case 35669:case 35673:return up;case 5125:return hp;case 36294:return fp;case 36295:return pp;case 36296:return mp;case 35678:case 36198:case 36298:case 36306:case 35682:return gp;case 35679:case 36299:case 36307:return _p;case 35680:case 36300:case 36308:case 36293:return vp;case 36289:case 36303:case 36311:case 36292:return xp}}function Sp(i,t){i.uniform1fv(this.addr,t)}function yp(i,t){const e=Fi(t,this.size,2);i.uniform2fv(this.addr,e)}function Ep(i,t){const e=Fi(t,this.size,3);i.uniform3fv(this.addr,e)}function Tp(i,t){const e=Fi(t,this.size,4);i.uniform4fv(this.addr,e)}function Ap(i,t){const e=Fi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function bp(i,t){const e=Fi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function wp(i,t){const e=Fi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Cp(i,t){i.uniform1iv(this.addr,t)}function Rp(i,t){i.uniform2iv(this.addr,t)}function Pp(i,t){i.uniform3iv(this.addr,t)}function Lp(i,t){i.uniform4iv(this.addr,t)}function Dp(i,t){i.uniform1uiv(this.addr,t)}function Ip(i,t){i.uniform2uiv(this.addr,t)}function Up(i,t){i.uniform3uiv(this.addr,t)}function Np(i,t){i.uniform4uiv(this.addr,t)}function Fp(i,t,e){const n=this.cache,r=t.length,s=ns(e,r);re(n,s)||(i.uniform1iv(this.addr,s),se(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||Wl,s[a])}function Op(i,t,e){const n=this.cache,r=t.length,s=ns(e,r);re(n,s)||(i.uniform1iv(this.addr,s),se(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||$l,s[a])}function Bp(i,t,e){const n=this.cache,r=t.length,s=ns(e,r);re(n,s)||(i.uniform1iv(this.addr,s),se(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||Yl,s[a])}function zp(i,t,e){const n=this.cache,r=t.length,s=ns(e,r);re(n,s)||(i.uniform1iv(this.addr,s),se(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||ql,s[a])}function Hp(i){switch(i){case 5126:return Sp;case 35664:return yp;case 35665:return Ep;case 35666:return Tp;case 35674:return Ap;case 35675:return bp;case 35676:return wp;case 5124:case 35670:return Cp;case 35667:case 35671:return Rp;case 35668:case 35672:return Pp;case 35669:case 35673:return Lp;case 5125:return Dp;case 36294:return Ip;case 36295:return Up;case 36296:return Np;case 35678:case 36198:case 36298:case 36306:case 35682:return Fp;case 35679:case 36299:case 36307:return Op;case 35680:case 36300:case 36308:case 36293:return Bp;case 36289:case 36303:case 36311:case 36292:return zp}}class Gp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Mp(e.type)}}class kp{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Hp(e.type)}}class Vp{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const ks=/(\w+)(\])?(\[|\.)?/g;function Vo(i,t){i.seq.push(t),i.map[t.id]=t}function Wp(i,t,e){const n=i.name,r=n.length;for(ks.lastIndex=0;;){const s=ks.exec(n),a=ks.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Vo(e,c===void 0?new Gp(o,i,t):new kp(o,i,t));break}else{let f=e.map[o];f===void 0&&(f=new Vp(o),Vo(e,f)),e=f}}}class Or{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);Wp(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function Wo(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Xp=37297;let qp=0;function $p(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function Yp(i){const t=Xt.getPrimaries(Xt.workingColorSpace),e=Xt.getPrimaries(i);let n;switch(t===e?n="":t===Wr&&e===Vr?n="LinearDisplayP3ToLinearSRGB":t===Vr&&e===Wr&&(n="LinearSRGBToLinearDisplayP3"),i){case Nn:case es:return[n,"LinearTransferOETF"];case $e:case ua:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Xo(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+$p(i.getShaderSource(t),a)}else return r}function Kp(i,t){const e=Yp(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Zp(i,t){let e;switch(t){case nd:e="Linear";break;case id:e="Reinhard";break;case rd:e="OptimizedCineon";break;case sd:e="ACESFilmic";break;case od:e="AgX";break;case ld:e="Neutral";break;case ad:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function jp(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(qi).join(`
`)}function Jp(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Qp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function qi(i){return i!==""}function qo(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function $o(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const tm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ea(i){return i.replace(tm,nm)}const em=new Map;function nm(i,t){let e=bt[t];if(e===void 0){const n=em.get(t);if(n!==void 0)e=bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ea(e)}const im=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Yo(i){return i.replace(im,rm)}function rm(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ko(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function sm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Sl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Cc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(t="SHADOWMAP_TYPE_VSM"),t}function am(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ci:t="ENVMAP_TYPE_CUBE";break;case Qr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function om(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ci:t="ENVMAP_MODE_REFRACTION";break}return t}function lm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case yl:t="ENVMAP_BLENDING_MULTIPLY";break;case td:t="ENVMAP_BLENDING_MIX";break;case ed:t="ENVMAP_BLENDING_ADD";break}return t}function cm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function dm(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=sm(e),c=am(e),d=om(e),f=lm(e),p=cm(e),m=jp(e),g=Jp(s),_=r.createProgram();let h,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}),c=new Ne(new ei(e,e),l);return c.rotation.x=-Math.PI/2,c.position.y=-.1,c.renderOrder=a-1,i.add(c),c}const rg=`
...
</svg>`;let we={},Ti=[];const Xi=(i,t,{text:e,svg:n})=>{const r=document.createElement("div");r.className=`compass-label ${t}`;let s="";n&&(s+=n),e&&(s+=`<span class="compass-text">${e}</span>`),r.innerHTML=s;const a=new jl(r);return i.add(a),a};function og(i){Object.values(we).forEach(e=>e.parent?.remove(e)),Ti.forEach(e=>e.label.parent?.remove(e.label)),we={},Ti=[],we.n=Xi(i,"compass-cardinal",{text:"N"}),we.s=Xi(i,"compass-cardinal",{text:"S"}),we.e=Xi(i,"compass-cardinal",{text:"E"}),we.w=Xi(i,"compass-cardinal",{text:"W"});const t=1e5;for(let e=0;e<360;e+=5){if(e%90===0)continue;let n,r;e%45===0?(r="compass-tick-large",n={svg:ag}):e%15===0?(r="compass-tick-medium",n={svg:sg}):(r="compass-tick-small",n={svg:rg});const s=Xi(i,r,n),a=(e-90)*(Math.PI/180),o=new L(t*Math.cos(a),0,t*Math.sin(a));Ti.push({label:s,relativePos:o})}}function lg(){Object.values(we).forEach(i=>{i.parent&&i.parent.remove(i),i.element?.parentNode&&i.element.parentNode.removeChild(i.element)}),Ti.forEach(i=>{i.label.parent&&i.label.parent.remove(i.label),i.label.element?.parentNode&&i.label.element.parentNode.removeChild(i.label.element)}),we={},Ti=[]}function cg(i){if(Object.keys(we).length===0)return;const t=1e5,e=new L(i.position.x,0,i.position.z);we.n.position.copy(e).add(new L(0,0,-t)),we.s.position.copy(e).add(new L(0,0,t)),we.e.position.copy(e).add(new L(t,0,0)),we.w.position.copy(e).add(new L(-t,0,0)),Ti.forEach(n=>{n.label.position.copy(e).add(n.relativePos)})}function xa(i){const t=[],e=i.replace(/[^\x20-\x7E\r\n$]/g,"").replace(/\r\n|\r/g,`
`).replace(/\n{2,}/g,`
`).trim();if(e.split(`
`).length===0)return t;const r=/\$[A-Z0-9]{2}GGA,[^\r\n]*?\*[0-9A-Fa-f]{2}/g,s=e.match(r);if(!s)return t;let a={};const o=250,l=.5;for(const c of s){if(c.length>82&&c.length<86)continue;const d=c.split(",");if(!(d.length<15))try{const f=c.substring(1,3),p=d[1],m=d[2],g=d[3],_=d[4],h=d[5],u=parseInt(d[6]),E=parseInt(d[7]),y=d[8],T=d[9],B=d[10],w=d[11];if(!m||!_||!g||!h||!T||m.length<4||_.length<5||B!=="M"||isNaN(u)||u===0||isNaN(E)||E<3)continue;const b=parseFloat(y);if(isNaN(b)||b>5)continue;const I=parseFloat(m.substring(0,2)),v=parseFloat(m.substring(2));if(isNaN(I)||isNaN(v))continue;let x=I+v/60;g==="S"&&(x=-x);const C=parseFloat(_.substring(0,3)),z=parseFloat(_.substring(3));if(isNaN(C)||isNaN(z))continue;let F=C+z/60;if(h==="W"&&(F=-F),Math.abs(x)>360||Math.abs(F)>360)continue;const X=parseFloat(T),q=parseFloat(w)||0,W=parseInt(p.slice(0,2))||0,Y=parseInt(p.slice(2,4))||0,G=parseFloat(p.slice(4))||0,dt=W*3600+Y*60+G,ct={lat:x,lon:F,alt:X,time:dt,satellites:E,undulation:q,talkerId:f},ut=a[f];if(ut){const It=Math.abs(ct.lat-ut.lat),kt=Math.abs(ct.lon-ut.lon);if(It>l||kt>l)continue;const k=ct.time-ut.time;if(k>0&&Br(ut.lat,ut.lon,ct.lat,ct.lon)/k>o)continue}t.push(ct),a[f]=ct}catch{continue}}return t}function Br(i,t,e,n){const s=c=>c*(Math.PI/180),a=s(e-i),o=s(n-t),l=Math.sin(a/2)**2+Math.cos(s(i))*Math.cos(s(e))*Math.sin(o/2)**2;return 2*6371e3*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}function dg(i){return i.reduce((t,e)=>{const{talkerId:n}=e;return t[n]||(t[n]=[]),t[n].push(e),t},{})}function ug(i){if(!i||i.length===0)return null;const t=i[i.length-1],e=i[0],n=i.length,r=t.time-e.time,s=r>0?n/r:0,a=Br(e.lat,e.lon,t.lat,t.lon),o=t.alt-e.alt,l=Math.sqrt(Math.pow(a,2)+Math.pow(o,2)),c=t.alt,d=t.alt+(t.undulation||0),f=t.lat,p=t.lon,m=t.satellites||0;let g=0;if(i.length>=2){const u=i[i.length-2],E=t,y=Br(u.lat,u.lon,E.lat,E.lon),T=E.time-u.time;T>0&&(g=y/T)}let _=0,h=0;for(let u=1;u<i.length;u++){const E=i[u-1],y=i[u],T=Br(E.lat,E.lon,y.lat,y.lon);_+=T;const B=y.alt-E.alt,w=Math.sqrt(Math.pow(T,2)+Math.pow(B,2));h+=w}return{totalPoints:n,totalDuration:r,currentAltitude:c,currentAltWsg84:d,currentLat:f,currentLon:p,currentSatellites:m,latestSpeed:g,total2DDistance:_,total3DDistance:h,rthDistance3D:l,updateRate:s,startTime:e.time,endTime:t.time}}function hg(i){const t=i.trim().split(`
`)[0]?.trim();if(!t)return"unknown";if(t.startsWith("{"))try{const e=JSON.parse(t);if(e.data?.aircraft!==void 0||e.receivedAt)return"adsb"}catch{}return/^\$[A-Z0-9]{2}[A-Z]{3},/.test(t)?"nmea":"unknown"}function Ma(i){const t=[],e=i.split(`
`).filter(n=>n.trim());for(const n of e){let r;try{r=JSON.parse(n)}catch{continue}const s=r.receivedAt||null,a=r.data?.aircraft;if(!(!Array.isArray(a)||a.length===0))for(const o of a){if(!o.icaoAddress||o.latDD==null||o.lonDD==null||o.altitudeMM==null||Math.abs(o.latDD)>90||Math.abs(o.lonDD)>180)continue;const l=o.altitudeMM/1e3,c=o.detail&&o.detail.baroaltDiffMM!=null?o.detail.baroaltDiffMM/1e3:null;let d=null,f=null;o.altitudeType===0?(d=l,c!==null&&(f=d+c)):o.altitudeType===1&&(f=l,c!==null&&(d=f-c));const p=(o.horVelocityCMS||0)/100,m=(o.verVelocityCMS||0)/100,g=(o.headingDE2||0)/100,_=o.timeStamp||s,h=_?new Date(_):new Date,u=h.getUTCHours()*3600+h.getUTCMinutes()*60+h.getUTCSeconds()+h.getUTCMilliseconds()/1e3;t.push({lat:o.latDD,lon:o.lonDD,alt:f!==null?f:d,baroAlt:d,geoAlt:f,time:u,satellites:0,undulation:0,talkerId:o.icaoAddress,dataType:"adsb",icaoAddress:o.icaoAddress,heading:g,horVelocity:p,verVelocity:m,altitudeType:o.altitudeType??null,emitterType:o.emitterType??null,receivedAt:s,rawAltitudeMM:o.altitudeMM})}}return t}function fg(i){return i.reduce((t,e)=>{const n=e.icaoAddress||e.talkerId;return(t[n]??=[]).push(e),t},{})}function pg(i){if(!i||i.length===0)return null;const t=i[0],e=i[i.length-1];let n=0;for(let r=1;r<i.length;r++)n+=gg(i[r-1].lat,i[r-1].lon,i[r].lat,i[r].lon);return{icaoAddress:e.icaoAddress,totalPoints:i.length,currentLat:e.lat,currentLon:e.lon,currentAltM:e.alt,currentBaroAltM:e.baroAlt,currentGeoAltM:e.geoAlt,heading:e.heading,horVelocityMs:e.horVelocity,verVelocityMs:e.verVelocity,emitterType:e.emitterType,altitudeType:e.altitudeType,startTime:t.time,endTime:e.time,duration:e.time-t.time,lastSeen:e.receivedAt,totalGroundDist:n}}function mg(i){return{0:"Unknown",1:"Light",2:"Small",3:"Large",4:"High Vortex",5:"Heavy",6:"Maneuverable",7:"Rotorcraft",9:"Glider",10:"Balloon",11:"Parachutist",12:"Ultralight",14:"UAV",15:"Space"}[i]??`Type ${i}`}function gg(i,t,e,n){const s=c=>c*(Math.PI/180),a=s(e-i),o=s(n-t),l=Math.sin(a/2)**2+Math.cos(s(i))*Math.cos(s(e))*Math.sin(o/2)**2;return 2*6371e3*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}let hl="nmea",Sa=new Map,fl=!1,Jl=null;async function _g(){if(!fl)try{const i=await fetch("/aircraftDatabase.csv");if(!i.ok){console.warn("Aircraft database CSV not found.");return}const t=await i.text();vg(t),fl=!0,console.log(`Loaded ${Sa.size} aircraft records`)}catch(i){console.warn("Failed to load aircraft database:",i)}}function vg(i){const t=i.split(`
`);if(t.length<2)return;const e=t[0].split(",").map(l=>l.trim()),n=e.indexOf("icao24"),r=e.indexOf("model"),s=e.indexOf("manufacturerName"),a=e.indexOf("operator"),o=e.indexOf("registration");if(n!==-1)for(let l=1;l<t.length;l++){const c=t[l].trim();if(!c)continue;const d=c.split(","),f=d[n]?.trim().toLowerCase();f&&Sa.set(f,{model:(r>=0?d[r]?.trim():"")||"Unknown Model",manufacturer:(s>=0?d[s]?.trim():"")||"",operator:(a>=0?d[a]?.trim():"")||"",registration:(o>=0?d[o]?.trim():"")||""})}}function Ql(i){if(!i)return"Unknown";const t=i.toLowerCase();return Sa.get(t)?.model||"Unknown"}_g();function tc(){document.querySelectorAll(".talker-header").forEach(i=>{i.dataset.talkerId===Jl?i.classList.add("active-track"):i.classList.remove("active-track")})}function xg(i,t){return`
        ...
        <div class="stats-group" data-data-type="adsb">
            ...
            <table><tbody>
                <tr><td>Points:</td><td><span id="${i}-points-stat">0</span></td></tr>
                <td>Hex ID:</td><td><a href="https://globe.adsbexchange.com/?icao=${i}" target="_blank">${i}</a></td>
                <tr><td>Latitude:</td><td><span id="${i}-lat-stat">0.0</span>&deg;</td></tr>
                <tr><td>Longitude:</td><td><span id="${i}-long-stat">0.0</span>&deg;</td></tr>
                <tr><td>Alt (MSL):</td><td><span id="${i}-baroalt-stat">--</span> m</td></tr>
                <tr><td>Alt (WGS84):</td><td><span id="${i}-geoalt-stat">--</span> m</td></tr>
        ...
        </div>`}function yg(i,t){const e=s=>document.getElementById(`${i}-${s}`);if(!e("points-stat"))return;const n=Ql(t.icaoAddress||i),r=document.getElementById(`${i}-header-model`);if(r&&(n==="Unknown"||n==="Unknown Model"?r.textContent=`${i}`:r.textContent=n),e("points-stat").textContent=t.totalPoints,e("lat-stat").textContent=t.currentLat.toFixed(6),e("long-stat").textContent=t.currentLon.toFixed(6),t.currentBaroAltM!=null?e("baroalt-stat").textContent=t.currentBaroAltM.toFixed(1):e("baroalt-stat").textContent="--",t.currentGeoAltM!=null?e("geoalt-stat").textContent=t.currentGeoAltM.toFixed(1):e("geoalt-stat").textContent="--",e("hdg-stat").textContent=t.heading.toFixed(1),e("hvel-stat").textContent=t.horVelocityMs.toFixed(1),e("vvel-stat").textContent=t.verVelocityMs.toFixed(1),e("gdist-stat").textContent=t.totalGroundDist.toFixed(1),e("type-stat").textContent=mg(t.emitterType),e("duration-stat").textContent=t.duration.toFixed(1),t.lastSeen)try{e("lastseen-stat").textContent=new Date(t.lastSeen).toISOString().substring(11,19)}catch{e("lastseen-stat").textContent="--"}}function pl(i){const t=Math.floor(i/3600).toString().padStart(2,"0"),e=Math.floor(i%3600/60).toString().padStart(2,"0"),n=Math.floor(i%60).toString().padStart(2,"0");return`${t}:${e}:${n}`}function ec(i,t){i.querySelectorAll(".stats-group").forEach(e=>{const n=e.querySelector(".talker-header");n&&t.includes(n.dataset.talkerId)||e.remove()})}function is(i){const t=document.getElementById("trail-tail-color"),e=new St(t?t.value:"#00ffaa"),n=ya();document.querySelectorAll(".talker-header").forEach(r=>{const s=r.dataset.talkerId;if(n){const a=ir(s);r.style.color=`#${a.getHexString()}`}else{const a=jn(e,s);r.style.color=`#${a.getHexString()}`}})}function Zi(i,t){const e=document.getElementById("stats");if(!e||!i||i.length===0)return;const n=t||(i[0]?.dataType==="adsb"?"adsb":"nmea");n!==hl&&(e.querySelectorAll(".stats-group").forEach(o=>o.remove()),hl=n);const r=document.getElementById("trail-tail-color"),s=new St(r?r.value:"#00ffaa"),a=ya();n==="adsb"?Tg(e,i,s,a):Eg(e,i,s,a),tc()}function Eg(i,t,e,n){const r=dg(t),s=Object.keys(r).sort();ec(i,s),s.forEach(a=>{if(!document.getElementById(`${a}-points-stat`)){let l;n?l=`#${ir(a).getHexString()}`:l=`#${jn(e,a).getHexString()}`,i.insertAdjacentHTML("beforeend",xg(a,l))}const o=ug(r[a]);o&&Mg(a,o)})}function Tg(i,t,e,n){const r=fg(t),s=Object.keys(r).sort();ec(i,s),s.forEach(a=>{if(!document.getElementById(`${a}-points-stat`)){let l;n?l=`#${ir(a).getHexString()}`:l=`#${jn(e,a).getHexString()}`,i.insertAdjacentHTML("beforeend",Sg(a,l))}const o=pg(r[a]);o&&yg(a,o)})}function Ag(){const i=document.getElementById("stats");i&&(window.addEventListener("cinematicTargetChanged",t=>{Jl=t.detail.talkerId,tc()}),i.addEventListener("click",t=>{const e=t.target.closest(".talker-header");if(!e)return;const n=e.dataset.talkerId;n&&window.dispatchEvent(new CustomEvent("activateCinematicForTalker",{detail:{talkerId:n}}))}))}Ag();const Zn=new Map;let ia=null;function bg(i){ia=i}function wg(){Zn.forEach(i=>{i.parent&&i.parent.remove(i),i.element?.parentNode&&i.element.parentNode.removeChild(i.element)}),Zn.clear()}function Cg(i,t){if(!(!ia||!t)){Zn.forEach((e,n)=>{n in i||(e.parent&&e.parent.remove(e),e.element?.parentNode&&e.element.parentNode.removeChild(e.element),Zn.delete(n))});for(const e in i){const n=i[e];if(n.length===0)continue;const r=n[n.length-1],s=t(r.lat,r.lon,r.alt);let a=Zn.get(e);if(!a){const c=document.createElement("div");c.className="track-label",c.setAttribute("data-track-label-id",e),c.style.cssText=`
            ...
            `,a=new jl(c),Zn.set(e,a),ia.add(a)}const o=r.dataType==="adsb";let l=`Rover ${e}`;if(o){const c=Ql(e);c&&c!=="Unknown"&&c!=="Unknown Model"?l=c:l=`Aircraft ${e}`}a.element.textContent!==l&&(a.element.textContent=l),a.position.copy(s)}}}function ra(i,t=!1){Zn.forEach((e,n)=>{if(e.element)if(t)e.element.style.color="#ffffff";else{const r=i(n),s=typeof r=="string"?r:`#${r.getHexString()}`;e.element.style.color=s}})}let _e=new Map,Ai=[],nc=null,Oi=!1,Un=null;const Rg=.618033988749895,qs=new Map;let Pg=0;function Lg(i){if(!qs.has(i)){const t=Pg++;qs.set(i,{index:t,hueOffset:t===0?0:t*Rg%1})}return qs.get(i)}function jn(i,t){const e=Lg(t);if(e.index===0)return i.clone();const n={};return i.getHSL(n),n.h=(n.h+e.hueOffset)%1,new St().setHSL(n.h,n.s,n.l)}const ml=3,$s=5,Dg=8;function gl(){!_e||_e.size===0||_e.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const n=i.geometry.attributes.pointSize;if(!n)return;const r=n.array,s=t.length,a=Math.max(0,s-ml);for(let o=0;o<s;o++)if(o<a)r[o]=$s;else{const l=(o-a)/(Math.min(ml,s)-1||1);r[o]=$s+(Dg-$s)*l}n.needsUpdate=!0})}function Ig(i,t,e){_e=i,Ai=t,nc=e;const n=document.getElementById("show-lines-toggle"),r=n?n.checked:!1;_e.forEach(({line:s})=>{s&&(s.visible=r)})}function Ug(){if(!Ai||Ai.length===0)return null;const i=Ai.map(r=>r.alt),t=Math.min(...i),e=Math.max(...i),n=e-t;return n===0?null:{minElevation:t,maxElevation:e,elevationRange:n}}function ic(i,t){const{minElevation:e,elevationRange:n}=t,r=Math.max(0,Math.min(1,(i-e)/n));let s,a,o;if(r<.25){const l=r/.25;s=0,a=l*.8,o=1}else if(r<.5){const l=(r-.25)/.25;s=0,a=.8+l*.2,o=1-l}else if(r<.75)s=(r-.5)/.25,a=1,o=0;else{const l=(r-.75)/.25;s=1,a=1-l,o=0}return new St(s,a,o)}function ir(i){const t=_e.get(i);if(!t||!t.gpsPoints||!t.gpsPoints.length||!Un)return new St(16777215);const e=t.gpsPoints[t.gpsPoints.length-1];return ic(e.alt,Un)}function rc(){!_e||!Un||!Ai.length||_e.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const e=i.geometry.attributes.color.array;t.forEach((n,r)=>{const s=ic(n.alt,Un),a=r*3;e[a]=s.r,e[a+1]=s.g,e[a+2]=s.b}),i.geometry.attributes.color.needsUpdate=!0})}function Ng(){return Un=Ug(),Un?(Oi=!0,rc(),rr(),ra(ir),is(),!0):!1}function sc(){Oi=!1,Un=null,rs(),rr(),is()}function ya(){return Oi}function rs(){if(!_e||_e.size===0||!nc||!Ai.length)return;if(Oi&&Un){rc(),gl(),ra(ir);return}const i=new St(document.getElementById("trail-head-color").value),t=new St(document.getElementById("trail-tail-color").value);_e.forEach(({points:e,gpsPoints:n},r)=>{if(!e||n.length===0)return;const s=jn(i,r),a=jn(t,r),o={},l={};a.getHSL(o),s.getHSL(l);const c=e.geometry.attributes.color.array,d=n.length,f=15,p=Math.max(0,d-f);for(let m=0;m<d;m++){let g;if(m<p)g=a;else{const h=(m-p)/(f-1),u=o.h+(l.h-o.h)*h,E=o.s+(l.s-o.s)*h,y=o.l+(l.l-o.l)*h;g=new St().setHSL(u,E,y)}const _=m*3;c[_]=g.r,c[_+1]=g.g,c[_+2]=g.b}e.geometry.attributes.color.needsUpdate=!0}),gl(),ra(e=>jn(t,e))}function rr(){if(!_e)return;const i=new St(document.getElementById("trail-line-color").value),t=Oi;_e.forEach(({line:e},n)=>{if(!e||!e.material)return;const r=jn(i,n);e.material.color.copy(r),e.material.transparent=t,e.material.opacity=t?.2:1,e.material.depthWrite=!t,e.material.needsUpdate=!0})}function ac(){if(!_e)return;const i=document.getElementById("show-lines-toggle").checked;_e.forEach(({line:t})=>{t&&(t.visible=i)})}function Fg(){return{head:new St(document.getElementById("trail-head-color").value),tail:new St(document.getElementById("trail-tail-color").value),line:new St(document.getElementById("trail-line-color").value)}}function Og(){const i=document.getElementById("trail-head-color"),t=document.getElementById("trail-tail-color"),e=document.getElementById("trail-line-color"),n=document.getElementById("show-lines-toggle"),r=document.getElementById("stats");r&&r.addEventListener("wheel",a=>a.stopPropagation());const s=()=>{if(Oi){sc();const a=document.getElementById("trail-preset");a&&(a.value="")}rs(),rr(),is()};i&&i.addEventListener("input",s),t&&t.addEventListener("input",s),e&&e.addEventListener("input",s),n&&n.addEventListener("change",ac)}function oc(){ya()?sc():(rs(),rr(),is())}const Bg=`
...
`;let Jn=null,Rn=null,ss=null,Le=null,bi=null,Ge=[],Yn=new Map,He=null,Yr=null,$i=null,Pn=!1;function Hg(i=null){if(!Ge||Ge.length===0||!Rn)return null;if(i===null){const n=Ge[Ge.length-1];return Rn(n.lat,n.lon,n.alt)}const t=Ge.filter(n=>n.talkerId===i);if(t.length===0)return null;const e=t[t.length-1];return Rn(e.lat,e.lon,e.alt)}function lc(){return Le}function Gg(i){Jn=i,bg(i)}function kg(){return Rn}function Vg(){const i=Pn?He:Le,t=Pn?$i:bi;return!i||t===null||t===void 0?0:(i.minAlt-t)*5}function cc(i){!i||i.length===0||(He=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),Yr={lat:(He.minLat+He.maxLat)/2,lon:(He.minLon+He.maxLon)/2,alt:(He.minAlt+He.maxAlt)/2},$i=i[0].alt,Pn=!0,console.log("Global coordinate system initialized:",{globalCenter:Yr,globalBounds:He}))}function Wg(){Jn&&(Yn.forEach(({points:i,line:t})=>{i&&(i.geometry&&i.geometry.dispose(),i.material&&(Array.isArray(i.material)?i.material.forEach(e=>e.dispose()):i.material.dispose()),Jn.remove(i)),t&&(t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose()),Jn.remove(t))}),Yn.clear(),wg(),Ge=[],ss=null,Le=null,bi=null)}function Xg(i){!i||i.length===0||(Le=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),ss={lat:(Le.minLat+Le.maxLat)/2,lon:(Le.minLon+Le.maxLon)/2,alt:(Le.minAlt+Le.maxAlt)/2},bi=i[0].alt)}function qg(){Rn=(i,t,e)=>{let n,r,s;typeof i=="object"&&i!==null&&"lat"in i?(n=i.lat,r=i.lon,s=i.alt!==void 0?i.alt:$i||bi):(n=i,r=t,s=e!==void 0?e:$i||bi);const a=Pn?Yr:ss,o=Pn?$i:bi;if(n===void 0||r===void 0||s===void 0||a===null||o===null)return new L(0,0,0);const l=a.lat*Math.PI/180,c=10,d=(r-a.lon)*Math.cos(l)*111320*c,f=(s-o)*5,p=(n-a.lat)*111320*c;return new L(d,f,-p)}}function $g(i){const t=[];return i.forEach(e=>{const n=Rn(e.lat,e.lon,e.alt),r=(Math.random()-.5)*.01;t.push(n.x,n.y,n.z+r)}),{positions:t}}function Yg(i,t){const e=new Ve;e.setAttribute("position",new ye(i.positions,3));const n=new Float32Array(i.positions.length);e.setAttribute("color",new ye(n,3));const r=new Float32Array(t);r.fill(4),e.setAttribute("pointSize",new ye(r,1));const s=new ke({vertexColors:!0,vertexShader:Bg,fragmentShader:zg,transparent:!1,depthTest:!0,depthWrite:!0}),a=new Xm(e,s);a.renderOrder=0;const o=Fg(),l=new _a({color:o.line,transparent:!1,opacity:1,depthTest:!0,depthWrite:!0,linewidth:1e4}),c=new Kl(e,l);c.renderOrder=0;const d=document.getElementById("show-lines-toggle");return c.visible=d?d.checked:!1,Jn.add(c,a),{points:a,line:c}}function ji(i,t=!1){let e;if(t?(Ge.push(...i),e=Ge):(Ge=[...i],e=Ge),e.length===0)return Wg(),null;Yn.forEach(({points:o,line:l})=>{o&&Jn.remove(o),l&&Jn.remove(l)}),Yn.clear(),Xg(e),qg();const n=e.reduce((o,l)=>{const c=l.talkerId||"default";return o[c]||(o[c]=[]),o[c].push(l),o},{});for(const o in n){const l=n[o];if(l.length>1){const c=$g(l),d=Yg(c,l.length);Yn.set(o,{points:d.points,line:d.line,gpsPoints:l})}}Cg(n,Rn),console.log(`Plotted ${e.length} points across ${Yn.size} tracks.`),Ig(Yn,Ge,Pn?He:Le),rs(),rr();const s=Pn?He:Le,a=Pn?Yr:ss;return{dataSpan:Math.max((s.maxLat-s.minLat)*111320,(s.maxLon-s.minLon)*111320),firstPoint:i[0],firstPointVec:Rn(i[0].lat,i[0].lon,i[0].alt),center:a,bounds:s}}let be,An,bn,on,yn,zr,sa,xe,Sn=null;function Kg(){be=new km,be.background=new St(328965),zr=new Si,sa=new Si,be.add(zr),zr.add(sa),An=new De(75,window.innerWidth/window.innerHeight,1,1e7),An.position.set(610,610,610),bn=new Gm({antialias:!0}),bn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(bn.domElement),on=new eg,on.setSize(window.innerWidth,window.innerHeight),on.domElement.style.position="absolute",on.domElement.style.top="0px",on.domElement.style.pointerEvents="none",document.body.appendChild(on.domElement),yn=ng(An,bn.domElement),be.add(new Qm(4210752,1.5));const i=new Jm(16777215,1);i.position.set(0,100,50),be.add(i),xe=new tg(100),xe.position.y=.1,be.add(xe),An.lookAt(xe.position),Sn=ig(be),og(be),dc(),console.log("Scene initialized. Waiting for data file.")}function Bi(){return{scene:be,camera:An,renderer:bn,labelRenderer:on,controls:yn,dataGroup:zr,tileGroup:sa,axesHelper:xe}}function Zg(){xe&&(be.remove(xe),xe.geometry&&xe.geometry.dispose(),xe.material&&(Array.isArray(xe.material)?xe.material.forEach(i=>i.dispose()):xe.material.dispose()),xe=null),Sn&&(be.remove(Sn),Sn.geometry&&Sn.geometry.dispose(),Sn.material&&Sn.material.dispose(),Sn=null)}function dc(){if(requestAnimationFrame(dc),yn.isCinematicActive&&yn.isCinematicActive()){const t=yn.getTargetTalkerId(),e=Hg(t);e&&yn.setCinematicTarget(e)}yn.update();const i=yn.getCurrentCamera();cg(i),bn.render(be,i),on.render(be,i)}function jg(){An&&bn&&(An.aspect=window.innerWidth/window.innerHeight,An.updateProjectionMatrix(),bn.setSize(window.innerWidth,window.innerHeight),on.setSize(window.innerWidth,window.innerHeight))}const aa={satellite:{url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",name:"Satellite"},streetview:{url:"https://server.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}",name:"Topographic"}},Je={initialOpacity:.5,initialTileService:"satellite",zoomLevel:17,adsbZoomLevel:11,initialRenderDistance:7};function _l(i,t,e){const n=Math.pow(2,e),r=Math.floor(n*((i+180)/360)),s=t*Math.PI/180,a=Math.floor(n*(1-Math.log(Math.tan(s)+1/Math.cos(s))/Math.PI)/2);return{x:Math.max(0,Math.min(n-1,r)),y:Math.max(0,Math.min(n-1,a))}}function Kr(i,t,e){const n=Math.pow(2,e),r=i/n*360-180,a=Math.atan(Math.sinh(Math.PI*(1-2*t/n)))*180/Math.PI;return{lon:r,lat:a}}function Jg(i,t,e=5e3){return new Promise((n,r)=>{const s=setTimeout(()=>{r(new Error(`Timeout loading texture: ${t}`))},e);i.load(t,a=>{clearTimeout(s),n(a)},void 0,a=>{clearTimeout(s),r(a)})})}let oa=Je.initialTileService,Zr=Je.initialOpacity,uc=Je.zoomLevel,ze=null;const Qg=.51;let qe=null;function hc(i){uc=i}async function Ea(){const{tileGroup:i}=Bi(),t=window.getCurrentRenderDistance?window.getCurrentRenderDistance():Je.initialRenderDistance,e=lc(),n=kg();if(!e||!n){console.error("Bounding box or GPS conversion not available.");return}for(;i.children.length>0;){const w=i.children[0];i.remove(w),w.geometry&&w.geometry.dispose(),w.material&&(w.material.map&&w.material.map.dispose(),w.material.dispose())}const r=uc,{minLon:s,maxLon:a,minLat:o,maxLat:l}=e,c=_l(s,l,r),d=_l(a,o,r),f={x:c.x-t,y:c.y-t},p={x:d.x+t,y:d.y+t},m={x:Math.floor((c.x+d.x)/2),y:Math.floor((c.y+d.y)/2)};if(isNaN(f.x)||isNaN(f.y)||isNaN(p.x)||isNaN(p.y)||p.x<f.x||p.y<f.y||p.x-f.x>1e3||p.y-f.y>1e3){console.error("Invalid tile coordinate range:",{minTile:f,maxTile:p,boundingBox:e});return}const g=Kr(f.x,f.y,r),_=Kr(p.x+1,p.y+1,r),h=n({lat:g.lat,lon:g.lon}),u=n({lat:_.lat,lon:_.lon});qe={minX:Math.min(h.x,u.x),maxX:Math.max(h.x,u.x),minZ:Math.min(h.z,u.z),maxZ:Math.max(h.z,u.z)};const E=[];for(let w=f.x;w<=p.x;w++)for(let b=f.y;b<=p.y;b++)E.push({x:w,y:b});E.sort((w,b)=>Math.hypot(w.x-m.x,w.y-m.y)-Math.hypot(b.x-m.x,b.y-m.y));const y=Vg();console.log(`Loading ${E.length} tiles at zoom ${r}, floorY=${y.toFixed(1)}`);const T=new Km,B=E.map(({x:w,y:b})=>t_(w,b,r,T,n,y).catch(()=>null));await Promise.all(B),e_(y),console.log("Finished loading tiles.")}async function t_(i,t,e,n,r,s){const{tileGroup:a}=Bi(),l=aa[oa].url.replace("{z}",e).replace("{y}",t).replace("{x}",i),c=Kr(i,t,e),d=Kr(i+1,t+1,e),f=r({lat:c.lat,lon:c.lon}),p=r({lat:d.lat,lon:d.lon}),m=Math.abs(p.x-f.x),g=Math.abs(p.z-f.z),_=(f.x+p.x)/2,h=(f.z+p.z)/2,u=await Jg(n,l,5e3);u.wrapS=ln,u.wrapT=ln,u.minFilter=Ce,u.magFilter=Ce;const E=new ei(m,g),y=new fa({map:u,side:Ie,transparent:!0,opacity:Zr}),T=new Ne(E,y);T.rotation.x=-Math.PI/2,T.position.set(_,s-.1,h),a.add(T)}function e_(i){const{scene:t}=Bi();if(ze&&(t.remove(ze),ze.geometry&&ze.geometry.dispose(),ze.material&&ze.material.dispose(),ze=null),!qe)return;const e=qe.maxX-qe.minX,n=qe.maxZ-qe.minZ,r=(qe.minX+qe.maxX)/2,s=(qe.minZ+qe.maxZ)/2,a=Math.max(e,n)/80,o=new ke({uniforms:{uGridColor:{value:new St(7829367)},uGridSize:{value:a},uLineWidth:{value:.5},uOpacity:{value:.55}},depthWrite:!1,depthTest:!0,polygonOffset:!0,polygonOffsetFactor:-8,polygonOffsetUnits:-8,transparent:!0,alphaTest:.01,blending:wn,side:Ie,vertexShader:`
            varying vec3 vWorldPos;
            void main() {
                vec4 worldPosition = modelMatrix * vec4(position, 1.0);
                vWorldPos = worldPosition.xyz;
        ...
        `}),l=new Ne(new ei(e,n),o);l.rotation.x=-Math.PI/2,l.position.set(r,i,s),l.renderOrder=-1,ze=l,t.add(ze),fc()}function fc(){ze&&(ze.visible=Zr<Qg)}function vl(i){const{tileGroup:t}=Bi();Zr=parseFloat(i),t.children.forEach(e=>{e.material&&(e.material.opacity=Zr)}),fc()}function n_(i){i!==oa&&aa[i]&&(oa=i,console.log("Switched to tile service:",aa[i].name),lc()&&Ea())}let he=[],fe=0,sr=!1,fn=!0,Ln=null,Ii=1;const i_=100,pc=100;function r_(i){const t=Ii;Ii=i,console.log(`Playback speed changed from ${t}x to ${i}x`),sr&&Ln&&(clearInterval(Ln),mc()),u_()}function la(){return{isLiveMode:fn,isPlaying:sr,currentLineIndex:fe,totalLines:he.length,progress:he.length>0?fe/(he.length-1):0,playbackSpeed:Ii}}function s_(){return i_/Ii}function mc(){fe>=he.length-1&&(fe=0),Ln=setInterval(()=>{fe<he.length-1?(fe++,or(),ar()):Ta()},s_())}function a_(){Ln&&clearInterval(Ln),sr=!0,vc(),mc()}function Ta(){Ln&&(clearInterval(Ln),Ln=null),sr=!1,vc()}function o_(){fn&&as(),fe=Math.max(0,fe-pc),or(),ar()}function l_(){fn&&as(),fe=Math.min(he.length-1,fe+pc),or(),ar()}function as(){fn=!1,xc()}function gc(){fn=!0,Ta(),fe=he.length-1,or(),xc(),ar()}let _c=[];function Aa(i,t=[]){he=i;const e=Sc();_c=i.map(n=>e==="adsb"?Ma(n)||[]:xa(n)||[]),fe=Math.max(0,he.length-1),or()}function c_(){return he}function d_(){const i=document.getElementById("timeSlider");i&&he.length>0&&(i.max=he.length-1,fn&&(i.value=he.length-1,fe=he.length-1))}function ar(){const i=[],t=Sc();for(let e=0;e<=fe;e++){const n=_c[e];n&&n.length>0&&i.push(...n)}ji(i,!1),Zi(i,t)}function or(){const i=document.getElementById("timeSlider");i&&he.length>0&&(i.max=he.length-1,i.value=fe)}function vc(){const i=document.getElementById("playIcon"),t=document.getElementById("pauseIcon");sr?(i&&(i.style.display="none"),t&&(t.style.display="inline")):(i&&(i.style.display="inline"),t&&(t.style.display="none"))}function xc(){const i=document.getElementById("goLive");i&&(i.style.opacity=fn?"0.5":"1.0",i.disabled=fn)}function u_(){const i=document.getElementById("currentSpeedDisplay");i&&(i.textContent=`${Ii}x`),document.querySelectorAll(".speed-option").forEach(t=>{t.classList.toggle("active",parseFloat(t.dataset.speed)===Ii)})}function Mc(i){fn&&as(),fe=parseInt(i.target.value),ar()}function h_(i){const t=parseFloat(i.target.dataset.speed);if(!isNaN(t)&&t>0){r_(t);const e=document.getElementById("speedOptions");e&&e.classList.remove("show")}}function f_(){const i=document.getElementById("timeSlider");i&&(["mousedown","mousemove","mouseup","click"].forEach(t=>{i.addEventListener(t,e=>e.stopPropagation())}),i.addEventListener("input",Mc))}const dn=new Map;let ti=null,p_=1,m_=10;const g_='<svg class="eye-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 576 512"><path fill="currentColor" d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 92.9-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.8-35.7-46.1-87.7-92.9-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0a144 144 0 1 1-288 0zm144-64a64 64 0 1 1 0 128a64 64 0 0 1 0-128z"/></svg>',__='<svg class="eye-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 640 512"><path fill="currentColor" d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2s-6.3 25.5 4.1 33.7l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C261 125.3 289.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L223.1 149.5zM135.5 234.9c-1.8 6.7-2.8 13.7-2.8 21.1c0 79.5 64.5 144 144 144c8.7 0 17.2-.8 25.4-2.2L135.5 234.9zm-40.7-48.4C56.5 226.5 32 264.8 32 268.3c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C171.5 467.2 236.2 504 317 504c50.4 0 96-15 135.2-39.2l-49.2-38.6c-26.8 14.8-57.4 23.8-86 23.8c-80.8 0-145.5-36.8-192.6-80.6c-33.3-31-59.3-66.8-74.9-93.1z"/></svg>';function Sc(){return ti&&dn.get(ti)?.type||null}function jr(){const i=document.getElementById("fileListContainer");if(!i)return;i.innerHTML="",dn.size===0?i.style.display="none":i.style.display="flex";const t=Array.from(dn.entries());t.forEach(([r,s],a)=>{const o=r===ti,l=a===t.length-1,c=document.createElement("div");c.className=o?"active":"",c.dataset.fileId=r,c.style.cssText=`
        ...
        `,c.addEventListener("click",()=>v_(r)),i.appendChild(c)});const e=document.getElementById("addFileBtn");e&&(dn.size>0?(e.style.display="",e.style.padding="0.6em 0.8em",e.style.fontSize="0.85em",e.style.boxSizing="border-box"):e.style.display="none");const n=document.getElementById("openFileBtn");n&&dn.size>0&&(n.style.display="none")}async function v_(i){if(i===ti)return;const t=dn.get(i);if(!t)return;ti=i,hc(t.type==="adsb"?Je.adsbZoomLevel:Je.zoomLevel);const n=await(await t.handle.getFile()).text(),r=n.split(`
`).filter(o=>o.trim());Aa(r);const s=t.type==="adsb"?Ma(n):xa(n);if(s.length===0){ji([]),Zi([],t.type),jr();return}cc(s);const a=ji(s,!1);Zi(s,t.type),jr(),a&&window.dispatchEvent(new CustomEvent("fileLoaded",{detail:a}))}async function x_(i){const t=dn.get(i);if(!(!t||!t.handle||t.isWatcherRunning)){t.isWatcherRunning=!0;try{const e=await t.handle.getFile();if(e.size>t.readOffset){const n=await e.slice(t.readOffset).text();if(t.readOffset=e.size,n.length>0&&i===ti){const r=n.split(`
`).filter(a=>a.trim()),s=[...c_(),...r];Aa(s),la().isLiveMode?gc():d_()}}}catch(e){console.error(`Error watching file ${i}:`,e)}finally{t.isWatcherRunning=!1}}}function M_(i){const t=dn.get(i);t&&(t.watcherInterval&&clearInterval(t.watcherInterval),t.watcherInterval=setInterval(()=>x_(i),m_))}async function xl(i){try{const[t]=await window.showOpenFilePicker({types:[{accept:{"text/plain":[".txt",".log",".csv",".ubx",".crswap",".bin",".json",".ndjson"]}}],multiple:!1});if(!t)return!1;const e=await t.getFile(),n=await e.text();let r=hg(n);r==="unknown"&&(r="nmea");const s=p_++;dn.set(s,{id:s,handle:t,name:e.name,type:r,readOffset:e.size,watcherInterval:null,isWatcherRunning:!1}),ti=s,hc(r==="adsb"?Je.adsbZoomLevel:Je.zoomLevel);const a=n.split(`
`).filter(c=>c.trim());Aa(a);const o=r==="adsb"?Ma(n):xa(n);if(o.length===0)return alert("No valid GPS/ADS-B points found."),ji([]),Zi([],r),jr(),!1;cc(o);const l=ji(o,!1);return Zi(o,r),jr(),i&&l&&i(l),M_(s),!0}catch(t){return t.name!=="AbortError"&&console.error("File selection failed:",t),!1}}function S_(){const i=d=>{window.dispatchEvent(new CustomEvent("fileLoaded",{detail:d}))},t=document.getElementById("openFileBtn");t&&t.addEventListener("click",()=>xl(i));const e=document.getElementById("addFileBtn");e&&e.addEventListener("click",()=>xl(i));const n=document.getElementById("rewind");n&&n.addEventListener("click",o_);const r=document.getElementById("playPause");r&&r.addEventListener("click",()=>{la().isLiveMode&&as(),la().isPlaying?Ta():a_()});const s=document.getElementById("forward");s&&s.addEventListener("click",l_);const a=document.getElementById("goLive");a&&a.addEventListener("click",gc);const o=document.getElementById("timeSlider");o&&(o.addEventListener("input",Mc),f_());const l=document.getElementById("adjustSpeed"),c=document.getElementById("speedOptions");l&&c&&(l.addEventListener("click",d=>{d.stopPropagation(),c.classList.toggle("show")}),document.querySelectorAll(".speed-option").forEach(d=>{d.addEventListener("click",h_)}),window.addEventListener("click",()=>c.classList.remove("show")))}function y_(){E_(),A_(),T_()}function E_(){const i=document.getElementById("opacitySlider");i&&(i.value=Je.initialOpacity,vl(i.value),i.addEventListener("input",t=>{vl(t.target.value)}))}function T_(){document.querySelectorAll(".view-option").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".view-option").forEach(e=>e.classList.remove("active")),i.classList.add("active");const t=i.dataset.view;n_(t)})})}function A_(){const i=document.getElementById("renderMinus"),t=document.getElementById("renderPlus"),e=document.getElementById("renderValue");let n=Je.initialRenderDistance;const r=1,s=50,a=()=>{e&&(e.textContent=n),i&&(i.disabled=n<=r),t&&(t.disabled=n>=s)},o=l=>{n=Math.max(r,Math.min(s,l)),a(),Ea()};i&&i.addEventListener("click",()=>o(n-1)),t&&t.addEventListener("click",()=>o(n+1)),window.getCurrentRenderDistance=()=>n,a()}let Ml=!1;function b_(){const{controls:i}=Bi();window.addEventListener("resize",jg),window.addEventListener("fileLoaded",t=>{const e=t.detail;e&&(Ml||(Zg(),lg(),Ml=!0),i.reset(e.dataSpan,e.firstPointVec),Ea())}),Og(),S_(),y_()}function w_(){Kg();const{dataGroup:i}=Bi();Gg(i),b_(),console.log("Application initialized successfully")}w_();document.addEventListener("DOMContentLoaded",()=>{const i=document.querySelectorAll(".slider-wrapper"),t=e=>{const n=e.querySelector('input[type="range"]'),r=e.querySelector(".slider-tooltip");if(!n||!r)return;document.body.appendChild(r);const s=()=>{const a=parseFloat(n.value),o=parseFloat(n.min||0),l=parseFloat(n.max||1),d=parseFloat(n.step||.1)<1||a%1!==0;r.textContent=d?a.toFixed(1):a;const f=n.getBoundingClientRect(),p=16,m=10,g=l-o,_=g===0?0:(a-o)/g,h=f.width-p,u=_*h,E=f.left+u+p+m,y=f.top+f.height/2-r.offsetHeight/2;r.style.position="fixed",r.style.left=`${E-5}px`,r.style.top=`${y}px`,r.style.zIndex="99999999"};e.addEventListener("mouseenter",()=>{s(),r.style.opacity="1"}),e.addEventListener("mouseleave",()=>{r.style.opacity="0"}),n.addEventListener("input",s),s()};i.forEach(e=>{t(e)})});class Jr{constructor(){this.validCount=0,this.invalidCount=0}validateNMEAChecksum(t){if(t=t.trim(),!t.startsWith("$")||!t.includes("*"))return!1;const e=t.split("*");if(e.length!==2)return!1;const n=e[0].substring(1),r=e[1],s=parseInt(r,16);if(isNaN(s))return!1;let a=0;for(let o=0;o<n.length;o++)a^=n.charCodeAt(o);return a===s}extractTalkerID(t){try{const e=t.trim();if(!e.startsWith("$"))return null;const n=e.indexOf(",");return n===-1?null:e.substring(1,n)}catch{return null}}sortNMEAData(t,e=null){const n={};this.validCount=0,this.invalidCount=0;for(const r of t)if(!(!r||r.trim().length===0))if(this.validateNMEAChecksum(r)){this.validCount++;const s=this.extractTalkerID(r);s?(n[s]||(n[s]=[],console.log(`Creating entry for valid talker ID: ${s}`)),n[s].push(r.trim())):this.invalidCount++}else this.invalidCount++;return console.log(`
