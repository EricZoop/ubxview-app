...
#define LOW_PRECISION`),t}function Rm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===kl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Jc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(t="SHADOWMAP_TYPE_VSM"),t}function Pm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case Oi:t="ENVMAP_TYPE_CUBE";break;case cs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Lm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Oi:t="ENVMAP_MODE_REFRACTION";break}return t}function Dm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Gl:t="ENVMAP_BLENDING_MULTIPLY";break;case Td:t="ENVMAP_BLENDING_MIX";break;case Ad:t="ENVMAP_BLENDING_ADD";break}return t}function Im(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Um(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Rm(e),c=Pm(e),d=Lm(e),p=Dm(e),f=Im(e),m=Sm(e),g=ym(s),_=r.createProgram();let h,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
`).replace(/\n{2,}/g,`
`).trim();if(e.split(`
`).length===0)return t;const r=/\$[A-Z0-9]{2}GGA,[^\r\n]*?\*[0-9A-Fa-f]{2}/g,s=e.match(r);if(!s)return t;let a={};const o=250,l=.5;for(const c of s){if(c.length>82&&c.length<86)continue;const d=c.split(",");if(!(d.length<15))try{const p=c.substring(1,3),f=d[1],m=d[2],g=d[3],_=d[4],h=d[5],u=parseInt(d[6]),E=parseInt(d[7]),y=d[8],T=d[9],B=d[10],R=d[11];if(!m||!_||!g||!h||!T||m.length<4||_.length<5||B!=="M"||isNaN(u)||u===0||isNaN(E)||E<3)continue;const w=parseFloat(y);if(isNaN(w)||w>5)continue;const I=parseFloat(m.substring(0,2)),v=parseFloat(m.substring(2));if(isNaN(I)||isNaN(v))continue;let x=I+v/60;g==="S"&&(x=-x);const b=parseFloat(_.substring(0,3)),z=parseFloat(_.substring(3));if(isNaN(b)||isNaN(z))continue;let F=b+z/60;if(h==="W"&&(F=-F),Math.abs(x)>360||Math.abs(F)>360)continue;const X=parseFloat(T),$=parseFloat(R)||0,W=parseInt(f.slice(0,2))||0,Y=parseInt(f.slice(2,4))||0,k=parseFloat(f.slice(4))||0,dt=W*3600+Y*60+k,ct={lat:x,lon:F,alt:X,time:dt,satellites:E,undulation:$,talkerId:p},ut=a[p];if(ut){const It=Math.abs(ct.lat-ut.lat),Gt=Math.abs(ct.lon-ut.lon);if(It>l||Gt>l)continue;const G=ct.time-ut.time;if(G>0&&qr(ut.lat,ut.lon,ct.lat,ct.lon)/G>o)continue}t.push(ct),a[p]=ct}catch{continue}}return t}function qr(i,t,e,n){const s=c=>c*(Math.PI/180),a=s(e-i),o=s(n-t),l=Math.sin(a/2)**2+Math.cos(s(i))*Math.cos(s(e))*Math.sin(o/2)**2;return 2*6371e3*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}function Ug(i){return i.reduce((t,e)=>{const{talkerId:n}=e;return t[n]||(t[n]=[]),t[n].push(e),t},{})}function Ng(i){if(!i||i.length===0)return null;const t=i[i.length-1],e=i[0],n=i.length,r=t.time-e.time,s=r>0?n/r:0,a=qr(e.lat,e.lon,t.lat,t.lon),o=t.alt-e.alt,l=Math.sqrt(Math.pow(a,2)+Math.pow(o,2)),c=t.alt,d=t.alt+(t.undulation||0),p=t.lat,f=t.lon,m=t.satellites||0;let g=0;if(i.length>=2){const u=i[i.length-2],E=t,y=qr(u.lat,u.lon,E.lat,E.lon),T=E.time-u.time;T>0&&(g=y/T)}let _=0,h=0;for(let u=1;u<i.length;u++){const E=i[u-1],y=i[u],T=qr(E.lat,E.lon,y.lat,y.lon);_+=T;const B=y.alt-E.alt,R=Math.sqrt(Math.pow(T,2)+Math.pow(B,2));h+=R}return{totalPoints:n,totalDuration:r,currentAltitude:c,currentAltWsg84:d,currentLat:p,currentLon:f,currentSatellites:m,latestSpeed:g,total2DDistance:_,total3DDistance:h,rthDistance3D:l,updateRate:s,startTime:e.time,endTime:t.time}}function Fg(i){const t=i.trim().split(`
...
`).map(g=>g.trim()).filter(Boolean);if(t.length<2)return[];const e=t[0].split(",").map(g=>g.trim()),n=g=>e.indexOf(g),r=n("ID"),s=n("DateTime"),a=n("RCS"),o=n("Lat"),l=n("Lon"),c=n("Alt"),d=n("ExtID"),p=n("VelAbs");if(r<0||o<0||l<0)return console.warn("radarParser: missing required columns (ID, Lat, Lon)"),[];const f=[],m={};for(let g=1;g<t.length;g++){const _=t[g].split(",");try{const h=_[r]?.trim(),u=s>=0&&_[s]?.trim()||"",E=parseFloat(_[o]),y=parseFloat(_[l]),T=c>=0?parseFloat(_[c]):0,B=a>=0?parseFloat(_[a]):NaN,R=p>=0?parseFloat(_[p]):NaN,w=d>=0&&_[d]?.trim()||"";if(!h||isNaN(E)||isNaN(y)||Math.abs(E)>90||Math.abs(y)>180)continue;f.push({dataType:"radar",id:h,talkerId:`radar_${h}`,lat:E,lon:y,alt:isNaN(T)?0:T,time:Gg(u),rcs:isNaN(B)?null:B,velAbs:isNaN(R)?null:R,extId:w,dateTime:u}),m[h]=(m[h]||0)+1}catch{continue}}return f.filter(g=>m[g.id]>20)}function Vg(i){return i.reduce((t,e)=>(t[e.id]||(t[e.id]=[]),t[e.id].push(e),t),{})}function Wg(i){if(!i||i.length===0)return null;const t=[...i].sort((r,s)=>r.time-s.time),e=t[0],n=t[t.length-1];return{totalPoints:t.length,duration:n.time-e.time,currentLat:n.lat,currentLon:n.lon,currentAlt:n.alt,currentVel:n.velAbs,currentRcs:n.rcs,currentExtId:n.extId,startTime:e.time,endTime:n.time}}const Na="stats-search-bar",ga="stats-search-wrapper";function Sc(i){if(document.getElementById(ga))return;const t=document.createElement("div");t.id=ga,t.className="stats-search-wrapper",t.style.display="none";const e=document.createElement("input");e.id=Na,e.type="text",e.placeholder="Search Airspace",e.autocomplete="off",e.spellcheck=!1,e.className="stats-search-input",e.addEventListener("input",()=>Fa(e.value.trim().toLowerCase()));const n=a=>a.stopPropagation();e.addEventListener("keydown",n),e.addEventListener("keyup",n),e.addEventListener("keypress",n);const r=document.createElementNS("http://www.w3.org/2000/svg","svg");r.classList.add("stats-search-icon"),r.setAttribute("viewBox","0 0 512 512");const s=document.createElementNS("http://www.w3.org/2000/svg","path");s.setAttribute("d","M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376C296.3 401.1 253.9 416 208 416 93.1 416 0 322.9 0 208S93.1 0 208 0 416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"),r.appendChild(s),t.appendChild(e),t.appendChild(r),i.insertBefore(t,i.firstChild)}function Xg(i){const t=document.getElementById(ga);if(t)if(i>3)t.style.display="block";else{t.style.display="none";const e=document.getElementById(Na);e&&e.value!==""&&(e.value="",Fa(""))}}function Fa(i){const t=document.querySelectorAll("#stats-groups .stats-group");let e=null;t.forEach(n=>{if(n.classList.remove("last-visible"),!i){n.style.display="",e=n;return}const r=n.querySelector(".talker-header"),s=(r?r.textContent:"").toLowerCase(),a=(r?.dataset.talkerId||"").toLowerCase(),o=s.includes(i)||a.includes(i);n.style.display=o?"":"none",o&&(e=n)}),e&&e.classList.add("last-visible")}function $g(){const i=document.getElementById(Na);return i?i.value.trim().toLowerCase():""}const Jn=new Map,ia=new Set;async function qg(i){const t=i.toUpperCase();try{const e=await fetch(`https://hexdb.io/hex-image?hex=${t}`);if(!e.ok)return null;const n=(await e.text()).trim();if(n&&(n.startsWith("http://")||n.startsWith("https://")))return n}catch{}return null}async function Oa(i){const t=i.toUpperCase();if(!(Jn.has(t)||ia.has(t))){ia.add(t);try{const e=await fetch(`https://hexdb.io/api/v1/aircraft/${t}`);if(!e.ok){Jn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null});return}const n=await e.json();if(n.error){Jn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null});return}Jn.set(t,{model:n.Type||n.ICAOTypeCode||"Unknown",manufacturer:n.Manufacturer||"",registration:n.Registration||"",operator:n.RegisteredOwners||"",type:n.ICAOTypeCode||"",fetched:!0,imageResolved:!1,imageUrl:null}),yc(i),window.dispatchEvent(new CustomEvent("aircraftInfoLoaded",{detail:{talkerId:i,model:n.Type||n.ICAOTypeCode||"Unknown"}}))}catch(e){console.warn(`hexdb.io lookup failed for ${i}:`,e),Jn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null})}finally{ia.delete(t)}}}function yc(i){const t=i.toUpperCase(),e=Jn.get(t);if(!e)return;const n=i,r=document.getElementById(`${n}-header-model`);r&&(r.textContent=e.model&&e.model!=="Unknown"?e.model:n);const s=document.getElementById(`${n}-reg-stat`);s&&(s.textContent=e.registration||"--");const a=document.getElementById(`${n}-operator-stat`);a&&(a.textContent=e.operator||"--");const o=document.getElementById(`${n}-aircraft-img`);o&&!e.imageResolved&&e.model!=="Unknown"?(e.imageResolved=!0,qg(t).then(l=>{l&&(e.imageUrl=l,o.src=l)})):o&&e.imageUrl&&(!o.src||o.src!==e.imageUrl)&&(o.src=e.imageUrl)}function Ec(i){if(!i)return"Unknown";const t=i.toUpperCase(),e=Jn.get(t);return e?e.model||"Unknown":(Oa(i),"Loading...")}let Tc=null,Dl=!1;function Yg(i){return i?i.dataType==="radar"?"radar":i.dataType==="adsb"?"adsb":i.dataType==="nmea"||typeof i.satellites=="number"&&i.icaoAddress===void 0?"nmea":i.icaoAddress!==void 0||i.heading!==void 0||i.horizontalVelocity!==void 0?"adsb":(i.talkerId&&/^[A-Z]{2}$/.test(i.talkerId),"nmea"):"nmea"}function Kg(i){const t=[],e=[],n=[];for(const r of i){const s=Yg(r);s==="adsb"?e.push(r):s==="radar"?n.push(r):t.push(r)}return{nmea:t,adsb:e,radar:n}}function Zg(i){let t=document.getElementById("stats-groups");return t||(t=document.createElement("div"),t.id="stats-groups",i.appendChild(t)),t}function Ac(){document.querySelectorAll(".talker-header").forEach(i=>{i.classList.toggle("active-track",i.dataset.talkerId===Tc)})}function Il(i){const t=Math.floor(i/3600).toString().padStart(2,"0"),e=Math.floor(i%3600/60).toString().padStart(2,"0"),n=Math.floor(i%60).toString().padStart(2,"0");return`${t}:${e}:${n}`}function Ba(i,t,e){i.querySelectorAll(`.stats-group[data-data-type="${e}"]`).forEach(n=>{const r=n.dataset.panelId;(!r||!t.includes(r))&&n.remove()})}function fs(){const i=document.getElementById("trail-tail-color"),t=new _t(i?i.value:"#00ffaa"),e=Dc(),n=Rc();document.querySelectorAll(".talker-header").forEach(r=>{const s=r.dataset.talkerId,a=e?qi(s):n?$i(s):Un(t,s);r.style.color=`#${a.getHexString()}`})}function ii(i,t){const e=document.getElementById("stats");if(!e)return;Dl||(Array.from(e.children).forEach(f=>{f.id!=="stats-search-wrapper"&&f.id!=="stats-groups"&&f.remove()}),Dl=!0),Sc(e);const n=Zg(e);if(!i||i.length===0)return;const{nmea:r,adsb:s,radar:a}=Kg(i),o=document.getElementById("trail-tail-color"),l=new _t(o?o.value:"#00ffaa"),c=Dc(),d=Rc();Qg(n,r,l,c,d),n_(n,s,l,c,d),s_(n,a,l,c,d);const p=n.querySelectorAll(".stats-group").length;Xg(p),Ac(),Fa($g())}function jg(i,t){return`
        ...
        <div class="stats-group" data-data-type="radar" data-panel-id="${e}">
        ...
        </div>`}function r_(i,t){const e=`radar_${i}`,n=r=>document.getElementById(`${e}-${r}`);n("points-stat")&&(n("points-stat").textContent=t.totalPoints,n("extid-stat").textContent=t.currentExtId||"--",n("rcs-stat").textContent=t.currentRcs!=null?t.currentRcs.toFixed(4):"--",n("lat-stat").textContent=t.currentLat.toFixed(7),n("long-stat").textContent=t.currentLon.toFixed(7),n("alt-stat").textContent=t.currentAlt.toFixed(1),n("vel-stat").textContent=t.currentVel!=null?t.currentVel.toFixed(2):"--",n("duration-stat").textContent=t.duration.toFixed(1))}function s_(i,t,e,n,r){if(t.length===0){i.querySelectorAll('.stats-group[data-data-type="radar"]').forEach(o=>o.remove());return}const s=Vg(t),a=Object.keys(s).sort((o,l)=>Number(o)-Number(l));Ba(i,a.map(o=>`radar_${o}`),"radar"),a.forEach(o=>{const l=`radar_${o}`;if(!document.getElementById(`${l}-points-stat`)){const d=n?`#${qi(l).getHexString()}`:r?`#${$i(l).getHexString()}`:`#${Un(e,l).getHexString()}`;i.insertAdjacentHTML("beforeend",i_(o,d))}const c=Wg(s[o]);c&&r_(o,c)})}function a_(){const i=document.getElementById("stats");i&&(Sc(i),window.addEventListener("cinematicTargetChanged",t=>{if(Tc=t.detail.talkerId,Ac(),t.detail.talkerId){const e=document.getElementById("stats-groups"),n=e?.querySelector(`.stats-group[data-panel-id="${t.detail.talkerId}"]`);n&&e&&e.scrollTo({top:n.offsetTop-60,behavior:"smooth"})}}),i.addEventListener("click",t=>{const e=t.target.closest(".talker-header");if(!e)return;const n=e.dataset.talkerId;n&&window.dispatchEvent(new CustomEvent("activateCinematicForTalker",{detail:{talkerId:n}}))}))}a_();const tn=new Map;let _a=null,za=!0;function o_(i){const t=document.getElementById("stats");if(!t)return;const e=t.querySelector(`.stats-group[data-panel-id="${i}"], .stats-group[data-panel-id="radar_${i}"]`);e&&t.scrollTo({top:e.offsetTop-t.offsetTop-10,behavior:"smooth"})}function l_(i){za=i,tn.forEach(t=>{t.visible=i})}function c_(){const i=document.getElementById("show-label-toggle");i&&(za=i.checked,i.addEventListener("change",()=>l_(i.checked)))}function d_(i){_a=i,c_(),window.addEventListener("aircraftInfoLoaded",t=>{t.detail?.talkerId&&h_(t.detail.talkerId)})}function u_(){tn.forEach(i=>{i.parent&&i.parent.remove(i),i.element?.parentNode&&i.element.parentNode.removeChild(i.element)}),tn.clear()}function h_(i){let t=tn.get(i);if(!t){for(const[r,s]of tn.entries())if(r.toLowerCase()===i.toLowerCase()){t=s;break}}if(!t)return;const e=Ec(i),n=e&&e!=="Unknown"&&e!=="Unknown Model"&&e!=="Loading..."?e:`Aircraft ${i}`;t.element.textContent!==n&&(t.element.textContent=n)}function f_(i,t){if(!(!_a||!t)){tn.forEach((e,n)=>{n in i||(e.parent&&e.parent.remove(e),e.element?.parentNode&&e.element.parentNode.removeChild(e.element),tn.delete(n))});for(const e in i){const n=i[e];if(n.length===0)continue;const r=n[n.length-1],s=t(r.lat,r.lon,r.alt);let a=tn.get(e);if(!a){const l=document.createElement("div");l.className="track-label",l.setAttribute("data-track-label-id",e),l.style.cssText=`
                margin-top: -20px;
                color: #ffffff;
                font-size: 12px;
                font-weight: 600;
            ...
            `,l.addEventListener("click",c=>{c.stopPropagation(),window.dispatchEvent(new CustomEvent("activateCinematicForTalker",{detail:{talkerId:e}})),o_(e)}),l.addEventListener("mouseenter",()=>{l.style.opacity="0.7"}),l.addEventListener("mouseleave",()=>{l.style.opacity="1"}),a=new _c(l),a.visible=za,tn.set(e,a),_a.add(a)}let o;if(r.dataType==="radar")o=`Track ${e.startsWith("radar_")?e.slice(6):e}`;else if(r.dataType==="adsb"){const l=Ec(e);o=l&&l!=="Unknown"&&l!=="Unknown Model"?l:`Aircraft ${e}`}else o=`Rover ${e}`;a.element.textContent!==o&&(a.element.textContent=o),a.position.copy(s)}}}function ar(i,t=!1){tn.forEach((e,n)=>{if(e.element)if(t)e.element.style.color="#ffffff";else{const r=i(n);e.element.style.color=typeof r=="string"?r:`#${r.getHexString()}`}})}let he=new Map,Ii=[],bc=null,ri=!1,Bn=null,si=!1;const va={radar:new _t(16720418),adsb:new _t(44287),nmea:new _t(16768256)};function wc(i){return i?i.dataType==="radar"?"radar":i.dataType==="adsb"?"adsb":i.dataType==="nmea"?"nmea":i.icaoAddress!==void 0||i.heading!==void 0||i.horizontalVelocity!==void 0?"adsb":(i.talkerId&&/^[A-Z]{2}$/.test(i.talkerId),"nmea"):"nmea"}const p_=.618033988749895,ra=new Map;let m_=0;function g_(i){if(!ra.has(i)){const t=m_++;ra.set(i,{index:t,hueOffset:t===0?0:t*p_%1})}return ra.get(i)}function Un(i,t){const e=g_(t);if(e.index===0)return i.clone();const n={};return i.getHSL(n),n.h=(n.h+e.hueOffset)%1,new _t().setHSL(n.h,n.s,n.l)}const __=["trail-head-color","trail-tail-color","trail-line-color"];function ss(){const i=ri||si;__.forEach(t=>{const e=document.getElementById(t);if(!e)return;e.disabled=i,e.style.opacity=i?"0.35":"1",e.style.cursor=i?"not-allowed":"pointer";const n=e.closest(".trail-group");n&&(n.style.cursor=i?"not-allowed":"")})}function $i(i){const t=he.get(i);if(!t||!t.gpsPoints||!t.gpsPoints.length)return new _t(16777215);const e=t.gpsPoints[0],n=wc(e);return va[n]?va[n].clone():new _t(16777215)}function Cc(){he&&he.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const e=i.geometry.attributes.color.array;t.forEach((n,r)=>{const s=wc(n),a=va[s]||new _t(16777215),o=r*3;e[o]=a.r,e[o+1]=a.g,e[o+2]=a.b}),i.geometry.attributes.color.needsUpdate=!0})}function v_(){si=!0,Cc(),pr(),ar($i),fs(),ss()}function Rc(){return si}const Ul=3,sa=5,x_=8;function aa(){!he||he.size===0||he.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const n=i.geometry.attributes.pointSize;if(!n)return;const r=n.array,s=t.length,a=Math.max(0,s-Ul);for(let o=0;o<s;o++)if(o<a)r[o]=sa;else{const l=(o-a)/(Math.min(Ul,s)-1||1);r[o]=sa+(x_-sa)*l}n.needsUpdate=!0})}function M_(i,t,e){he=i,Ii=t,bc=e;const n=document.getElementById("show-lines-toggle"),r=n?n.checked:!1;he.forEach(({line:s})=>{s&&(s.visible=r)})}function S_(){if(!Ii||Ii.length===0)return null;const i=Ii.map(r=>r.alt),t=Math.min(...i),e=Math.max(...i),n=e-t;return n===0?null:{minElevation:t,maxElevation:e,elevationRange:n}}function Pc(i,t){const{minElevation:e,elevationRange:n}=t,r=Math.max(0,Math.min(1,(i-e)/n));let s,a,o;if(r<.25){const l=r/.25;s=0,a=l*.8,o=1}else if(r<.5){const l=(r-.25)/.25;s=0,a=.8+l*.2,o=1-l}else if(r<.75)s=(r-.5)/.25,a=1,o=0;else{const l=(r-.75)/.25;s=1,a=1-l,o=0}return new _t(s,a,o)}function qi(i){const t=he.get(i);if(!t||!t.gpsPoints||!t.gpsPoints.length||!Bn)return new _t(16777215);const e=t.gpsPoints[t.gpsPoints.length-1];return Pc(e.alt,Bn)}function Lc(){!he||!Bn||!Ii.length||he.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const e=i.geometry.attributes.color.array;t.forEach((n,r)=>{const s=Pc(n.alt,Bn),a=r*3;e[a]=s.r,e[a+1]=s.g,e[a+2]=s.b}),i.geometry.attributes.color.needsUpdate=!0})}function y_(){return Bn=S_(),Bn?(ri=!0,Lc(),pr(),ar(qi),fs(),ss(),!0):!1}function Dc(){return ri}function Ha(){if(!he||he.size===0||!bc||!Ii.length)return;if(ri&&Bn){Lc(),aa(),ar(qi);return}if(si){Cc(),aa(),ar($i);return}const i=new _t(document.getElementById("trail-head-color").value),t=new _t(document.getElementById("trail-tail-color").value);he.forEach(({points:e,gpsPoints:n},r)=>{if(!e||n.length===0)return;const s=Un(i,r),a=Un(t,r),o={},l={};a.getHSL(o),s.getHSL(l);const c=e.geometry.attributes.color.array,d=n.length,p=15,f=Math.max(0,d-p);for(let m=0;m<d;m++){let g;if(m<f)g=a;else{const h=(m-f)/(p-1),u=o.h+(l.h-o.h)*h,E=o.s+(l.s-o.s)*h,y=o.l+(l.l-o.l)*h;g=new _t().setHSL(u,E,y)}const _=m*3;c[_]=g.r,c[_+1]=g.g,c[_+2]=g.b}e.geometry.attributes.color.needsUpdate=!0}),aa(),ar(e=>Un(t,e))}function pr(){if(!he)return;const i=new _t(document.getElementById("trail-line-color").value),t=ri||si;he.forEach(({line:e},n)=>{if(!e||!e.material)return;const r=Un(i,n);e.material.color.copy(r),e.material.transparent=t,e.material.opacity=t?.2:1,e.material.depthWrite=!t,e.material.needsUpdate=!0})}function E_(){if(!he)return;const i=document.getElementById("show-lines-toggle").checked;he.forEach(({line:t})=>{t&&(t.visible=i)})}function T_(){return{head:new _t(document.getElementById("trail-head-color").value),tail:new _t(document.getElementById("trail-tail-color").value),line:new _t(document.getElementById("trail-line-color").value)}}function A_(){const i=document.getElementById("trail-head-color"),t=document.getElementById("trail-tail-color"),e=document.getElementById("trail-line-color"),n=document.getElementById("show-lines-toggle"),r=document.getElementById("stats");r&&r.addEventListener("wheel",o=>o.stopPropagation());const s=()=>{const o=document.getElementById("trail-preset");o&&(o.value=""),Ha(),pr(),fs()},a=()=>{E_()};i&&i.addEventListener("input",s),t&&t.addEventListener("input",s),e&&e.addEventListener("input",s),n&&n.addEventListener("change",a)}function ka(){ri&&(ri=!1,Bn=null,ss()),si&&(si=!1,ss()),Ha(),pr(),fs()}const b_=`
...
`;let ei=null,Nn=null,ps=null,Ne=null,Ui=null,We=[],Qn=new Map,Ue=null,lr=null,Ni=null,mn=!1;function C_(i=null){if(!We||We.length===0||!Nn)return null;if(i===null){const n=We[We.length-1];return Nn(n.lat,n.lon,n.alt)}const t=We.filter(n=>n.talkerId===i);if(t.length===0)return null;const e=t[t.length-1];return Nn(e.lat,e.lon,e.alt)}function Ic(){return Ne}function R_(i){ei=i,d_(i)}function P_(){return Nn}function L_(){const i=mn?Ue:Ne,t=mn?Ni:Ui;return!i||t===null||t===void 0?0:(i.minAlt-t)*5}function Uc(i){!i||i.length===0||(Ue=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),lr={lat:(Ue.minLat+Ue.maxLat)/2,lon:(Ue.minLon+Ue.maxLon)/2,alt:(Ue.minAlt+Ue.maxAlt)/2},Ni=i[0].alt,mn=!0,console.log("Global coordinate system initialized:",{globalCenter:lr,globalBounds:Ue}))}function D_(){Ue=null,lr=null,Ni=null,mn=!1}function I_(){ei&&(Qn.forEach(({points:i,line:t})=>{i&&(i.geometry&&i.geometry.dispose(),i.material&&(Array.isArray(i.material)?i.material.forEach(e=>e.dispose()):i.material.dispose()),ei.remove(i)),t&&(t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose()),ei.remove(t))}),Qn.clear(),u_(),We=[],ps=null,Ne=null,Ui=null)}function U_(i){!i||i.length===0||(Ne=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),ps={lat:(Ne.minLat+Ne.maxLat)/2,lon:(Ne.minLon+Ne.maxLon)/2,alt:(Ne.minAlt+Ne.maxAlt)/2},Ui=i[0].alt)}function N_(){Nn=(i,t,e)=>{let n,r,s;typeof i=="object"&&i!==null&&"lat"in i?(n=i.lat,r=i.lon,s=i.alt!==void 0?i.alt:Ni||Ui):(n=i,r=t,s=e!==void 0?e:Ni||Ui);const a=mn?lr:ps,o=mn?Ni:Ui;if(n===void 0||r===void 0||s===void 0||a===null||o===null)return new L(0,0,0);const l=a.lat*Math.PI/180,c=10,d=(r-a.lon)*Math.cos(l)*111320*c,p=(s-o)*5,f=(n-a.lat)*111320*c;return new L(d,p,-f)}}function F_(i){const t=[];return i.forEach(e=>{const n=Nn(e.lat,e.lon,e.alt),r=(Math.random()-.5)*.01;t.push(n.x,n.y,n.z+r)}),{positions:t}}function O_(i,t){const e=new $e;e.setAttribute("position",new Ee(i.positions,3));const n=new Float32Array(i.positions.length);e.setAttribute("color",new Ee(n,3));const r=new Float32Array(t);r.fill(4),e.setAttribute("pointSize",new Ee(r,1));const s=new Xe({vertexColors:!0,vertexShader:b_,fragmentShader:w_,transparent:!1,depthTest:!0,depthWrite:!0}),a=new mg(e,s);a.renderOrder=0;const o=T_(),l=new Ia({color:o.line,transparent:!1,opacity:1,depthTest:!0,depthWrite:!0,linewidth:1e4}),c=new mc(e,l);c.renderOrder=0;const d=document.getElementById("show-lines-toggle");return c.visible=d?d.checked:!1,ei.add(c,a),{points:a,line:c}}function ai(i,t=!1){let e;if(t?(We.push(...i),e=We):(We=[...i],e=We),e.length===0)return I_(),null;Qn.forEach(({points:o,line:l})=>{o&&ei.remove(o),l&&ei.remove(l)}),Qn.clear(),U_(e),N_();const n=e.reduce((o,l)=>{const c=l.talkerId||"default";return o[c]||(o[c]=[]),o[c].push(l),o},{});for(const o in n){const l=n[o];if(l.length>1){const c=F_(l),d=O_(c,l.length);Qn.set(o,{points:d.points,line:d.line,gpsPoints:l})}}f_(n,Nn),console.log(`Plotted ${e.length} points across ${Qn.size} tracks.`),M_(Qn,We,mn?Ue:Ne),Ha(),pr();const s=mn?Ue:Ne,a=mn?lr:ps;return{dataSpan:Math.max((s.maxLat-s.minLat)*111320,(s.maxLon-s.minLon)*111320),firstPoint:i[0],firstPointVec:Nn(i[0].lat,i[0].lon,i[0].alt),center:a,bounds:s}}let we,Rn,Pn,un,bn,Yr,xa,xe,An=null;function B_(){we=new hg,we.background=new _t(328965),Yr=new Ri,xa=new Ri,we.add(Yr),Yr.add(xa),Rn=new Fe(75,window.innerWidth/window.innerHeight,1,1e7),Rn.position.set(610,610,610),Pn=new ug({antialias:!0}),Pn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Pn.domElement),un=new Ag,un.setSize(window.innerWidth,window.innerHeight),un.domElement.style.position="absolute",un.domElement.style.top="0px",un.domElement.style.pointerEvents="none",document.body.appendChild(un.domElement),bn=bg(Rn,Pn.domElement),we.add(new Eg(4210752,1.5));const i=new yg(16777215,1);i.position.set(0,100,50),we.add(i),xe=new Tg(100),xe.position.y=.1,we.add(xe),Rn.lookAt(xe.position),An=wg(we),Lg(we),Nc(),console.log("Scene initialized. Waiting for data file.")}function Yi(){return{scene:we,camera:Rn,renderer:Pn,labelRenderer:un,controls:bn,dataGroup:Yr,tileGroup:xa,axesHelper:xe}}function z_(){xe&&(we.remove(xe),xe.geometry&&xe.geometry.dispose(),xe.material&&(Array.isArray(xe.material)?xe.material.forEach(i=>i.dispose()):xe.material.dispose()),xe=null),An&&(we.remove(An),An.geometry&&An.geometry.dispose(),An.material&&An.material.dispose(),An=null)}function Nc(){if(requestAnimationFrame(Nc),bn.isCinematicActive&&bn.isCinematicActive()){const t=bn.getTargetTalkerId(),e=C_(t);e&&bn.setCinematicTarget(e)}bn.update();const i=bn.getCurrentCamera();Ig(i),Pn.render(we,i),un.render(we,i)}function H_(){Rn&&Pn&&(Rn.aspect=window.innerWidth/window.innerHeight,Rn.updateProjectionMatrix(),Pn.setSize(window.innerWidth,window.innerHeight),un.setSize(window.innerWidth,window.innerHeight))}const Ma={satellite:{url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",name:"Satellite"},streetview:{url:"https://server.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}",name:"Topographic"}},mr={initialOpacity:.5,initialTileService:"satellite",initialRenderDistance:5,initialRenderDistanceKm:2};function Nl(i,t,e){const n=Math.pow(2,e),r=Math.floor(n*((i+180)/360)),s=t*Math.PI/180,a=Math.floor(n*(1-Math.log(Math.tan(s)+1/Math.cos(s))/Math.PI)/2);return{x:Math.max(0,Math.min(n-1,r)),y:Math.max(0,Math.min(n-1,a))}}function as(i,t,e){const n=Math.pow(2,e),r=i/n*360-180,a=Math.atan(Math.sinh(Math.PI*(1-2*t/n)))*180/Math.PI;return{lon:r,lat:a}}function k_(i,t,e=5e3){return new Promise((n,r)=>{const s=setTimeout(()=>{r(new Error(`Timeout loading texture: ${t}`))},e);i.load(t,a=>{clearTimeout(s),n(a)},void 0,a=>{clearTimeout(s),r(a)})})}let Sa=mr.initialTileService,os=mr.initialOpacity,Ie=null;const G_=.51;let Ke=null;const ya=500;let Kr=null;function Fc(i){Kr=null}function V_(i,t){const e=t/111.32,n=(i.minLat+i.maxLat)/2,r=t/(111.32*Math.cos(n*Math.PI/180));return{minLat:i.minLat-e,maxLat:i.maxLat+e,minLon:i.minLon-r,maxLon:i.maxLon+r}}function W_(i){const t=Math.max(i.maxLon-i.minLon,1e-4),e=Math.max(i.maxLat-i.minLat,1e-4);for(let n=18;n>=1;n--){const r=Math.pow(2,n),s=Math.ceil(r*t/360)+1,a=Math.ceil(r*e/180)+1;if(s*a<=ya)return n}return 1}async function Ga(){const{tileGroup:i}=Yi(),t=window.getCurrentRenderDistance?window.getCurrentRenderDistance():mr.initialRenderDistanceKm,e=Ic(),n=P_();if(!e||!n){console.error("Bounding box or GPS conversion not available.");return}for(;i.children.length>0;){const y=i.children[0];i.remove(y),y.geometry&&y.geometry.dispose(),y.material&&(y.material.map&&y.material.map.dispose(),y.material.dispose())}const r=V_(e,t),s=Kr!==null?Kr:W_(r),a=Nl(r.minLon,r.maxLat,s),o=Nl(r.maxLon,r.minLat,s),l={x:Math.floor((a.x+o.x)/2),y:Math.floor((a.y+o.y)/2)},c=o.x-a.x+1,d=o.y-a.y+1,p=c*d;if(isNaN(a.x)||isNaN(a.y)||isNaN(o.x)||isNaN(o.y)||o.x<a.x||o.y<a.y||c>1e3||d>1e3){console.error("Invalid tile coordinate range:",{minTile:a,maxTile:o,bbox:r});return}if(p>ya){console.warn(`Tile count ${p} still exceeds MAX_TILE_COUNT (${ya}) after auto-zoom. Aborting tile fetch.`);return}const f=as(a.x,a.y,s),m=as(o.x+1,o.y+1,s),g=n({lat:f.lat,lon:f.lon}),_=n({lat:m.lat,lon:m.lon});Ke={minX:Math.min(g.x,_.x),maxX:Math.max(g.x,_.x),minZ:Math.min(g.z,_.z),maxZ:Math.max(g.z,_.z)};const h=[];for(let y=a.x;y<=o.x;y++)for(let T=a.y;T<=o.y;T++)h.push({x:y,y:T});h.sort((y,T)=>Math.hypot(y.x-l.x,y.y-l.y)-Math.hypot(T.x-l.x,T.y-l.y));const u=L_();console.log(`Loading ${h.length} tiles | zoom ${s} (${Kr!==null?"manual":"auto"}) | renderDist ${t} km | floorY ${u.toFixed(1)}`);const E=new xg;await Promise.all(h.map(({x:y,y:T})=>X_(y,T,s,E,n,u).catch(()=>null))),$_(u),console.log("Finished loading tiles.")}async function X_(i,t,e,n,r,s){const{tileGroup:a}=Yi(),o=Ma[Sa].url.replace("{z}",e).replace("{y}",t).replace("{x}",i),l=as(i,t,e),c=as(i+1,t+1,e),d=r({lat:l.lat,lon:l.lon}),p=r({lat:c.lat,lon:c.lon}),f=Math.abs(p.x-d.x),m=Math.abs(p.z-d.z),g=await k_(n,o,5e3);g.wrapS=hn,g.wrapT=hn,g.minFilter=Re,g.magFilter=Re;const _=new ze(new ci(f,m),new Ra({map:g,side:Oe,transparent:!0,opacity:os}));_.rotation.x=-Math.PI/2,_.position.set((d.x+p.x)/2,s-.1,(d.z+p.z)/2),a.add(_)}function $_(i){const{scene:t}=Yi();if(Ie&&(t.remove(Ie),Ie.geometry.dispose(),Ie.material.dispose(),Ie=null),!Ke)return;const e=Ke.maxX-Ke.minX,n=Ke.maxZ-Ke.minZ,r=(Ke.minX+Ke.maxX)/2,s=(Ke.minZ+Ke.maxZ)/2,a=Math.max(e,n)/80;Ie=new ze(new ci(e,n),new Xe({uniforms:{uGridColor:{value:new _t(7829367)},uGridSize:{value:a},uLineWidth:{value:.5},uOpacity:{value:.55}},depthWrite:!1,depthTest:!0,polygonOffset:!0,polygonOffsetFactor:-8,polygonOffsetUnits:-8,transparent:!0,alphaTest:.01,blending:Dn,side:Oe,vertexShader:`
                varying vec3 vWorldPos;
                void main() {
