...
void main() {
	...
	`}function Sp(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===fa||l===pa,d=l===Oi||l===Bi;if(c||d){let f=t.get(o);const p=f!==void 0?f.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==p)return e===null&&(e=new el(i)),f=c?e.fromEquirectangular(o,f):e.fromCubemap(o,f),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),f.texture;if(f!==void 0)return f.texture;{const m=o.image;return c&&m&&m.height>0||d&&m&&r(m)?(e===null&&(e=new el(i)),f=c?e.fromEquirectangular(o):e.fromCubemap(o),f.texture.pmremVersion=o.pmremVersion,t.set(o,f),o.addEventListener("dispose",s),f.texture):null}}}return o}function r(o){let l=0;const c=6;for(let d=0;d<c;d++)o[d]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function yp(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&Ql("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Ep(i,t,e,n){const r={},s=new WeakMap;function a(f){const p=f.target;p.index!==null&&t.remove(p.index);for(const g in p.attributes)t.remove(p.attributes[g]);for(const g in p.morphAttributes){const _=p.morphAttributes[g];for(let h=0,u=_.length;h<u;h++)t.remove(_[h])}p.removeEventListener("dispose",a),delete r[p.id];const m=s.get(p);m&&(t.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,e.memory.geometries--}function o(f,p){return r[p.id]===!0||(p.addEventListener("dispose",a),r[p.id]=!0,e.memory.geometries++),p}function l(f){const p=f.attributes;for(const g in p)t.update(p[g],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const g in m){const _=m[g];for(let h=0,u=_.length;h<u;h++)t.update(_[h],i.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,g=f.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let y=0,T=E.length;y<T;y+=3){const N=E[y+0],R=E[y+1],w=E[y+2];p.push(N,R,R,w,w,N)}}else if(g!==void 0){const E=g.array;_=g.version;for(let y=0,T=E.length/3-1;y<T;y+=3){const N=y+0,R=y+1,w=y+2;p.push(N,R,R,w,w,N)}}else return;const h=new(Jl(p)?sc:rc)(p,1);h.version=_;const u=s.get(f);u&&t.remove(u),s.set(f,h)}function d(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:d}}function Tp(i,t,e){let n;function r(p){n=p}let s,a;function o(p){s=p.type,a=p.bytesPerElement}function l(p,m){i.drawElements(n,m,s,p*a),e.update(m,n,1)}function c(p,m,g){g!==0&&(i.drawElementsInstanced(n,m,s,p*a,g),e.update(m,n,g))}function d(p,m,g){if(g===0)return;const _=t.get("WEBGL_multi_draw");if(_===null)for(let h=0;h<g;h++)this.render(p[h]/a,m[h]);else{_.multiDrawElementsWEBGL(n,m,0,s,p,0,g);let h=0;for(let u=0;u<g;u++)h+=m[u];e.update(h,n,1)}}function f(p,m,g,_){if(g===0)return;const h=t.get("WEBGL_multi_draw");if(h===null)for(let u=0;u<p.length;u++)c(p[u]/a,m[u],_[u]);else{h.multiDrawElementsInstancedWEBGL(n,m,0,s,p,0,_,0,g);let u=0;for(let E=0;E<g;E++)u+=m[E];for(let E=0;E<_.length;E++)e.update(u,n,_[E])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=f}function Ap(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function bp(i,t,e){const n=new WeakMap,r=new ue;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=d!==void 0?d.length:0;let p=n.get(o);if(p===void 0||p.count!==f){let x=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;p!==void 0&&p.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,h=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],E=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let T=0;g===!0&&(T=1),_===!0&&(T=2),h===!0&&(T=3);let N=o.attributes.position.count*T,R=1;N>t.maxTextureSize&&(R=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const w=new Float32Array(N*R*4*f),I=new ec(w,N,R,f);I.type=Cn,I.needsUpdate=!0;const v=T*4;for(let b=0;b<f;b++){const z=u[b],O=E[b],X=y[b],$=N*R*4*b;for(let W=0;W<z.count;W++){const Y=W*v;g===!0&&(r.fromBufferAttribute(z,W),w[$+Y+0]=r.x,w[$+Y+1]=r.y,w[$+Y+2]=r.z,w[$+Y+3]=0),_===!0&&(r.fromBufferAttribute(O,W),w[$+Y+4]=r.x,w[$+Y+5]=r.y,w[$+Y+6]=r.z,w[$+Y+7]=0),h===!0&&(r.fromBufferAttribute(X,W),w[$+Y+8]=r.x,w[$+Y+9]=r.y,w[$+Y+10]=r.z,w[$+Y+11]=X.itemSize===4?r.w:1)}}p={count:f,texture:I,size:new kt(N,R)},n.set(o,p),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let g=0;for(let h=0;h<c.length;h++)g+=c[h];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",_),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",p.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}return{update:s}}function wp(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,d=l.geometry,f=t.get(l,d);if(r.get(f)!==c&&(t.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class hc extends _e{constructor(t,e,n,r,s,a,o,l,c,d=Ii){if(d!==Ii&&d!==ki)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===Ii&&(n=zi),n===void 0&&d===ki&&(n=Hi),super(null,r,s,a,o,l,d,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Oe,this.minFilter=l!==void 0?l:Oe,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const fc=new _e,pc=new hc(1,1);pc.compareFunction=jl;const mc=new ec,gc=new hu,_c=new lc,sl=[],al=[],ol=new Float32Array(16),ll=new Float32Array(9),cl=new Float32Array(4);function $i(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=sl[r];if(s===void 0&&(s=new Float32Array(r),sl[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function se(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ae(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function _s(i,t){let e=al[t];e===void 0&&(e=new Int32Array(t),al[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Cp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Rp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(se(e,t))return;i.uniform2fv(this.addr,t),ae(e,t)}}function Pp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(se(e,t))return;i.uniform3fv(this.addr,t),ae(e,t)}}function Lp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(se(e,t))return;i.uniform4fv(this.addr,t),ae(e,t)}}function Dp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(se(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ae(e,t)}else{if(se(e,n))return;cl.set(n),i.uniformMatrix2fv(this.addr,!1,cl),ae(e,n)}}function Ip(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(se(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ae(e,t)}else{if(se(e,n))return;ll.set(n),i.uniformMatrix3fv(this.addr,!1,ll),ae(e,n)}}function Up(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(se(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ae(e,t)}else{if(se(e,n))return;ol.set(n),i.uniformMatrix4fv(this.addr,!1,ol),ae(e,n)}}function Np(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Fp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(se(e,t))return;i.uniform2iv(this.addr,t),ae(e,t)}}function Op(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(se(e,t))return;i.uniform3iv(this.addr,t),ae(e,t)}}function Bp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(se(e,t))return;i.uniform4iv(this.addr,t),ae(e,t)}}function zp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Hp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(se(e,t))return;i.uniform2uiv(this.addr,t),ae(e,t)}}function kp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(se(e,t))return;i.uniform3uiv(this.addr,t),ae(e,t)}}function Gp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(se(e,t))return;i.uniform4uiv(this.addr,t),ae(e,t)}}function Vp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?pc:fc;e.setTexture2D(t||s,r)}function Wp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||gc,r)}function Xp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||_c,r)}function $p(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||mc,r)}function qp(i){switch(i){case 5126:return Cp;case 35664:return Rp;case 35665:return Pp;case 35666:return Lp;case 35674:return Dp;case 35675:return Ip;case 35676:return Up;case 5124:case 35670:return Np;case 35667:case 35671:return Fp;case 35668:case 35672:return Op;case 35669:case 35673:return Bp;case 5125:return zp;case 36294:return Hp;case 36295:return kp;case 36296:return Gp;case 35678:case 36198:case 36298:case 36306:case 35682:return Vp;case 35679:case 36299:case 36307:return Wp;case 35680:case 36300:case 36308:case 36293:return Xp;case 36289:case 36303:case 36311:case 36292:return $p}}function Yp(i,t){i.uniform1fv(this.addr,t)}function Kp(i,t){const e=$i(t,this.size,2);i.uniform2fv(this.addr,e)}function Zp(i,t){const e=$i(t,this.size,3);i.uniform3fv(this.addr,e)}function jp(i,t){const e=$i(t,this.size,4);i.uniform4fv(this.addr,e)}function Jp(i,t){const e=$i(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Qp(i,t){const e=$i(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function tm(i,t){const e=$i(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function em(i,t){i.uniform1iv(this.addr,t)}function nm(i,t){i.uniform2iv(this.addr,t)}function im(i,t){i.uniform3iv(this.addr,t)}function rm(i,t){i.uniform4iv(this.addr,t)}function sm(i,t){i.uniform1uiv(this.addr,t)}function am(i,t){i.uniform2uiv(this.addr,t)}function om(i,t){i.uniform3uiv(this.addr,t)}function lm(i,t){i.uniform4uiv(this.addr,t)}function cm(i,t,e){const n=this.cache,r=t.length,s=_s(e,r);se(n,s)||(i.uniform1iv(this.addr,s),ae(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||fc,s[a])}function dm(i,t,e){const n=this.cache,r=t.length,s=_s(e,r);se(n,s)||(i.uniform1iv(this.addr,s),ae(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||gc,s[a])}function um(i,t,e){const n=this.cache,r=t.length,s=_s(e,r);se(n,s)||(i.uniform1iv(this.addr,s),ae(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||_c,s[a])}function hm(i,t,e){const n=this.cache,r=t.length,s=_s(e,r);se(n,s)||(i.uniform1iv(this.addr,s),ae(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||mc,s[a])}function fm(i){switch(i){case 5126:return Yp;case 35664:return Kp;case 35665:return Zp;case 35666:return jp;case 35674:return Jp;case 35675:return Qp;case 35676:return tm;case 5124:case 35670:return em;case 35667:case 35671:return nm;case 35668:case 35672:return im;case 35669:case 35673:return rm;case 5125:return sm;case 36294:return am;case 36295:return om;case 36296:return lm;case 35678:case 36198:case 36298:case 36306:case 35682:return cm;case 35679:case 36299:case 36307:return dm;case 35680:case 36300:case 36308:case 36293:return um;case 36289:case 36303:case 36311:case 36292:return hm}}class pm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=qp(e.type)}}class mm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=fm(e.type)}}class gm{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const ra=/(\w+)(\])?(\[|\.)?/g;function dl(i,t){i.seq.push(t),i.map[t.id]=t}function _m(i,t,e){const n=i.name,r=n.length;for(ra.lastIndex=0;;){const s=ra.exec(n),a=ra.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){dl(e,c===void 0?new pm(o,i,t):new mm(o,i,t));break}else{let f=e.map[o];f===void 0&&(f=new gm(o),dl(e,f)),e=f}}}class Zr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);_m(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function ul(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const vm=37297;let xm=0;function Mm(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function Sm(i){const t=Xt.getPrimaries(Xt.workingColorSpace),e=Xt.getPrimaries(i);let n;switch(t===e?n="":t===as&&e===ss?n="LinearDisplayP3ToLinearSRGB":t===ss&&e===as&&(n="LinearSRGBToLinearDisplayP3"),i){case Hn:case gs:return[n,"LinearTransferOETF"];case Ze:case La:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function hl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Mm(i.getShaderSource(t),a)}else return r}function ym(i,t){const e=Sm(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Em(i,t){let e;switch(t){case Rd:e="Linear";break;case Pd:e="Reinhard";break;case Ld:e="OptimizedCineon";break;case Dd:e="ACESFilmic";break;case Ud:e="AgX";break;case Nd:e="Neutral";break;case Id:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function Tm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(lr).join(`
`)}function Am(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function bm(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function lr(i){return i!==""}function fl(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function pl(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const wm=/^[ \t]*#include +<([\w\d./]+)>/gm;function va(i){return i.replace(wm,Rm)}const Cm=new Map;function Rm(i,t){let e=bt[t];if(e===void 0){const n=Cm.get(t);if(n!==void 0)e=bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return va(e)}const Pm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ml(i){return i.replace(Pm,Lm)}function Lm(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function gl(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Dm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Gl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ed?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===un&&(t="SHADOWMAP_TYPE_VSM"),t}function Im(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Oi:case Bi:t="ENVMAP_TYPE_CUBE";break;case ps:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Um(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Bi:t="ENVMAP_MODE_REFRACTION";break}return t}function Nm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Vl:t="ENVMAP_BLENDING_MULTIPLY";break;case wd:t="ENVMAP_BLENDING_MIX";break;case Cd:t="ENVMAP_BLENDING_ADD";break}return t}function Fm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Om(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Dm(e),c=Im(e),d=Um(e),f=Nm(e),p=Fm(e),m=Tm(e),g=Am(s),_=r.createProgram();let h,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `}),c=new Be(new hi(e,e),l);return c.rotation.x=-Math.PI/2,c.position.y=-.1,c.renderOrder=a-1,i.add(c),c}const wg=`
...
</svg>`;let we={},Ni=[];const ar=(i,t,{text:e,svg:n})=>{const r=document.createElement("div");r.className=`compass-label ${t}`;let s="";n&&(s+=n),e&&(s+=`<span class="compass-text">${e}</span>`),r.innerHTML=s;const a=new xc(r);return i.add(a),a};function Pg(i){Object.values(we).forEach(e=>e.parent?.remove(e)),Ni.forEach(e=>e.label.parent?.remove(e.label)),we={},Ni=[],we.n=ar(i,"compass-cardinal",{text:"N"}),we.s=ar(i,"compass-cardinal",{text:"S"}),we.e=ar(i,"compass-cardinal",{text:"E"}),we.w=ar(i,"compass-cardinal",{text:"W"});const t=1e5;for(let e=0;e<360;e+=5){if(e%90===0)continue;let n,r;e%45===0?(r="compass-tick-large",n={svg:Rg}):e%15===0?(r="compass-tick-medium",n={svg:Cg}):(r="compass-tick-small",n={svg:wg});const s=ar(i,r,n),a=(e-90)*(Math.PI/180),o=new D(t*Math.cos(a),0,t*Math.sin(a));Ni.push({label:s,relativePos:o})}}function Lg(){Object.values(we).forEach(i=>{i.parent&&i.parent.remove(i),i.element?.parentNode&&i.element.parentNode.removeChild(i.element)}),Ni.forEach(i=>{i.label.parent&&i.label.parent.remove(i.label),i.label.element?.parentNode&&i.label.element.parentNode.removeChild(i.label.element)}),we={},Ni=[]}function Dg(i){if(Object.keys(we).length===0)return;const t=1e5,e=new D(i.position.x,0,i.position.z);we.n.position.copy(e).add(new D(0,0,-t)),we.s.position.copy(e).add(new D(0,0,t)),we.e.position.copy(e).add(new D(t,0,0)),we.w.position.copy(e).add(new D(-t,0,0)),Ni.forEach(n=>{n.label.position.copy(e).add(n.relativePos)})}function Mc(i){const t=[],e=i.replace(/[^\x20-\x7E\r\n$]/g,"").replace(/\r\n|\r/g,`
`).replace(/\n{2,}/g,`
`).trim();if(e.split(`
`).length===0)return t;const r=/\$[A-Z0-9]{2}GGA,[^\r\n]*?\*[0-9A-Fa-f]{2}/g,s=e.match(r);if(!s)return t;let a={};const o=250,l=.5;for(const c of s){if(c.length>82&&c.length<86)continue;const d=c.split(",");if(!(d.length<15))try{const f=c.substring(1,3),p=d[1],m=d[2],g=d[3],_=d[4],h=d[5],u=parseInt(d[6]),E=parseInt(d[7]),y=d[8],T=d[9],N=d[10],R=d[11];if(!m||!_||!g||!h||!T||m.length<4||_.length<5||N!=="M"||isNaN(u)||u===0||isNaN(E)||E<3)continue;const w=parseFloat(y);if(isNaN(w)||w>5)continue;const I=parseFloat(m.substring(0,2)),v=parseFloat(m.substring(2));if(isNaN(I)||isNaN(v))continue;let x=I+v/60;g==="S"&&(x=-x);const b=parseFloat(_.substring(0,3)),z=parseFloat(_.substring(3));if(isNaN(b)||isNaN(z))continue;let O=b+z/60;if(h==="W"&&(O=-O),Math.abs(x)>360||Math.abs(O)>360)continue;const X=parseFloat(T),$=parseFloat(R)||0,W=parseInt(p.slice(0,2))||0,Y=parseInt(p.slice(2,4))||0,k=parseFloat(p.slice(4))||0,dt=W*3600+Y*60+k,ct={lat:x,lon:O,alt:X,time:dt,satellites:E,undulation:$,talkerId:f},ut=a[f];if(ut){const It=Math.abs(ct.lat-ut.lat),Gt=Math.abs(ct.lon-ut.lon);if(It>l||Gt>l)continue;const G=ct.time-ut.time;if(G>0&&jr(ut.lat,ut.lon,ct.lat,ct.lon)/G>o)continue}t.push(ct),a[f]=ct}catch{continue}}return t}function jr(i,t,e,n){const s=c=>c*(Math.PI/180),a=s(e-i),o=s(n-t),l=Math.sin(a/2)**2+Math.cos(s(i))*Math.cos(s(e))*Math.sin(o/2)**2;return 2*6371e3*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}function Ig(i){return i.reduce((t,e)=>{const{talkerId:n}=e;return t[n]||(t[n]=[]),t[n].push(e),t},{})}function Ug(i){if(!i||i.length===0)return null;const t=i[i.length-1],e=i[0],n=i.length,r=t.time-e.time,s=r>0?n/r:0,a=jr(e.lat,e.lon,t.lat,t.lon),o=t.alt-e.alt,l=Math.sqrt(Math.pow(a,2)+Math.pow(o,2)),c=t.alt,d=t.alt+(t.undulation||0),f=t.lat,p=t.lon,m=t.satellites||0;let g=0;if(i.length>=2){const u=i[i.length-2],E=t,y=jr(u.lat,u.lon,E.lat,E.lon),T=E.time-u.time;T>0&&(g=y/T)}let _=0,h=0;for(let u=1;u<i.length;u++){const E=i[u-1],y=i[u],T=jr(E.lat,E.lon,y.lat,y.lon);_+=T;const N=y.alt-E.alt,R=Math.sqrt(Math.pow(T,2)+Math.pow(N,2));h+=R}return{totalPoints:n,totalDuration:r,currentAltitude:c,currentAltWsg84:d,currentLat:f,currentLon:p,currentSatellites:m,latestSpeed:g,total2DDistance:_,total3DDistance:h,rthDistance3D:l,updateRate:s,startTime:e.time,endTime:t.time}}function Ng(i){const t=i.trim().split(`
...
`).map(g=>g.trim()).filter(Boolean);if(t.length<2)return[];const e=t[0].split(",").map(g=>g.trim()),n=g=>e.indexOf(g),r=n("ID"),s=n("DateTime"),a=n("RCS"),o=n("Lat"),l=n("Lon"),c=n("Alt"),d=n("ExtID"),f=n("VelAbs");if(r<0||o<0||l<0)return console.warn("radarParser: missing required columns (ID, Lat, Lon)"),[];const p=[],m={};for(let g=1;g<t.length;g++){const _=t[g].split(",");try{const h=_[r]?.trim(),u=s>=0&&_[s]?.trim()||"",E=parseFloat(_[o]),y=parseFloat(_[l]),T=c>=0?parseFloat(_[c]):0,N=a>=0?parseFloat(_[a]):NaN,R=f>=0?parseFloat(_[f]):NaN,w=d>=0&&_[d]?.trim()||"";if(!h||isNaN(E)||isNaN(y)||Math.abs(E)>90||Math.abs(y)>180)continue;p.push({dataType:"radar",id:h,talkerId:`radar_${h}`,lat:E,lon:y,alt:isNaN(T)?0:T,time:kg(u),rcs:isNaN(N)?null:N,velAbs:isNaN(R)?null:R,extId:w,dateTime:u}),m[h]=(m[h]||0)+1}catch{continue}}return p.filter(g=>m[g.id]>20)}function Gg(i){return i.reduce((t,e)=>(t[e.id]||(t[e.id]=[]),t[e.id].push(e),t),{})}function Vg(i){if(!i||i.length===0)return null;const t=[...i].sort((r,s)=>r.time-s.time),e=t[0],n=t[t.length-1];return{totalPoints:t.length,duration:n.time-e.time,currentLat:n.lat,currentLon:n.lon,currentAlt:n.alt,currentVel:n.velAbs,currentRcs:n.rcs,currentExtId:n.extId,startTime:e.time,endTime:n.time}}const Oa="stats-search-bar",Ma="stats-search-wrapper";function Ec(i){if(document.getElementById(Ma))return;const t=document.createElement("div");t.id=Ma,t.className="stats-search-wrapper",t.style.display="none";const e=document.createElement("input");e.id=Oa,e.type="text",e.placeholder="Search Airspace",e.autocomplete="off",e.spellcheck=!1,e.className="stats-search-input",e.addEventListener("input",()=>Ba(e.value.trim().toLowerCase()));const n=a=>a.stopPropagation();e.addEventListener("keydown",n),e.addEventListener("keyup",n),e.addEventListener("keypress",n);const r=document.createElementNS("http://www.w3.org/2000/svg","svg");r.classList.add("stats-search-icon"),r.setAttribute("viewBox","0 0 512 512");const s=document.createElementNS("http://www.w3.org/2000/svg","path");s.setAttribute("d","M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376C296.3 401.1 253.9 416 208 416 93.1 416 0 322.9 0 208S93.1 0 208 0 416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"),r.appendChild(s),t.appendChild(e),t.appendChild(r),i.insertBefore(t,i.firstChild)}function Wg(i){const t=document.getElementById(Ma);if(t)if(i>3)t.style.display="block";else{t.style.display="none";const e=document.getElementById(Oa);e&&e.value!==""&&(e.value="",Ba(""))}}function Ba(i){const t=document.querySelectorAll("#stats-groups .stats-group");let e=null;t.forEach(n=>{if(n.classList.remove("last-visible"),!i){n.style.display="",e=n;return}const r=n.querySelector(".talker-header"),s=(r?r.textContent:"").toLowerCase(),a=(r?.dataset.talkerId||"").toLowerCase(),o=s.includes(i)||a.includes(i);n.style.display=o?"":"none",o&&(e=n)}),e&&e.classList.add("last-visible")}function Xg(){const i=document.getElementById(Oa);return i?i.value.trim().toLowerCase():""}const Qn=new Map,oa=new Set;async function $g(i){const t=i.toUpperCase();try{const e=await fetch(`https://hexdb.io/hex-image?hex=${t}`);if(!e.ok)return null;const n=(await e.text()).trim();if(n&&(n.startsWith("http://")||n.startsWith("https://")))return n}catch{}return null}async function za(i){const t=i.toUpperCase();if(!(Qn.has(t)||oa.has(t))){oa.add(t);try{const e=await fetch(`https://hexdb.io/api/v1/aircraft/${t}`);if(!e.ok){Qn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null});return}const n=await e.json();if(n.error){Qn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null});return}Qn.set(t,{model:n.Type||n.ICAOTypeCode||"Unknown",manufacturer:n.Manufacturer||"",registration:n.Registration||"",operator:n.RegisteredOwners||"",type:n.ICAOTypeCode||"",fetched:!0,imageResolved:!1,imageUrl:null}),Tc(i),window.dispatchEvent(new CustomEvent("aircraftInfoLoaded",{detail:{talkerId:i,model:n.Type||n.ICAOTypeCode||"Unknown"}}))}catch(e){console.warn(`hexdb.io lookup failed for ${i}:`,e),Qn.set(t,{model:"Unknown",manufacturer:"",registration:"",operator:"",type:"",fetched:!0,imageResolved:!1,imageUrl:null})}finally{oa.delete(t)}}}function Tc(i){const t=i.toUpperCase(),e=Qn.get(t);if(!e)return;const n=i,r=document.getElementById(`${n}-header-model`);r&&(r.textContent=e.model&&e.model!=="Unknown"?e.model:n);const s=document.getElementById(`${n}-reg-stat`);s&&(s.textContent=e.registration||"--");const a=document.getElementById(`${n}-operator-stat`);a&&(a.textContent=e.operator||"--");const o=document.getElementById(`${n}-aircraft-img`);o&&!e.imageResolved&&e.model!=="Unknown"?(e.imageResolved=!0,$g(t).then(l=>{l&&(e.imageUrl=l,o.src=l)})):o&&e.imageUrl&&(!o.src||o.src!==e.imageUrl)&&(o.src=e.imageUrl)}function Ac(i){if(!i)return"Unknown";const t=i.toUpperCase(),e=Qn.get(t);return e?e.model||"Unknown":(za(i),"Loading...")}let bc=null,Ll=!1;function qg(i){return i?i.dataType==="radar"?"radar":i.dataType==="adsb"?"adsb":i.dataType==="nmea"||typeof i.satellites=="number"&&i.icaoAddress===void 0?"nmea":i.icaoAddress!==void 0||i.heading!==void 0||i.horizontalVelocity!==void 0?"adsb":(i.talkerId&&/^[A-Z]{2}$/.test(i.talkerId),"nmea"):"nmea"}function Yg(i){const t=[],e=[],n=[];for(const r of i){const s=qg(r);s==="adsb"?e.push(r):s==="radar"?n.push(r):t.push(r)}return{nmea:t,adsb:e,radar:n}}function Kg(i){let t=document.getElementById("stats-groups");return t||(t=document.createElement("div"),t.id="stats-groups",i.appendChild(t)),t}function wc(){document.querySelectorAll(".talker-header").forEach(i=>{i.classList.toggle("active-track",i.dataset.talkerId===bc)})}function Dl(i){const t=Math.floor(i/3600).toString().padStart(2,"0"),e=Math.floor(i%3600/60).toString().padStart(2,"0"),n=Math.floor(i%60).toString().padStart(2,"0");return`${t}:${e}:${n}`}function Ha(i,t,e){i.querySelectorAll(`.stats-group[data-data-type="${e}"]`).forEach(n=>{const r=n.dataset.panelId;(!r||!t.includes(r))&&n.remove()})}function vs(){const i=document.getElementById("trail-tail-color"),t=new _t(i?i.value:"#00ffaa"),e=Uc(),n=Lc();document.querySelectorAll(".talker-header").forEach(r=>{const s=r.dataset.talkerId,a=e?Yi(s):n?qi(s):Nn(t,s);r.style.color=`#${a.getHexString()}`})}function ai(i,t){const e=document.getElementById("stats");if(!e)return;Ll||(Array.from(e.children).forEach(p=>{p.id!=="stats-search-wrapper"&&p.id!=="stats-groups"&&p.remove()}),Ll=!0),Ec(e);const n=Kg(e);if(!i||i.length===0)return;const{nmea:r,adsb:s,radar:a}=Yg(i),o=document.getElementById("trail-tail-color"),l=new _t(o?o.value:"#00ffaa"),c=Uc(),d=Lc();Jg(n,r,l,c,d),e_(n,s,l,c,d),r_(n,a,l,c,d);const f=n.querySelectorAll(".stats-group").length;Wg(f),wc(),Ba(Xg())}function Zg(i,t){return`
        ...
        <div class="stats-group" data-data-type="radar" data-panel-id="${e}">
        ...
        </div>`}function i_(i,t){const e=`radar_${i}`,n=r=>document.getElementById(`${e}-${r}`);n("points-stat")&&(n("points-stat").textContent=t.totalPoints,n("extid-stat").textContent=t.currentExtId||"--",n("rcs-stat").textContent=t.currentRcs!=null?t.currentRcs.toFixed(4):"--",n("lat-stat").textContent=t.currentLat.toFixed(7),n("long-stat").textContent=t.currentLon.toFixed(7),n("alt-stat").textContent=t.currentAlt.toFixed(1),n("vel-stat").textContent=t.currentVel!=null?t.currentVel.toFixed(2):"--",n("duration-stat").textContent=t.duration.toFixed(1))}function r_(i,t,e,n,r){if(t.length===0){i.querySelectorAll('.stats-group[data-data-type="radar"]').forEach(o=>o.remove());return}const s=Gg(t),a=Object.keys(s).sort((o,l)=>Number(o)-Number(l));Ha(i,a.map(o=>`radar_${o}`),"radar"),a.forEach(o=>{const l=`radar_${o}`;if(!document.getElementById(`${l}-points-stat`)){const d=n?`#${Yi(l).getHexString()}`:r?`#${qi(l).getHexString()}`:`#${Nn(e,l).getHexString()}`;i.insertAdjacentHTML("beforeend",n_(o,d))}const c=Vg(s[o]);c&&i_(o,c)})}function s_(){const i=document.getElementById("stats");i&&(Ec(i),window.addEventListener("cinematicTargetChanged",t=>{if(bc=t.detail.talkerId,wc(),t.detail.talkerId){const e=document.getElementById("stats-groups"),n=e?.querySelector(`.stats-group[data-panel-id="${t.detail.talkerId}"]`);n&&e&&e.scrollTo({top:n.offsetTop-60,behavior:"smooth"})}}),i.addEventListener("click",t=>{const e=t.target.closest(".talker-header");if(!e)return;const n=e.dataset.talkerId;n&&window.dispatchEvent(new CustomEvent("activateCinematicForTalker",{detail:{talkerId:n}}))}))}s_();const tn=new Map;let Sa=null,ka=!0;function a_(i){const t=document.getElementById("stats");if(!t)return;const e=t.querySelector(`.stats-group[data-panel-id="${i}"], .stats-group[data-panel-id="radar_${i}"]`);e&&t.scrollTo({top:e.offsetTop-t.offsetTop-10,behavior:"smooth"})}function o_(i){ka=i,tn.forEach(t=>{t.visible=i})}function l_(){const i=document.getElementById("show-label-toggle");i&&(ka=i.checked,i.addEventListener("change",()=>o_(i.checked)))}function c_(i){Sa=i,l_(),window.addEventListener("aircraftInfoLoaded",t=>{t.detail?.talkerId&&u_(t.detail.talkerId)})}function d_(){tn.forEach(i=>{i.parent&&i.parent.remove(i),i.element?.parentNode&&i.element.parentNode.removeChild(i.element)}),tn.clear()}function u_(i){let t=tn.get(i);if(!t){for(const[r,s]of tn.entries())if(r.toLowerCase()===i.toLowerCase()){t=s;break}}if(!t)return;const e=Ac(i),n=e&&e!=="Unknown"&&e!=="Unknown Model"&&e!=="Loading..."?e:`Aircraft ${i}`;t.element.textContent!==n&&(t.element.textContent=n)}function h_(i,t){if(!(!Sa||!t)){tn.forEach((e,n)=>{n in i||(e.parent&&e.parent.remove(e),e.element?.parentNode&&e.element.parentNode.removeChild(e.element),tn.delete(n))});for(const e in i){const n=i[e];if(n.length===0)continue;const r=n[n.length-1],s=t(r.lat,r.lon,r.alt);let a=tn.get(e);if(!a){const l=document.createElement("div");l.className="track-label",l.setAttribute("data-track-label-id",e),l.style.cssText=`
                margin-top: -20px;
                color: #ffffff;
                font-size: 12px;
                font-weight: 600;
            ...
            `,l.addEventListener("click",c=>{c.stopPropagation(),window.dispatchEvent(new CustomEvent("activateCinematicForTalker",{detail:{talkerId:e}})),a_(e)}),l.addEventListener("mouseenter",()=>{l.style.opacity="0.7"}),l.addEventListener("mouseleave",()=>{l.style.opacity="1"}),a=new xc(l),a.visible=ka,tn.set(e,a),Sa.add(a)}let o;if(r.dataType==="radar")o=`Track ${e.startsWith("radar_")?e.slice(6):e}`;else if(r.dataType==="adsb"){const l=Ac(e);o=l&&l!=="Unknown"&&l!=="Unknown Model"?l:`Aircraft ${e}`}else o=`Rover ${e}`;a.element.textContent!==o&&(a.element.textContent=o),a.position.copy(s)}}}function cr(i,t=!1){tn.forEach((e,n)=>{if(e.element)if(t)e.element.style.color="#ffffff";else{const r=i(n);e.element.style.color=typeof r=="string"?r:`#${r.getHexString()}`}})}let de=new Map,Fi=[],Cc=null,oi=!1,zn=null,li=!1;const ya={radar:new _t(16720418),adsb:new _t(44287),nmea:new _t(16768256)};function Rc(i){return i?i.dataType==="radar"?"radar":i.dataType==="adsb"?"adsb":i.dataType==="nmea"?"nmea":i.icaoAddress!==void 0||i.heading!==void 0||i.horizontalVelocity!==void 0?"adsb":(i.talkerId&&/^[A-Z]{2}$/.test(i.talkerId),"nmea"):"nmea"}const f_=.618033988749895,la=new Map;let p_=0;function m_(i){if(!la.has(i)){const t=p_++;la.set(i,{index:t,hueOffset:t===0?0:t*f_%1})}return la.get(i)}function Nn(i,t){const e=m_(t);if(e.index===0)return i.clone();const n={};return i.getHSL(n),n.h=(n.h+e.hueOffset)%1,new _t().setHSL(n.h,n.s,n.l)}const g_=["trail-head-color","trail-tail-color","trail-line-color"];function ds(){const i=oi||li;g_.forEach(t=>{const e=document.getElementById(t);if(!e)return;e.disabled=i,e.style.opacity=i?"0.35":"1",e.style.cursor=i?"not-allowed":"pointer";const n=e.closest(".trail-group");n&&(n.style.cursor=i?"not-allowed":"")})}function qi(i){const t=de.get(i);if(!t||!t.gpsPoints||!t.gpsPoints.length)return new _t(16777215);const e=t.gpsPoints[0],n=Rc(e);return ya[n]?ya[n].clone():new _t(16777215)}function Pc(){de&&de.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const e=i.geometry.attributes.color.array;t.forEach((n,r)=>{const s=Rc(n),a=ya[s]||new _t(16777215),o=r*3;e[o]=a.r,e[o+1]=a.g,e[o+2]=a.b}),i.geometry.attributes.color.needsUpdate=!0})}function __(){li=!0,Pc(),_r(),cr(qi),vs(),ds()}function Lc(){return li}const Il=3,ca=5,v_=8;function da(){!de||de.size===0||de.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const n=i.geometry.attributes.pointSize;if(!n)return;const r=n.array,s=t.length,a=Math.max(0,s-Il);for(let o=0;o<s;o++)if(o<a)r[o]=ca;else{const l=(o-a)/(Math.min(Il,s)-1||1);r[o]=ca+(v_-ca)*l}n.needsUpdate=!0})}function x_(i,t,e){de=i,Fi=t,Cc=e;const n=document.getElementById("show-lines-toggle"),r=n?n.checked:!1;de.forEach(({line:s})=>{s&&(s.visible=r)})}function M_(){if(!Fi||Fi.length===0)return null;const i=Fi.map(r=>r.alt),t=Math.min(...i),e=Math.max(...i),n=e-t;return n===0?null:{minElevation:t,maxElevation:e,elevationRange:n}}function Dc(i,t){const{minElevation:e,elevationRange:n}=t,r=Math.max(0,Math.min(1,(i-e)/n));let s,a,o;if(r<.25){const l=r/.25;s=0,a=l*.8,o=1}else if(r<.5){const l=(r-.25)/.25;s=0,a=.8+l*.2,o=1-l}else if(r<.75)s=(r-.5)/.25,a=1,o=0;else{const l=(r-.75)/.25;s=1,a=1-l,o=0}return new _t(s,a,o)}function Yi(i){const t=de.get(i);if(!t||!t.gpsPoints||!t.gpsPoints.length||!zn)return new _t(16777215);const e=t.gpsPoints[t.gpsPoints.length-1];return Dc(e.alt,zn)}function Ic(){!de||!zn||!Fi.length||de.forEach(({points:i,gpsPoints:t})=>{if(!i)return;const e=i.geometry.attributes.color.array;t.forEach((n,r)=>{const s=Dc(n.alt,zn),a=r*3;e[a]=s.r,e[a+1]=s.g,e[a+2]=s.b}),i.geometry.attributes.color.needsUpdate=!0})}function S_(){return zn=M_(),zn?(oi=!0,Ic(),_r(),cr(Yi),vs(),ds(),!0):!1}function Uc(){return oi}function Ga(){if(!de||de.size===0||!Cc||!Fi.length)return;if(oi&&zn){Ic(),da(),cr(Yi);return}if(li){Pc(),da(),cr(qi);return}const i=new _t(document.getElementById("trail-head-color").value),t=new _t(document.getElementById("trail-tail-color").value);de.forEach(({points:e,gpsPoints:n},r)=>{if(!e||n.length===0)return;const s=Nn(i,r),a=Nn(t,r),o={},l={};a.getHSL(o),s.getHSL(l);const c=e.geometry.attributes.color.array,d=n.length,f=15,p=Math.max(0,d-f);for(let m=0;m<d;m++){let g;if(m<p)g=a;else{const h=(m-p)/(f-1),u=o.h+(l.h-o.h)*h,E=o.s+(l.s-o.s)*h,y=o.l+(l.l-o.l)*h;g=new _t().setHSL(u,E,y)}const _=m*3;c[_]=g.r,c[_+1]=g.g,c[_+2]=g.b}e.geometry.attributes.color.needsUpdate=!0}),da(),cr(e=>Nn(t,e))}function _r(){if(!de)return;const i=new _t(document.getElementById("trail-line-color").value),t=oi||li;de.forEach(({line:e},n)=>{if(!e||!e.material)return;const r=Nn(i,n);e.material.color.copy(r),e.material.transparent=t,e.material.opacity=t?.2:1,e.material.depthWrite=!t,e.material.needsUpdate=!0})}function y_(){if(!de)return;const i=document.getElementById("show-lines-toggle").checked;de.forEach(({line:t})=>{t&&(t.visible=i)})}function E_(){return{head:new _t(document.getElementById("trail-head-color").value),tail:new _t(document.getElementById("trail-tail-color").value),line:new _t(document.getElementById("trail-line-color").value)}}function T_(){const i=document.getElementById("trail-head-color"),t=document.getElementById("trail-tail-color"),e=document.getElementById("trail-line-color"),n=document.getElementById("show-lines-toggle"),r=document.getElementById("stats");r&&r.addEventListener("wheel",o=>o.stopPropagation());const s=()=>{const o=document.getElementById("trail-preset");o&&(o.value=""),Ga(),_r(),vs()},a=()=>{y_()};i&&i.addEventListener("input",s),t&&t.addEventListener("input",s),e&&e.addEventListener("input",s),n&&n.addEventListener("change",a)}function Va(){oi&&(oi=!1,zn=null,ds()),li&&(li=!1,ds()),Ga(),_r(),vs()}const A_=`
...
`;let ni=null,Fn=null,xs=null,Ue=null,ii=null,We=[],ti=new Map,Ie=null,ur=null,ri=null,nn=!1;function w_(i=null){if(!We||We.length===0||!Fn)return null;if(i===null){const n=We[We.length-1];return Fn(n.lat,n.lon,n.alt)}const t=We.filter(n=>n.talkerId===i);if(t.length===0)return null;const e=t[t.length-1];return Fn(e.lat,e.lon,e.alt)}function vr(){return Ue}function C_(i){ni=i,c_(i)}function R_(){return Fn}function P_(){const i=nn?Ie:Ue,t=nn?ri:ii;return!i||t===null||t===void 0?0:(i.minAlt-t)*1}function L_(){return nn?ri:ii}function Nc(i){!i||i.length===0||(Ie=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),ur={lat:(Ie.minLat+Ie.maxLat)/2,lon:(Ie.minLon+Ie.maxLon)/2,alt:(Ie.minAlt+Ie.maxAlt)/2},ri=i[0].alt,nn=!0,console.log("Global coordinate system initialized:",{globalCenter:ur,globalBounds:Ie}))}function D_(){Ie=null,ur=null,ri=null,nn=!1}function I_(){ni&&(ti.forEach(({points:i,line:t})=>{i&&(i.geometry&&i.geometry.dispose(),i.material&&(Array.isArray(i.material)?i.material.forEach(e=>e.dispose()):i.material.dispose()),ni.remove(i)),t&&(t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose()),ni.remove(t))}),ti.clear(),d_(),We=[],xs=null,Ue=null,ii=null)}function U_(i){!i||i.length===0||(Ue=i.reduce((t,e)=>({minLat:Math.min(t.minLat,e.lat),maxLat:Math.max(t.maxLat,e.lat),minLon:Math.min(t.minLon,e.lon),maxLon:Math.max(t.maxLon,e.lon),minAlt:Math.min(t.minAlt,e.alt),maxAlt:Math.max(t.maxAlt,e.alt)}),{minLat:1/0,maxLat:-1/0,minLon:1/0,maxLon:-1/0,minAlt:1/0,maxAlt:-1/0}),xs={lat:(Ue.minLat+Ue.maxLat)/2,lon:(Ue.minLon+Ue.maxLon)/2,alt:(Ue.minAlt+Ue.maxAlt)/2},ii=i[0].alt)}function N_(){Fn=(i,t,e)=>{let n,r,s;typeof i=="object"&&i!==null&&"lat"in i?(n=i.lat,r=i.lon,s=i.alt!==void 0?i.alt:ri||ii):(n=i,r=t,s=e!==void 0?e:ri||ii);const a=nn?ur:xs,o=nn?ri:ii;if(n===void 0||r===void 0||s===void 0||a===null||o===null)return new D(0,0,0);const l=a.lat*Math.PI/180,c=10,d=(r-a.lon)*Math.cos(l)*111320*c,f=(s-o)*10,p=(n-a.lat)*111320*c;return new D(d,f,-p)}}function F_(i){const t=[];return i.forEach(e=>{const n=Fn(e.lat,e.lon,e.alt),r=(Math.random()-.5)*.01;t.push(n.x,n.y,n.z+r)}),{positions:t}}function O_(i,t){const e=new $e;e.setAttribute("position",new Ee(i.positions,3));const n=new Float32Array(i.positions.length);e.setAttribute("color",new Ee(n,3));const r=new Float32Array(t);r.fill(4),e.setAttribute("pointSize",new Ee(r,1));const s=new Xe({vertexColors:!0,vertexShader:A_,fragmentShader:b_,transparent:!1,depthTest:!0,depthWrite:!0}),a=new vg(e,s);a.renderOrder=0;const o=E_(),l=new Na({color:o.line,transparent:!1,opacity:1,depthTest:!0,depthWrite:!0,linewidth:1e4}),c=new vc(e,l);c.renderOrder=0;const d=document.getElementById("show-lines-toggle");return c.visible=d?d.checked:!1,ni.add(c,a),{points:a,line:c}}function ci(i,t=!1){let e;if(t?(We.push(...i),e=We):(We=[...i],e=We),e.length===0)return I_(),null;ti.forEach(({points:o,line:l})=>{o&&ni.remove(o),l&&ni.remove(l)}),ti.clear(),U_(e),N_();const n=e.reduce((o,l)=>{const c=l.talkerId||"default";return o[c]||(o[c]=[]),o[c].push(l),o},{});for(const o in n){const l=n[o];if(l.length>1){const c=F_(l),d=O_(c,l.length);ti.set(o,{points:d.points,line:d.line,gpsPoints:l})}}h_(n,Fn),console.log(`Plotted ${e.length} points across ${ti.size} tracks.`),x_(ti,We,nn?Ie:Ue),Ga(),_r();const s=nn?Ie:Ue,a=nn?ur:xs;return{dataSpan:Math.max((s.maxLat-s.minLat)*111320,(s.maxLon-s.minLon)*111320),firstPoint:i[0],firstPointVec:Fn(i[0].lat,i[0].lon,i[0].alt),center:a,bounds:s}}let Ge,Rn,Pn,hn,bn,Jr,Ea,xe,An=null;function B_(){Ge=new mg,Ge.background=new _t(328965),Jr=new Di,Ea=new Di,Ge.add(Jr),Jr.add(Ea),Rn=new Ne(75,window.innerWidth/window.innerHeight,1,1e7),Rn.position.set(610,610,610),Pn=new pg({antialias:!0}),Pn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Pn.domElement),hn=new Tg,hn.setSize(window.innerWidth,window.innerHeight),hn.domElement.style.position="absolute",hn.domElement.style.top="0px",hn.domElement.style.pointerEvents="none",document.body.appendChild(hn.domElement),bn=Ag(Rn,Pn.domElement),xe=new Eg(100),xe.position.y=.1,Ge.add(xe),Rn.lookAt(xe.position),An=bg(Ge),Pg(Ge),Fc(),console.log("Scene initialized. Waiting for data file.")}function Ki(){return{scene:Ge,camera:Rn,renderer:Pn,labelRenderer:hn,controls:bn,dataGroup:Jr,tileGroup:Ea,axesHelper:xe}}function z_(){xe&&(Ge.remove(xe),xe.geometry&&xe.geometry.dispose(),xe.material&&(Array.isArray(xe.material)?xe.material.forEach(i=>i.dispose()):xe.material.dispose()),xe=null),An&&(Ge.remove(An),An.geometry&&An.geometry.dispose(),An.material&&An.material.dispose(),An=null)}function Fc(){if(requestAnimationFrame(Fc),bn.isCinematicActive&&bn.isCinematicActive()){const t=bn.getTargetTalkerId(),e=w_(t);e&&bn.setCinematicTarget(e)}bn.update();const i=bn.getCurrentCamera();Dg(i),Pn.render(Ge,i),hn.render(Ge,i)}function H_(){Rn&&Pn&&(Rn.aspect=window.innerWidth/window.innerHeight,Rn.updateProjectionMatrix(),Pn.setSize(window.innerWidth,window.innerHeight),hn.setSize(window.innerWidth,window.innerHeight))}const Ta={satellite:{url:"https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",name:"Satellite"},streetview:{url:"https://server.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}",name:"Topographic"}},xr={initialOpacity:.5,initialTileService:"satellite",initialRenderDistance:5,initialRenderDistanceKm:2};function Ul(i,t,e){const n=Math.pow(2,e),r=Math.floor(n*((i+180)/360)),s=t*Math.PI/180,a=Math.floor(n*(1-Math.log(Math.tan(s)+1/Math.cos(s))/Math.PI)/2);return{x:Math.max(0,Math.min(n-1,r)),y:Math.max(0,Math.min(n-1,a))}}function us(i,t,e){const n=Math.pow(2,e),r=i/n*360-180,a=Math.atan(Math.sinh(Math.PI*(1-2*t/n)))*180/Math.PI;return{lon:r,lat:a}}function k_(i,t,e=5e3){return new Promise((n,r)=>{const s=setTimeout(()=>{r(new Error(`Timeout loading texture: ${t}`))},e);i.load(t,a=>{clearTimeout(s),n(a)},void 0,a=>{clearTimeout(s),r(a)})})}let Aa=xr.initialTileService,hs=xr.initialOpacity,De=null;const G_=.51;let Ke=null;const ba=500;let Qr=null;function Oc(i){Qr=null}const V_="https://s3.amazonaws.com/elevation-tiles-prod/terrarium/{z}/{x}/{y}.png";let Bc=32,zc=10,Ln=!1;function W_(i){zc=parseFloat(i),Ln&&vr()&&Zi()}function X_(i){Bc=parseInt(i,10),Ln&&vr()&&Zi()}function $_(i){Ln=!!i,vr()&&Zi()}async function q_(i,t,e){const n=V_.replace("{z}",e).replace("{x}",i).replace("{y}",t);return new Promise(r=>{const s=new Image;s.crossOrigin="Anonymous",s.onload=()=>{try{const a=document.createElement("canvas");a.width=s.width,a.height=s.height;const o=a.getContext("2d");o.drawImage(s,0,0),r(o.getImageData(0,0,a.width,a.height))}catch(a){console.warn(`Elevation canvas read failed for ${i},${t},${e}:`,a),r(null)}},s.onerror=()=>{console.warn(`Elevation tile load failed: ${n}`),r(null)},setTimeout(()=>r(null),6e3),s.src=n})}function Y_(i,t,e){const{data:n,width:r,height:s}=i;return((o,l)=>{const c=Math.max(0,Math.min(r-1,Math.round(l))),f=(Math.max(0,Math.min(s-1,Math.round(o)))*r+c)*4;return n[f]*256+n[f+1]+n[f+2]/256-32768})(t,e)}function K_(i,t){const e=t/111.32,n=(i.minLat+i.maxLat)/2,r=t/(111.32*Math.cos(n*Math.PI/180));return{minLat:i.minLat-e,maxLat:i.maxLat+e,minLon:i.minLon-r,maxLon:i.maxLon+r}}function Z_(i){const t=Math.max(i.maxLon-i.minLon,1e-4),e=Math.max(i.maxLat-i.minLat,1e-4);for(let n=18;n>=1;n--){const r=Math.pow(2,n),s=Math.ceil(r*t/360)+1,a=Math.ceil(r*e/180)+1;if(s*a<=ba)return n}return 1}async function Zi(){const{tileGroup:i}=Ki(),t=window.getCurrentRenderDistance?window.getCurrentRenderDistance():xr.initialRenderDistanceKm,e=vr(),n=R_();if(!e||!n){console.error("Bounding box or GPS conversion not available.");return}for(;i.children.length>0;){const T=i.children[0];i.remove(T),T.geometry&&T.geometry.dispose(),T.material&&(T.material.map&&T.material.map.dispose(),T.material.dispose())}const r=K_(e,t),s=Qr!==null?Qr:Z_(r),a=Ul(r.minLon,r.maxLat,s),o=Ul(r.maxLon,r.minLat,s),l={x:Math.floor((a.x+o.x)/2),y:Math.floor((a.y+o.y)/2)},c=o.x-a.x+1,d=o.y-a.y+1,f=c*d;if(isNaN(a.x)||isNaN(a.y)||isNaN(o.x)||isNaN(o.y)||o.x<a.x||o.y<a.y||c>1e3||d>1e3){console.error("Invalid tile coordinate range:",{minTile:a,maxTile:o,bbox:r});return}if(f>ba){console.warn(`Tile count ${f} exceeds MAX_TILE_COUNT (${ba}). Aborting.`);return}const p=us(a.x,a.y,s),m=us(o.x+1,o.y+1,s),g=n({lat:p.lat,lon:p.lon}),_=n({lat:m.lat,lon:m.lon});Ke={minX:Math.min(g.x,_.x),maxX:Math.max(g.x,_.x),minZ:Math.min(g.z,_.z),maxZ:Math.max(g.z,_.z)};const h=[];for(let T=a.x;T<=o.x;T++)for(let N=a.y;N<=o.y;N++)h.push({x:T,y:N});h.sort((T,N)=>Math.hypot(T.x-l.x,T.y-l.y)-Math.hypot(N.x-l.x,N.y-l.y));const u=P_(),E=L_();console.log(`Loading ${h.length} tiles | zoom ${s} (${Qr!==null?"manual":"auto"}) | renderDist ${t} km | floorY ${u.toFixed(1)} | topo ${Ln?"ON":"OFF"}`);const y=new yg;await Promise.all(h.map(({x:T,y:N})=>j_(T,N,s,y,n,u,E).catch(()=>null))),Q_(u),console.log("Finished loading tiles.")}async function j_(i,t,e,n,r,s,a){const{tileGroup:o}=Ki(),l=Ta[Aa].url.replace("{z}",e).replace("{y}",t).replace("{x}",i),c=us(i,t,e),d=us(i+1,t+1,e),f=r({lat:c.lat,lon:c.lon}),p=r({lat:d.lat,lon:d.lon}),m=Math.abs(p.x-f.x),g=Math.abs(p.z-f.z),[_,h]=await Promise.all([k_(n,l,5e3),Ln&&a!==null?q_(i,t,e):Promise.resolve(null)]);_.wrapS=fn,_.wrapT=fn,_.minFilter=Ce,_.magFilter=Ce;const u=Ln&&h?Bc:1,E=new hi(m,g,u,u);Ln&&h&&J_(E,h,s,a,u);const y=new Ia({map:_,side:Fe,transparent:!0,opacity:hs}),T=new Be(E,y);T.rotation.x=-Math.PI/2,Ln&&h?T.position.set((f.x+p.x)/2,s,(f.z+p.z)/2):T.position.set((f.x+p.x)/2,s-.1,(f.z+p.z)/2),o.add(T)}function J_(i,t,e,n,r){const s=i.attributes.position,a=r+1,o=r+1,l=t.height,c=t.width;for(let d=0;d<a;d++)for(let f=0;f<o;f++){const p=d*o+f,m=d/(a-1)*(l-1),g=f/(o-1)*(c-1),u=(Y_(t,m,g)-n)*zc-e;s.setZ(p,u)}s.needsUpdate=!0,i.computeVertexNormals()}function Q_(i){const{scene:t}=Ki();if(De&&(t.remove(De),De.geometry.dispose(),De.material.dispose(),De=null),!Ke)return;const e=Ke.maxX-Ke.minX,n=Ke.maxZ-Ke.minZ,r=(Ke.minX+Ke.maxX)/2,s=(Ke.minZ+Ke.maxZ)/2,a=Math.max(e,n)/80;De=new Be(new hi(e,n),new Xe({uniforms:{uGridColor:{value:new _t(7829367)},uGridSize:{value:a},uLineWidth:{value:.5},uOpacity:{value:.55}},depthWrite:!1,depthTest:!0,polygonOffset:!0,polygonOffsetFactor:-8,polygonOffsetUnits:-8,transparent:!0,alphaTest:.01,blending:In,side:Fe,vertexShader:`
                varying vec3 vWorldPos;
                void main() {
            ...
            `})),De.rotation.x=-Math.PI/2,De.position.set(r,i,s),De.renderOrder=-1,t.add(De),Hc()}function Hc(){De&&(De.visible=hs<G_)}function Nl(i){const{tileGroup:t}=Ki();hs=parseFloat(i),t.children.forEach(e=>{e.material&&(e.material.opacity=hs)}),Hc()}function t0(i){i!==Aa&&Ta[i]&&(Aa=i,console.log("Switched to tile service:",Ta[i].name),vr()&&Zi())}let Wa=[],wa=[],ie=[],Ca=[],re=0,rn=!1,_n=!0,ts=null,Vi=1;const e0=100,kc=100;function di(i){return i==null||i===0?null:i<1e10?i*1e3:i}function n0(){const i=[];for(const t of wa)t&&t.length&&i.push(...t);ie=i.sort((t,e)=>{const n=di(t.time)??1/0,r=di(e.time)??1/0;return n-r})}function Fl(i){const t=di(i);return t?new Date(t).toLocaleTimeString("en-US",{hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"}):"--:--:--"}function i0(i){const t=di(ie[i]?.time),e=di(ie[i+1]?.time);return t!=null&&e!=null&&e>t?Math.max(0,(e-t)/Vi):e0/Vi}function r0(){return Wa}function s0(i){Vi=i,rn&&(ji(),Ji()),d0()}function Ra(){return{isLiveMode:_n,isPlaying:rn,currentPointIndex:re,totalLines:Wa.length,totalPoints:ie.length,progress:ie.length>0?re/(ie.length-1):0,playbackSpeed:Vi}}function Xa(i){Ca=i||[]}function Ms(i){Wa=i;const t=qc();if(t==="radar"){const e=i.join(`
`);wa=[yc(e)||[]]}else wa=i.map(e=>t==="adsb"?Sc(e)||[]:Mc(e)||[]);n0(),re=Math.max(0,ie.length-1),Qi()}function a0(){const i=document.getElementById("timeSlider");i&&ie.length>0&&(i.max=ie.length-1,_n&&(re=ie.length-1,i.value=re))}function ji(){ts!==null&&(clearTimeout(ts),ts=null)}function Ji(){if(!rn)return;if(re>=ie.length-1){$a();return}const i=i0(re);ts=setTimeout(()=>{rn&&(re++,Qi(),Mr(),Ji())},i)}function o0(){ji(),re>=ie.length-1&&(re=0),rn=!0,Vc(),Ji()}function $a(){ji(),rn=!1,Vc()}function l0(){_n&&Ss(),re=Math.max(0,re-kc),Qi(),Mr(),rn&&(ji(),Ji())}function c0(){_n&&Ss(),re=Math.min(ie.length-1,re+kc),Qi(),Mr(),rn&&(ji(),Ji())}function Ss(){_n=!1,Wc()}function Gc(){_n=!0,$a(),re=Math.max(0,ie.length-1),Qi(),Wc(),Mr()}function Mr(){qc();const i=ie.slice(0,re+1);let t=i;if(Ca.length>0){const e=di(ie[re]?.time)??1/0,n=Ca.filter(r=>(di(r.time)??1/0)<=e);t=[...i,...n]}ci(t,!1),ai(t)}function Qi(){const i=document.getElementById("timeSlider"),t=document.getElementById("timeDisplay");if(ie.length>0){const e=ie.length-1;if(i&&(i.max=e,i.value=re),t){const n=ie[re]?.time,r=ie[e]?.time;t.textContent=`${Fl(n)} / ${Fl(r)}`}}}function Vc(){const i=document.getElementById("playIcon"),t=document.getElementById("pauseIcon");rn?(i&&(i.style.display="none"),t&&(t.style.display="inline")):(i&&(i.style.display="inline"),t&&(t.style.display="none"))}function Wc(){const i=document.getElementById("goLive");i&&(i.style.opacity=_n?"0.5":"1.0",i.disabled=_n)}function d0(){const i=document.getElementById("currentSpeedDisplay");i&&(i.textContent=`${Vi}x`),document.querySelectorAll(".speed-option").forEach(t=>{t.classList.toggle("active",parseFloat(t.dataset.speed)===Vi)})}function Xc(i){_n&&Ss(),re=parseInt(i.target.value),Qi(),Mr(),rn&&(ji(),Ji())}function u0(i){const t=parseFloat(i.target.dataset.speed);if(!isNaN(t)&&t>0){s0(t);const e=document.getElementById("speedOptions");e&&e.classList.remove("show")}}function h0(){const i=document.getElementById("timeSlider");i&&(["mousedown","mousemove","mouseup","click"].forEach(t=>{i.addEventListener(t,e=>e.stopPropagation())}),i.addEventListener("input",Xc))}const f0=`<svg class="eye-icon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 576 512">\r
<path fill="currentColor" d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 92.9-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.8-35.7-46.1-87.7-92.9-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0a144 144 0 1 1-288 0zm144-64a64 64 0 1 1 0 128a64 64 0 0 1 0-128z"/></svg>`,p0=`<svg class="trash-icon" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 448 512"><path fill="currentColor" d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg>\r
`,m0=`<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 512 512">\r
<path fill="currentColor" d="M232.5 5.2c14.9-6.9 32.1-6.9 47 0l218.6 101c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L13.9 149.8C5.4 145.8 0 137.3 0 128s5.4-17.9 13.9-21.8L232.5 5.2zM48.1 218.4l164.3 75.9c27.7 12.8 59.6 12.8 87.3 0l164.3-75.9 34.1 15.8c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L13.9 277.8C5.4 273.8 0 265.3 0 256s5.4-17.9 13.9-21.8l34.1-15.8zM13.9 362.2l34.1-15.8 164.3 75.9c27.7 12.8 59.6 12.8 87.3 0l164.3-75.9 34.1 15.8c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L13.9 405.8C5.4 401.8 0 393.3 0 384s5.4-17.9 13.9-21.8z"/></svg>`,Se=new Map;let Re=null,g0=1,_0=10;const Ve=new Set;function ys(i,t){return t==="adsb"?Sc(i):t==="radar"?yc(i):Mc(i)}async function v0(){const i=[];for(const t of Ve){const e=Se.get(t);if(e)try{const r=await(await e.handle.getFile()).text();i.push(...ys(r,e.type))}catch(n){console.error(`Overlay read failed for file ${t}:`,n)}}return i}async function $c(){if(!Re)return;const i=Se.get(Re);if(i)try{const e=await(await i.handle.getFile()).text(),n=ys(e,i.type),r=await v0();Xa(r);const s=[...n,...r];if(s.length===0)return;ci(s,!1),ai(s,i.type)}catch(t){console.error("rerenderWithOverlays failed:",t)}}function x0(i){const t=Se.get(i);if(t)if(t.watcherInterval&&clearInterval(t.watcherInterval),Ve.delete(i),Se.delete(i),i===Re){const e=[...Se.keys()];e.length>0?(Re=null,Yc(e[e.length-1])):(Re=null,Ms([]),ci([]),ai([]),D_(),ui())}else(Ve.size>0||i!==Re)&&$c(),ui()}function qc(){return Re&&Se.get(Re)?.type||null}function ui(){const i=document.getElementById("fileListContainer");if(!i)return;i.innerHTML="",Se.size===0?i.style.display="none":i.style.display="flex";const t=Array.from(Se.entries());t.forEach(([r,s],a)=>{const o=r===Re,l=Ve.has(r),c=a===t.length-1,d=document.createElement("div");d.className=o?"active":"",d.dataset.fileId=r,d.style.cssText=`
        ...
        `;if(o||(f+=`
            ...
            `),d.innerHTML=f,d.addEventListener("click",p=>{p.target.closest(".trash-btn")||p.target.closest(".overlay-btn")||Yc(r)}),!o){const p=d.querySelector(".trash-btn");p&&(p.addEventListener("mouseenter",()=>{p.style.color="#e03c3c"}),p.addEventListener("mouseleave",()=>{p.style.color="#88888888"}),p.addEventListener("click",g=>{g.stopPropagation(),x0(r)}));const m=d.querySelector(".overlay-btn");m&&(m.addEventListener("mouseenter",()=>{Ve.has(r)||(m.style.color="#4e9bff")}),m.addEventListener("mouseleave",()=>{m.style.color=Ve.has(r)?"#4e9bff":"#88888888"}),m.addEventListener("click",async g=>{g.stopPropagation(),Ve.has(r)?Ve.delete(r):Ve.add(r),ui(),await $c()}))}i.appendChild(d)});const e=document.getElementById("addFileBtn");e&&(e.style.display=Se.size>0?"":"none");const n=document.getElementById("openFileBtn");n&&Se.size>0?n.style.display="none":n&&(n.style.display="")}async function Yc(i){if(i===Re)return;const t=Se.get(i);if(!t)return;Ve.clear(),Xa([]),Re=i,Oc();const n=await(await t.handle.getFile()).text(),r=t.type==="radar"?[n]:n.split(`
`).filter(o=>o.trim());Ms(r);const s=ys(n,t.type);if(s.length===0){ci([]),ai([],t.type),ui();return}Nc(s);const a=ci(s,!1);ai(s,t.type),ui(),a&&window.dispatchEvent(new CustomEvent("fileLoaded",{detail:a}))}async function M0(i){const t=Se.get(i);if(!(!t||!t.handle||t.isWatcherRunning)&&t.type!=="radar"){t.isWatcherRunning=!0;try{const e=await t.handle.getFile();if(e.size>t.readOffset){const n=await e.slice(t.readOffset).text();if(t.readOffset=e.size,n.length>0&&i===Re){const r=n.split(`
`).filter(a=>a.trim()),s=[...r0(),...r];Ms(s),Ra().isLiveMode?Gc():a0()}}}catch(e){console.error(`Error watching file ${i}:`,e)}finally{t.isWatcherRunning=!1}}}function S0(i){const t=Se.get(i);!t||t.type==="radar"||(t.watcherInterval&&clearInterval(t.watcherInterval),t.watcherInterval=setInterval(()=>M0(i),_0))}async function Ol(i){try{const[t]=await window.showOpenFilePicker({types:[{accept:{"text/plain":[".txt",".log",".csv",".ubx",".crswap",".bin",".json",".ndjson"]}}],multiple:!1});if(!t)return!1;const e=await t.getFile(),n=await e.text();let r;Hg(n)?r="radar":(r=Ng(n),r==="unknown"&&(r="nmea"));const s=g0++;Se.set(s,{id:s,handle:t,name:e.name,type:r,readOffset:e.size,watcherInterval:null,isWatcherRunning:!1}),Ve.clear(),Xa([]),Re=s,Oc(null);const a=r==="radar"?[n]:n.split(`
`).filter(c=>c.trim());Ms(a);const o=ys(n,r);if(o.length===0)return alert("No valid GPS / ADS-B / Radar points found."),ci([]),ai([],r),ui(),!1;Nc(o);const l=ci(o,!1);return ai(o,r),ui(),i&&l&&i(l),S0(s),!0}catch(t){return t.name!=="AbortError"&&console.error("File selection failed:",t),!1}}function y0(){const i=d=>{window.dispatchEvent(new CustomEvent("fileLoaded",{detail:d}))},t=document.getElementById("openFileBtn");t&&t.addEventListener("click",()=>Ol(i));const e=document.getElementById("addFileBtn");e&&e.addEventListener("click",()=>Ol(i));const n=document.getElementById("rewind");n&&n.addEventListener("click",l0);const r=document.getElementById("playPause");r&&r.addEventListener("click",()=>{Ra().isLiveMode&&Ss(),Ra().isPlaying?$a():o0()});const s=document.getElementById("forward");s&&s.addEventListener("click",c0);const a=document.getElementById("goLive");a&&a.addEventListener("click",Gc);const o=document.getElementById("timeSlider");o&&(o.addEventListener("input",Xc),h0());const l=document.getElementById("adjustSpeed"),c=document.getElementById("speedOptions");l&&c&&(l.addEventListener("click",d=>{d.stopPropagation(),c.classList.toggle("show")}),document.querySelectorAll(".speed-option").forEach(d=>{d.addEventListener("click",u0)}),window.addEventListener("click",()=>c.classList.remove("show")))}document.getElementById("topo-toggle").addEventListener("change",i=>{$_(i.target.checked)});document.getElementById("topo-scale").addEventListener("change",i=>{W_(i.target.value)});document.getElementById("topo-segments").addEventListener("change",i=>{X_(i.target.value)});function E0(){T0(),b0(),A0()}const es=document.getElementById("topo-segments"),Bl=1,zl=256;let or=parseInt(es.value,10);es.addEventListener("change",()=>{let i=parseInt(es.value,10);isNaN(i)||(i>or?i=or*2:i<or&&(i=Math.floor(or/2)),i>zl&&(i=zl),i<Bl&&(i=Bl),es.value=i,or=i)});function T0(){const i=document.getElementById("opacitySlider");i&&(i.value=xr.initialOpacity,Nl(i.value),i.addEventListener("input",t=>{Nl(t.target.value)}))}function A0(){document.querySelectorAll(".view-option").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".view-option").forEach(e=>e.classList.remove("active")),i.classList.add("active");const t=i.dataset.view;t0(t)})})}function b0(){const i=document.getElementById("renderMinus"),t=document.getElementById("renderPlus"),e=document.getElementById("renderValue");let n=xr.initialRenderDistance;const r=1,s=50,a=()=>{e&&(e.textContent=n),i&&(i.disabled=n<=r),t&&(t.disabled=n>=s)},o=l=>{n=Math.max(r,Math.min(s,l)),a(),Zi()};i&&i.addEventListener("click",()=>o(n-1)),t&&t.addEventListener("click",()=>o(n+1)),window.getCurrentRenderDistance=()=>n,a()}let Hl=!1;function w0(){const{controls:i}=Ki();window.addEventListener("resize",H_),window.addEventListener("fileLoaded",t=>{const e=t.detail;e&&(Hl||(z_(),Lg(),Hl=!0),i.reset(e.dataSpan,e.firstPointVec),Zi())}),T_(),y0(),E0()}function C0(){B_();const{dataGroup:i}=Ki();C_(i),w0(),console.log("Application initialized successfully")}C0();document.addEventListener("DOMContentLoaded",()=>{const i=document.querySelectorAll(".slider-wrapper"),t=e=>{const n=e.querySelector('input[type="range"]'),r=e.querySelector(".slider-tooltip");if(!n||!r)return;document.body.appendChild(r);const s=()=>{const a=parseFloat(n.value),o=parseFloat(n.min||0),l=parseFloat(n.max||1),d=parseFloat(n.step||.1)<1||a%1!==0;r.textContent=d?a.toFixed(1):a;const f=n.getBoundingClientRect(),p=16,m=10,g=l-o,_=g===0?0:(a-o)/g,h=f.width-p,u=_*h,E=f.left+u+p+m,y=f.top+f.height/2-r.offsetHeight/2;r.style.position="fixed",r.style.left=`${E-5}px`,r.style.top=`${y}px`,r.style.zIndex="99999999"};e.addEventListener("mouseenter",()=>{s(),r.style.opacity="1"}),e.addEventListener("mouseleave",()=>{r.style.opacity="0"}),n.addEventListener("input",s),s()};i.forEach(e=>{t(e)})});class fs{constructor(){this.validCount=0,this.invalidCount=0}validateNMEAChecksum(t){if(t=t.trim(),!t.startsWith("$")||!t.includes("*"))return!1;const e=t.split("*");if(e.length!==2)return!1;const n=e[0].substring(1),r=e[1],s=parseInt(r,16);if(isNaN(s))return!1;let a=0;for(let o=0;o<n.length;o++)a^=n.charCodeAt(o);return a===s}extractTalkerID(t){try{const e=t.trim();if(!e.startsWith("$"))return null;const n=e.indexOf(",");return n===-1?null:e.substring(1,n)}catch{return null}}sortNMEAData(t,e=null){const n={};this.validCount=0,this.invalidCount=0;for(const r of t)if(!(!r||r.trim().length===0))if(this.validateNMEAChecksum(r)){this.validCount++;const s=this.extractTalkerID(r);s?(n[s]||(n[s]=[],console.log(`Creating entry for valid talker ID: ${s}`)),n[s].push(r.trim())):this.invalidCount++}else this.invalidCount++;return console.log(`
