...
`].filter(hr).join(`
`)),a=La(a),a=Ol(a,e),a=Bl(a,e),o=La(o),o=Ol(o,e),o=Bl(o,e),a=zl(a),o=zl(o),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+f);const y=M+p+a,w=M+f+o,U=Nl(r,r.VERTEX_SHADER,y),T=Nl(r,r.FRAGMENT_SHADER,w);r.attachShader(_,U),r.attachShader(_,T),e.index0AttributeName!==void 0?r.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function C(A){if(n.debug.checkShaderErrors){const B=r.getProgramInfoLog(_).trim(),F=r.getShaderInfoLog(U).trim(),V=r.getShaderInfoLog(T).trim();let $=!0,k=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if($=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,U,T);else{const Z=Fl(r,U,"vertex"),G=Fl(r,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`;function kg(n,t,e){let i=new Za;const r=new Ot,s=new Ot,a=new he,o=new Og({depthPacking:Nu}),l=new Bg,c={},d=e.maxTextureSize,u={[Gn]:we,[we]:Gn,[Be]:Be},h=new Ye({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ot},radius:{value:4}},vertexShader:zg,fragmentShader:Hg}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const g=new Se;g.setAttribute("position",new Le(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ve(g,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=yc;let f=this.type;this.render=function(T,C,D){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||T.length===0)return;const v=n.getRenderTarget(),x=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),B=n.state;B.setBlending(Sn),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const F=f!==gn&&this.type===gn,V=f===gn&&this.type!==gn;for(let $=0,k=T.length;$<k;$++){const Z=T[$],G=Z.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const dt=G.getFrameExtents();if(r.multiply(dt),s.copy(G.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/dt.x),r.x=s.x*dt.x,G.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/dt.y),r.y=s.y*dt.y,G.mapSize.y=s.y)),G.map===null||F===!0||V===!0){const ut=this.type!==gn?{minFilter:He,magFilter:He}:{};G.map!==null&&G.map.dispose(),G.map=new hi(r.x,r.y,ut),G.map.texture.name=Z.name+".shadowMap",G.camera.updateProjectionMatrix()}n.setRenderTarget(G.map),n.clear();const ct=G.getViewportCount();for(let ut=0;ut<ct;ut++){const Dt=G.getViewport(ut);a.set(s.x*Dt.x,s.y*Dt.y,s.x*Dt.z,s.y*Dt.w),B.viewport(a),G.updateMatrices(Z,ut),i=G.getFrustum(),w(C,D,G.camera,Z,this.type)}G.isPointLightShadow!==!0&&this.type===gn&&M(G,D),G.needsUpdate=!1}f=this.type,p.needsUpdate=!1,n.setRenderTarget(v,x,A)};function M(T,C){const D=t.update(_);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,m.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new hi(r.x,r.y)),h.uniforms.shadow_pass.value=T.map.texture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(C,null,D,h,_,null),m.uniforms.shadow_pass.value=T.mapPass.texture,m.uniforms.resolution.value=T.mapSize,m.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(C,null,D,m,_,null)}function y(T,C,D,v){let x=null;const A=D.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(A!==void 0)x=A;else if(x=D.isPointLight===!0?l:o,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const B=x.uuid,F=C.uuid;let V=c[B];V===void 0&&(V={},c[B]=V);let $=V[F];$===void 0&&($=x.clone(),V[F]=$,C.addEventListener("dispose",U)),x=$}if(x.visible=C.visible,x.wireframe=C.wireframe,v===gn?x.side=C.shadowSide!==null?C.shadowSide:C.side:x.side=C.shadowSide!==null?C.shadowSide:u[C.side],x.alphaMap=C.alphaMap,x.alphaTest=C.alphaTest,x.map=C.map,x.clipShadows=C.clipShadows,x.clippingPlanes=C.clippingPlanes,x.clipIntersection=C.clipIntersection,x.displacementMap=C.displacementMap,x.displacementScale=C.displacementScale,x.displacementBias=C.displacementBias,x.wireframeLinewidth=C.wireframeLinewidth,x.linewidth=C.linewidth,D.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const B=n.properties.get(x);B.light=D}return x}function w(T,C,D,v,x){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&x===gn)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,T.matrixWorld);const F=t.update(T),V=T.material;if(Array.isArray(V)){const $=F.groups;for(let k=0,Z=$.length;k<Z;k++){const G=$[k],dt=V[G.materialIndex];if(dt&&dt.visible){const ct=y(T,dt,v,x);T.onBeforeShadow(n,T,C,D,F,ct,G),n.renderBufferDirect(D,null,F,ct,T,G),T.onAfterShadow(n,T,C,D,F,ct,G)}}}else if(V.visible){const $=y(T,V,v,x);T.onBeforeShadow(n,T,C,D,F,$,null),n.renderBufferDirect(D,null,F,$,T,null),T.onAfterShadow(n,T,C,D,F,$,null)}}const B=T.children;for(let F=0,V=B.length;F<V;F++)w(B[F],C,D,v,x)}function U(T){T.target.removeEventListener("dispose",U);for(const D in c){const v=c[D],x=T.target.uuid;x in v&&(v[x].dispose(),delete v[x])}}}function Gg(n){function t(){let R=!1;const ot=new he;let X=null;const q=new he(0,0,0,0);return{setMask:function(et){X!==et&&!R&&(n.colorMask(et,et,et,et),X=et)},setLocked:function(et){R=et},setClear:function(et,wt,kt,ee,ce){ce===!0&&(et*=ee,wt*=ee,kt*=ee),ot.set(et,wt,kt,ee),q.equals(ot)===!1&&(n.clearColor(et,wt,kt,ee),q.copy(ot))},reset:function(){R=!1,X=null,q.set(-1,0,0,0)}}}function e(){let R=!1,ot=null,X=null,q=null;return{setTest:function(et){et?ht(n.DEPTH_TEST):st(n.DEPTH_TEST)},setMask:function(et){ot!==et&&!R&&(n.depthMask(et),ot=et)},setFunc:function(et){if(X!==et){switch(et){case ou:n.depthFunc(n.NEVER);break;case lu:n.depthFunc(n.ALWAYS);break;case cu:n.depthFunc(n.LESS);break;case hs:n.depthFunc(n.LEQUAL);break;case du:n.depthFunc(n.EQUAL);break;case uu:n.depthFunc(n.GEQUAL);break;case hu:n.depthFunc(n.GREATER);break;case fu:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}X=et}},setLocked:function(et){R=et},setClear:function(et){q!==et&&(n.clearDepth(et),q=et)},reset:function(){R=!1,ot=null,X=null,q=null}}}function i(){let R=!1,ot=null,X=null,q=null,et=null,wt=null,kt=null,ee=null,ce=null;return{setTest:function($t){R||($t?ht(n.STENCIL_TEST):st(n.STENCIL_TEST))},setMask:function($t){ot!==$t&&!R&&(n.stencilMask($t),ot=$t)},setFunc:function($t,Ke,je){(X!==$t||q!==Ke||et!==je)&&(n.stencilFunc($t,Ke,je),X=$t,q=Ke,et=je)},setOp:function($t,Ke,je){(wt!==$t||kt!==Ke||ee!==je)&&(n.stencilOp($t,Ke,je),wt=$t,kt=Ke,ee=je)},setLocked:function($t){R=$t},setClear:function($t){ce!==$t&&(n.clearStencil($t),ce=$t)},reset:function(){R=!1,ot=null,X=null,q=null,et=null,wt=null,kt=null,ee=null,ce=null}}}const r=new t,s=new e,a=new i,o=new WeakMap,l=new WeakMap;let c={},d={},u=new WeakMap,h=[],m=null,g=!1,_=null,p=null,f=null,M=null,y=null,w=null,U=null,T=new pt(0,0,0),C=0,D=!1,v=null,x=null,A=null,B=null,F=null;const V=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,k=0;const Z=n.getParameter(n.VERSION);Z.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(Z)[1]),$=k>=1):Z.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),$=k>=2);let G=null,dt={};const ct=n.getParameter(n.SCISSOR_BOX),ut=n.getParameter(n.VIEWPORT),Dt=new he().fromArray(ct),Gt=new he().fromArray(ut);function W(R,ot,X,q){const et=new Uint8Array(4),wt=n.createTexture();n.bindTexture(R,wt),n.texParameteri(R,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(R,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let kt=0;kt<X;kt++)R===n.TEXTURE_3D||R===n.TEXTURE_2D_ARRAY?n.texImage3D(ot,0,n.RGBA,1,1,q,0,n.RGBA,n.UNSIGNED_BYTE,et):n.texImage2D(ot+kt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,et);return wt}const J={};J[n.TEXTURE_2D]=W(n.TEXTURE_2D,n.TEXTURE_2D,1),J[n.TEXTURE_CUBE_MAP]=W(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[n.TEXTURE_2D_ARRAY]=W(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),J[n.TEXTURE_3D]=W(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),ht(n.DEPTH_TEST),s.setFunc(hs),St(!1),Ht(wo),ht(n.CULL_FACE),Nt(Sn);function ht(R){c[R]!==!0&&(n.enable(R),c[R]=!0)}function st(R){c[R]!==!1&&(n.disable(R),c[R]=!1)}function Pt(R,ot){return d[R]!==ot?(n.bindFramebuffer(R,ot),d[R]=ot,R===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=ot),R===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=ot),!0):!1}function Ct(R,ot){let X=h,q=!1;if(R){X=u.get(ot),X===void 0&&(X=[],u.set(ot,X));const et=R.textures;if(X.length!==et.length||X[0]!==n.COLOR_ATTACHMENT0){for(let wt=0,kt=et.length;wt<kt;wt++)X[wt]=n.COLOR_ATTACHMENT0+wt;X.length=et.length,q=!0}}else X[0]!==n.BACK&&(X[0]=n.BACK,q=!0);q&&n.drawBuffers(X)}function zt(R){return m!==R?(n.useProgram(R),m=R,!0):!1}const L={[ii]:n.FUNC_ADD,[Wd]:n.FUNC_SUBTRACT,[Xd]:n.FUNC_REVERSE_SUBTRACT};L[$d]=n.MIN,L[qd]=n.MAX;const Bt={[Yd]:n.ZERO,[Kd]:n.ONE,[jd]:n.SRC_COLOR,[Ea]:n.SRC_ALPHA,[nu]:n.SRC_ALPHA_SATURATE,[tu]:n.DST_COLOR,[Jd]:n.DST_ALPHA,[Zd]:n.ONE_MINUS_SRC_COLOR,[wa]:n.ONE_MINUS_SRC_ALPHA,[eu]:n.ONE_MINUS_DST_COLOR,[Qd]:n.ONE_MINUS_DST_ALPHA,[iu]:n.CONSTANT_COLOR,[ru]:n.ONE_MINUS_CONSTANT_COLOR,[su]:n.CONSTANT_ALPHA,[au]:n.ONE_MINUS_CONSTANT_ALPHA};function Nt(R,ot,X,q,et,wt,kt,ee,ce,$t){if(R===Sn){g===!0&&(st(n.BLEND),g=!1);return}if(g===!1&&(ht(n.BLEND),g=!0),R!==Vd){if(R!==_||$t!==D){if((p!==ii||y!==ii)&&(n.blendEquation(n.FUNC_ADD),p=ii,y=ii),$t)switch(R){case Bn:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case To:n.blendFunc(n.ONE,n.ONE);break;case bo:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ao:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case Bn:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case To:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case bo:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ao:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}f=null,M=null,w=null,U=null,T.set(0,0,0),C=0,_=R,D=$t}return}et=et||ot,wt=wt||X,kt=kt||q,(ot!==p||et!==y)&&(n.blendEquationSeparate(L[ot],L[et]),p=ot,y=et),(X!==f||q!==M||wt!==w||kt!==U)&&(n.blendFuncSeparate(Bt[X],Bt[q],Bt[wt],Bt[kt]),f=X,M=q,w=wt,U=kt),(ee.equals(T)===!1||ce!==C)&&(n.blendColor(ee.r,ee.g,ee.b,ce),T.copy(ee),C=ce),_=R,D=!1}function jt(R,ot){R.side===Be?st(n.CULL_FACE):ht(n.CULL_FACE);let X=R.side===we;ot&&(X=!X),St(X),R.blending===Bn&&R.transparent===!1?Nt(Sn):Nt(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),s.setFunc(R.depthFunc),s.setTest(R.depthTest),s.setMask(R.depthWrite),r.setMask(R.colorWrite);const q=R.stencilWrite;a.setTest(q),q&&(a.setMask(R.stencilWriteMask),a.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),a.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),Tt(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?ht(n.SAMPLE_ALPHA_TO_COVERAGE):st(n.SAMPLE_ALPHA_TO_COVERAGE)}function St(R){v!==R&&(R?n.frontFace(n.CW):n.frontFace(n.CCW),v=R)}function Ht(R){R!==Hd?(ht(n.CULL_FACE),R!==x&&(R===wo?n.cullFace(n.BACK):R===kd?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):st(n.CULL_FACE),x=R}function It(R){R!==A&&($&&n.lineWidth(R),A=R)}function Tt(R,ot,X){R?(ht(n.POLYGON_OFFSET_FILL),(B!==ot||F!==X)&&(n.polygonOffset(ot,X),B=ot,F=X)):st(n.POLYGON_OFFSET_FILL)}function ne(R){R?ht(n.SCISSOR_TEST):st(n.SCISSOR_TEST)}function b(R){R===void 0&&(R=n.TEXTURE0+V-1),G!==R&&(n.activeTexture(R),G=R)}function S(R,ot,X){X===void 0&&(G===null?X=n.TEXTURE0+V-1:X=G);let q=dt[X];q===void 0&&(q={type:void 0,texture:void 0},dt[X]=q),(q.type!==R||q.texture!==ot)&&(G!==X&&(n.activeTexture(X),G=X),n.bindTexture(R,ot||J[R]),q.type=R,q.texture=ot)}function H(){const R=dt[G];R!==void 0&&R.type!==void 0&&(n.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function Y(){try{n.compressedTexImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function K(){try{n.compressedTexImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function j(){try{n.texSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function vt(){try{n.texSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function it(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function rt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Rt(){try{n.texStorage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Q(){try{n.texStorage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function gt(){try{n.texImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ut(){try{n.texImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Et(R){Dt.equals(R)===!1&&(n.scissor(R.x,R.y,R.z,R.w),Dt.copy(R))}function at(R){Gt.equals(R)===!1&&(n.viewport(R.x,R.y,R.z,R.w),Gt.copy(R))}function Lt(R,ot){let X=l.get(ot);X===void 0&&(X=new WeakMap,l.set(ot,X));let q=X.get(R);q===void 0&&(q=n.getUniformBlockIndex(ot,R.name),X.set(R,q))}function Ft(R,ot){const q=l.get(ot).get(R);o.get(ot)!==q&&(n.uniformBlockBinding(ot,q,R.__bindingPointIndex),o.set(ot,q))}function te(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},G=null,dt={},d={},u=new WeakMap,h=[],m=null,g=!1,_=null,p=null,f=null,M=null,y=null,w=null,U=null,T=new pt(0,0,0),C=0,D=!1,v=null,x=null,A=null,B=null,F=null,Dt.set(0,0,n.canvas.width,n.canvas.height),Gt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:ht,disable:st,bindFramebuffer:Pt,drawBuffers:Ct,useProgram:zt,setBlending:Nt,setMaterial:jt,setFlipSided:St,setCullFace:Ht,setLineWidth:It,setPolygonOffset:Tt,setScissorTest:ne,activeTexture:b,bindTexture:S,unbindTexture:H,compressedTexImage2D:Y,compressedTexImage3D:K,texImage2D:gt,texImage3D:Ut,updateUBOMapping:Lt,uniformBlockBinding:Ft,texStorage2D:Rt,texStorage3D:Q,texSubImage2D:j,texSubImage3D:vt,compressedTexSubImage2D:it,compressedTexSubImage3D:rt,scissor:Et,viewport:at,reset:te}}function Vg(n,t,e,i,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ot,d=new WeakMap;let u;const h=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,S){return m?new OffscreenCanvas(b,S):mr("canvas")}function _(b,S,H){let Y=1;const K=ne(b);if((K.width>H||K.height>H)&&(Y=H/Math.max(K.width,K.height)),Y<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const j=Math.floor(Y*K.width),vt=Math.floor(Y*K.height);u===void 0&&(u=g(j,vt));const it=S?g(j,vt):u;return it.width=j,it.height=vt,it.getContext("2d").drawImage(b,0,0,j,vt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+j+"x"+vt+")."),it}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),b;return b}function p(b){return b.generateMipmaps&&b.minFilter!==He&&b.minFilter!==Re}function f(b){n.generateMipmap(b)}function M(b,S,H,Y,K=!1){if(b!==null){if(n[b]!==void 0)return n[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let j=S;if(S===n.RED&&(H===n.FLOAT&&(j=n.R32F),H===n.HALF_FLOAT&&(j=n.R16F),H===n.UNSIGNED_BYTE&&(j=n.R8)),S===n.RED_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.R8UI),H===n.UNSIGNED_SHORT&&(j=n.R16UI),H===n.UNSIGNED_INT&&(j=n.R32UI),H===n.BYTE&&(j=n.R8I),H===n.SHORT&&(j=n.R16I),H===n.INT&&(j=n.R32I)),S===n.RG&&(H===n.FLOAT&&(j=n.RG32F),H===n.HALF_FLOAT&&(j=n.RG16F),H===n.UNSIGNED_BYTE&&(j=n.RG8)),S===n.RG_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.RG8UI),H===n.UNSIGNED_SHORT&&(j=n.RG16UI),H===n.UNSIGNED_INT&&(j=n.RG32UI),H===n.BYTE&&(j=n.RG8I),H===n.SHORT&&(j=n.RG16I),H===n.INT&&(j=n.RG32I)),S===n.RGB&&H===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),S===n.RGBA){const vt=K?ps:Xt.getTransfer(Y);H===n.FLOAT&&(j=n.RGBA32F),H===n.HALF_FLOAT&&(j=n.RGBA16F),H===n.UNSIGNED_BYTE&&(j=vt===Yt?n.SRGB8_ALPHA8:n.RGBA8),H===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),H===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function y(b,S){let H;return b?S===null||S===Vi||S===Wi?H=n.DEPTH24_STENCIL8:S===Dn?H=n.DEPTH32F_STENCIL8:S===fs&&(H=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Vi||S===Wi?H=n.DEPTH_COMPONENT24:S===Dn?H=n.DEPTH_COMPONENT32F:S===fs&&(H=n.DEPTH_COMPONENT16),H}function w(b,S){return p(b)===!0||b.isFramebufferTexture&&b.minFilter!==He&&b.minFilter!==Re?Math.log2(Math.max(S.width,S.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?S.mipmaps.length:1}function U(b){const S=b.target;S.removeEventListener("dispose",U),C(S),S.isVideoTexture&&d.delete(S)}function T(b){const S=b.target;S.removeEventListener("dispose",T),v(S)}function C(b){const S=i.get(b);if(S.__webglInit===void 0)return;const H=b.source,Y=h.get(H);if(Y){const K=Y[S.__cacheKey];K.usedTimes--,K.usedTimes===0&&D(b),Object.keys(Y).length===0&&h.delete(H)}i.remove(b)}function D(b){const S=i.get(b);n.deleteTexture(S.__webglTexture);const H=b.source,Y=h.get(H);delete Y[S.__cacheKey],a.memory.textures--}function v(b){const S=i.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(S.__webglFramebuffer[Y]))for(let K=0;K<S.__webglFramebuffer[Y].length;K++)n.deleteFramebuffer(S.__webglFramebuffer[Y][K]);else n.deleteFramebuffer(S.__webglFramebuffer[Y]);S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer[Y])}else{if(Array.isArray(S.__webglFramebuffer))for(let Y=0;Y<S.__webglFramebuffer.length;Y++)n.deleteFramebuffer(S.__webglFramebuffer[Y]);else n.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&n.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Y=0;Y<S.__webglColorRenderbuffer.length;Y++)S.__webglColorRenderbuffer[Y]&&n.deleteRenderbuffer(S.__webglColorRenderbuffer[Y]);S.__webglDepthRenderbuffer&&n.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const H=b.textures;for(let Y=0,K=H.length;Y<K;Y++){const j=i.get(H[Y]);j.__webglTexture&&(n.deleteTexture(j.__webglTexture),a.memory.textures--),i.remove(H[Y])}i.remove(b)}let x=0;function A(){x=0}function B(){const b=x;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),x+=1,b}function F(b){const S=[];return S.push(b.wrapS),S.push(b.wrapT),S.push(b.wrapR||0),S.push(b.magFilter),S.push(b.minFilter),S.push(b.anisotropy),S.push(b.internalFormat),S.push(b.format),S.push(b.type),S.push(b.generateMipmaps),S.push(b.premultiplyAlpha),S.push(b.flipY),S.push(b.unpackAlignment),S.push(b.colorSpace),S.join()}function V(b,S){const H=i.get(b);if(b.isVideoTexture&&It(b),b.isRenderTargetTexture===!1&&b.version>0&&H.__version!==b.version){const Y=b.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Gt(H,b,S);return}}e.bindTexture(n.TEXTURE_2D,H.__webglTexture,n.TEXTURE0+S)}function $(b,S){const H=i.get(b);if(b.version>0&&H.__version!==b.version){Gt(H,b,S);return}e.bindTexture(n.TEXTURE_2D_ARRAY,H.__webglTexture,n.TEXTURE0+S)}function k(b,S){const H=i.get(b);if(b.version>0&&H.__version!==b.version){Gt(H,b,S);return}e.bindTexture(n.TEXTURE_3D,H.__webglTexture,n.TEXTURE0+S)}function Z(b,S){const H=i.get(b);if(b.version>0&&H.__version!==b.version){W(H,b,S);return}e.bindTexture(n.TEXTURE_CUBE_MAP,H.__webglTexture,n.TEXTURE0+S)}const G={[Aa]:n.REPEAT,[vn]:n.CLAMP_TO_EDGE,[Ca]:n.MIRRORED_REPEAT},dt={[He]:n.NEAREST,[Eu]:n.NEAREST_MIPMAP_NEAREST,[Ir]:n.NEAREST_MIPMAP_LINEAR,[Re]:n.LINEAR,[Fs]:n.LINEAR_MIPMAP_NEAREST,[oi]:n.LINEAR_MIPMAP_LINEAR},ct={[Ou]:n.NEVER,[Vu]:n.ALWAYS,[Bu]:n.LESS,[Lc]:n.LEQUAL,[zu]:n.EQUAL,[Gu]:n.GEQUAL,[Hu]:n.GREATER,[ku]:n.NOTEQUAL};function ut(b,S){if(S.type===Dn&&t.has("OES_texture_float_linear")===!1&&(S.magFilter===Re||S.magFilter===Fs||S.magFilter===Ir||S.magFilter===oi||S.minFilter===Re||S.minFilter===Fs||S.minFilter===Ir||S.minFilter===oi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(b,n.TEXTURE_WRAP_S,G[S.wrapS]),n.texParameteri(b,n.TEXTURE_WRAP_T,G[S.wrapT]),(b===n.TEXTURE_3D||b===n.TEXTURE_2D_ARRAY)&&n.texParameteri(b,n.TEXTURE_WRAP_R,G[S.wrapR]),n.texParameteri(b,n.TEXTURE_MAG_FILTER,dt[S.magFilter]),n.texParameteri(b,n.TEXTURE_MIN_FILTER,dt[S.minFilter]),S.compareFunction&&(n.texParameteri(b,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(b,n.TEXTURE_COMPARE_FUNC,ct[S.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===He||S.minFilter!==Ir&&S.minFilter!==oi||S.type===Dn&&t.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const H=t.get("EXT_texture_filter_anisotropic");n.texParameterf(b,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Dt(b,S){let H=!1;b.__webglInit===void 0&&(b.__webglInit=!0,S.addEventListener("dispose",U));const Y=S.source;let K=h.get(Y);K===void 0&&(K={},h.set(Y,K));const j=F(S);if(j!==b.__cacheKey){K[j]===void 0&&(K[j]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,H=!0),K[j].usedTimes++;const vt=K[b.__cacheKey];vt!==void 0&&(K[b.__cacheKey].usedTimes--,vt.usedTimes===0&&D(S)),b.__cacheKey=j,b.__webglTexture=K[j].texture}return H}function Gt(b,S,H){let Y=n.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Y=n.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Y=n.TEXTURE_3D);const K=Dt(b,S),j=S.source;e.bindTexture(Y,b.__webglTexture,n.TEXTURE0+H);const vt=i.get(j);if(j.version!==vt.__version||K===!0){e.activeTexture(n.TEXTURE0+H);const it=Xt.getPrimaries(Xt.workingColorSpace),rt=S.colorSpace===In?null:Xt.getPrimaries(S.colorSpace),Rt=S.colorSpace===In||it===rt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Rt);let Q=_(S.image,!1,r.maxTextureSize);Q=Tt(S,Q);const gt=s.convert(S.format,S.colorSpace),Ut=s.convert(S.type);let Et=M(S.internalFormat,gt,Ut,S.colorSpace,S.isVideoTexture);ut(Y,S);let at;const Lt=S.mipmaps,Ft=S.isVideoTexture!==!0,te=vt.__version===void 0||K===!0,R=j.dataReady,ot=w(S,Q);if(S.isDepthTexture)Et=y(S.format===Xi,S.type),te&&(Ft?e.texStorage2D(n.TEXTURE_2D,1,Et,Q.width,Q.height):e.texImage2D(n.TEXTURE_2D,0,Et,Q.width,Q.height,0,gt,Ut,null));else if(S.isDataTexture)if(Lt.length>0){Ft&&te&&e.texStorage2D(n.TEXTURE_2D,ot,Et,Lt[0].width,Lt[0].height);for(let X=0,q=Lt.length;X<q;X++)at=Lt[X],Ft?R&&e.texSubImage2D(n.TEXTURE_2D,X,0,0,at.width,at.height,gt,Ut,at.data):e.texImage2D(n.TEXTURE_2D,X,Et,at.width,at.height,0,gt,Ut,at.data);S.generateMipmaps=!1}else Ft?(te&&e.texStorage2D(n.TEXTURE_2D,ot,Et,Q.width,Q.height),R&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,Q.width,Q.height,gt,Ut,Q.data)):e.texImage2D(n.TEXTURE_2D,0,Et,Q.width,Q.height,0,gt,Ut,Q.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ft&&te&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ot,Et,Lt[0].width,Lt[0].height,Q.depth);for(let X=0,q=Lt.length;X<q;X++)if(at=Lt[X],S.format!==nn)if(gt!==null)if(Ft){if(R)if(S.layerUpdates.size>0){for(const et of S.layerUpdates){const wt=at.width*at.height;e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,X,0,0,et,at.width,at.height,1,gt,at.data.slice(wt*et,wt*(et+1)),0,0)}S.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,X,0,0,0,at.width,at.height,Q.depth,gt,at.data,0,0)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,X,Et,at.width,at.height,Q.depth,0,at.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?R&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,X,0,0,0,at.width,at.height,Q.depth,gt,Ut,at.data):e.texImage3D(n.TEXTURE_2D_ARRAY,X,Et,at.width,at.height,Q.depth,0,gt,Ut,at.data)}else{Ft&&te&&e.texStorage2D(n.TEXTURE_2D,ot,Et,Lt[0].width,Lt[0].height);for(let X=0,q=Lt.length;X<q;X++)at=Lt[X],S.format!==nn?gt!==null?Ft?R&&e.compressedTexSubImage2D(n.TEXTURE_2D,X,0,0,at.width,at.height,gt,at.data):e.compressedTexImage2D(n.TEXTURE_2D,X,Et,at.width,at.height,0,at.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?R&&e.texSubImage2D(n.TEXTURE_2D,X,0,0,at.width,at.height,gt,Ut,at.data):e.texImage2D(n.TEXTURE_2D,X,Et,at.width,at.height,0,gt,Ut,at.data)}else if(S.isDataArrayTexture)if(Ft){if(te&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ot,Et,Q.width,Q.height,Q.depth),R)if(S.layerUpdates.size>0){let X;switch(Ut){case n.UNSIGNED_BYTE:switch(gt){case n.ALPHA:X=1;break;case n.LUMINANCE:X=1;break;case n.LUMINANCE_ALPHA:X=2;break;case n.RGB:X=3;break;case n.RGBA:X=4;break;default:throw new Error(`Unknown texel size for format ${gt}.`)}break;case n.UNSIGNED_SHORT_4_4_4_4:case n.UNSIGNED_SHORT_5_5_5_1:case n.UNSIGNED_SHORT_5_6_5:X=1;break;default:throw new Error(`Unknown texel size for type ${Ut}.`)}const q=Q.width*Q.height*X;for(const et of S.layerUpdates)e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,et,Q.width,Q.height,1,gt,Ut,Q.data.slice(q*et,q*(et+1)));S.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,gt,Ut,Q.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Et,Q.width,Q.height,Q.depth,0,gt,Ut,Q.data);else if(S.isData3DTexture)Ft?(te&&e.texStorage3D(n.TEXTURE_3D,ot,Et,Q.width,Q.height,Q.depth),R&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,gt,Ut,Q.data)):e.texImage3D(n.TEXTURE_3D,0,Et,Q.width,Q.height,Q.depth,0,gt,Ut,Q.data);else if(S.isFramebufferTexture){if(te)if(Ft)e.texStorage2D(n.TEXTURE_2D,ot,Et,Q.width,Q.height);else{let X=Q.width,q=Q.height;for(let et=0;et<ot;et++)e.texImage2D(n.TEXTURE_2D,et,Et,X,q,0,gt,Ut,null),X>>=1,q>>=1}}else if(Lt.length>0){if(Ft&&te){const X=ne(Lt[0]);e.texStorage2D(n.TEXTURE_2D,ot,Et,X.width,X.height)}for(let X=0,q=Lt.length;X<q;X++)at=Lt[X],Ft?R&&e.texSubImage2D(n.TEXTURE_2D,X,0,0,gt,Ut,at):e.texImage2D(n.TEXTURE_2D,X,Et,gt,Ut,at);S.generateMipmaps=!1}else if(Ft){if(te){const X=ne(Q);e.texStorage2D(n.TEXTURE_2D,ot,Et,X.width,X.height)}R&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,gt,Ut,Q)}else e.texImage2D(n.TEXTURE_2D,0,Et,gt,Ut,Q);p(S)&&f(Y),vt.__version=j.version,S.onUpdate&&S.onUpdate(S)}b.__version=S.version}function W(b,S,H){if(S.image.length!==6)return;const Y=Dt(b,S),K=S.source;e.bindTexture(n.TEXTURE_CUBE_MAP,b.__webglTexture,n.TEXTURE0+H);const j=i.get(K);if(K.version!==j.__version||Y===!0){e.activeTexture(n.TEXTURE0+H);const vt=Xt.getPrimaries(Xt.workingColorSpace),it=S.colorSpace===In?null:Xt.getPrimaries(S.colorSpace),rt=S.colorSpace===In||vt===it?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,rt);const Rt=S.isCompressedTexture||S.image[0].isCompressedTexture,Q=S.image[0]&&S.image[0].isDataTexture,gt=[];for(let q=0;q<6;q++)!Rt&&!Q?gt[q]=_(S.image[q],!0,r.maxCubemapSize):gt[q]=Q?S.image[q].image:S.image[q],gt[q]=Tt(S,gt[q]);const Ut=gt[0],Et=s.convert(S.format,S.colorSpace),at=s.convert(S.type),Lt=M(S.internalFormat,Et,at,S.colorSpace),Ft=S.isVideoTexture!==!0,te=j.__version===void 0||Y===!0,R=K.dataReady;let ot=w(S,Ut);ut(n.TEXTURE_CUBE_MAP,S);let X;if(Rt){Ft&&te&&e.texStorage2D(n.TEXTURE_CUBE_MAP,ot,Lt,Ut.width,Ut.height);for(let q=0;q<6;q++){X=gt[q].mipmaps;for(let et=0;et<X.length;et++){const wt=X[et];S.format!==nn?Et!==null?Ft?R&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et,0,0,wt.width,wt.height,Et,wt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et,Lt,wt.width,wt.height,0,wt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ft?R&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et,0,0,wt.width,wt.height,Et,at,wt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et,Lt,wt.width,wt.height,0,Et,at,wt.data)}}}else{if(X=S.mipmaps,Ft&&te){X.length>0&&ot++;const q=ne(gt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,ot,Lt,q.width,q.height)}for(let q=0;q<6;q++)if(Q){Ft?R&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,gt[q].width,gt[q].height,Et,at,gt[q].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Lt,gt[q].width,gt[q].height,0,Et,at,gt[q].data);for(let et=0;et<X.length;et++){const kt=X[et].image[q].image;Ft?R&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et+1,0,0,kt.width,kt.height,Et,at,kt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et+1,Lt,kt.width,kt.height,0,Et,at,kt.data)}}else{Ft?R&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,Et,at,gt[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Lt,Et,at,gt[q]);for(let et=0;et<X.length;et++){const wt=X[et];Ft?R&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et+1,0,0,Et,at,wt.image[q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+q,et+1,Lt,Et,at,wt.image[q])}}}p(S)&&f(n.TEXTURE_CUBE_MAP),j.__version=K.version,S.onUpdate&&S.onUpdate(S)}b.__version=S.version}function J(b,S,H,Y,K,j){const vt=s.convert(H.format,H.colorSpace),it=s.convert(H.type),rt=M(H.internalFormat,vt,it,H.colorSpace);if(!i.get(S).__hasExternalTextures){const Q=Math.max(1,S.width>>j),gt=Math.max(1,S.height>>j);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?e.texImage3D(K,j,rt,Q,gt,S.depth,0,vt,it,null):e.texImage2D(K,j,rt,Q,gt,0,vt,it,null)}e.bindFramebuffer(n.FRAMEBUFFER,b),Ht(S)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Y,K,i.get(H).__webglTexture,0,St(S)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Y,K,i.get(H).__webglTexture,j),e.bindFramebuffer(n.FRAMEBUFFER,null)}function ht(b,S,H){if(n.bindRenderbuffer(n.RENDERBUFFER,b),S.depthBuffer){const Y=S.depthTexture,K=Y&&Y.isDepthTexture?Y.type:null,j=y(S.stencilBuffer,K),vt=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,it=St(S);Ht(S)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,it,j,S.width,S.height):H?n.renderbufferStorageMultisample(n.RENDERBUFFER,it,j,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,j,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,vt,n.RENDERBUFFER,b)}else{const Y=S.textures;for(let K=0;K<Y.length;K++){const j=Y[K],vt=s.convert(j.format,j.colorSpace),it=s.convert(j.type),rt=M(j.internalFormat,vt,it,j.colorSpace),Rt=St(S);H&&Ht(S)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Rt,rt,S.width,S.height):Ht(S)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Rt,rt,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,rt,S.width,S.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function st(b,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,b),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),V(S.depthTexture,0);const Y=i.get(S.depthTexture).__webglTexture,K=St(S);if(S.depthTexture.format===Fi)Ht(S)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0);else if(S.depthTexture.format===Xi)Ht(S)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function Pt(b){const S=i.get(b),H=b.isWebGLCubeRenderTarget===!0;if(b.depthTexture&&!S.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");st(S.__webglFramebuffer,b)}else if(H){S.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)e.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[Y]),S.__webglDepthbuffer[Y]=n.createRenderbuffer(),ht(S.__webglDepthbuffer[Y],b,!1)}else e.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer=n.createRenderbuffer(),ht(S.__webglDepthbuffer,b,!1);e.bindFramebuffer(n.FRAMEBUFFER,null)}function Ct(b,S,H){const Y=i.get(b);S!==void 0&&J(Y.__webglFramebuffer,b,b.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),H!==void 0&&Pt(b)}function zt(b){const S=b.texture,H=i.get(b),Y=i.get(S);b.addEventListener("dispose",T);const K=b.textures,j=b.isWebGLCubeRenderTarget===!0,vt=K.length>1;if(vt||(Y.__webglTexture===void 0&&(Y.__webglTexture=n.createTexture()),Y.__version=S.version,a.memory.textures++),j){H.__webglFramebuffer=[];for(let it=0;it<6;it++)if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer[it]=[];for(let rt=0;rt<S.mipmaps.length;rt++)H.__webglFramebuffer[it][rt]=n.createFramebuffer()}else H.__webglFramebuffer[it]=n.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){H.__webglFramebuffer=[];for(let it=0;it<S.mipmaps.length;it++)H.__webglFramebuffer[it]=n.createFramebuffer()}else H.__webglFramebuffer=n.createFramebuffer();if(vt)for(let it=0,rt=K.length;it<rt;it++){const Rt=i.get(K[it]);Rt.__webglTexture===void 0&&(Rt.__webglTexture=n.createTexture(),a.memory.textures++)}if(b.samples>0&&Ht(b)===!1){H.__webglMultisampledFramebuffer=n.createFramebuffer(),H.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let it=0;it<K.length;it++){const rt=K[it];H.__webglColorRenderbuffer[it]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,H.__webglColorRenderbuffer[it]);const Rt=s.convert(rt.format,rt.colorSpace),Q=s.convert(rt.type),gt=M(rt.internalFormat,Rt,Q,rt.colorSpace,b.isXRRenderTarget===!0),Ut=St(b);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ut,gt,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+it,n.RENDERBUFFER,H.__webglColorRenderbuffer[it])}n.bindRenderbuffer(n.RENDERBUFFER,null),b.depthBuffer&&(H.__webglDepthRenderbuffer=n.createRenderbuffer(),ht(H.__webglDepthRenderbuffer,b,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(j){e.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture),ut(n.TEXTURE_CUBE_MAP,S);for(let it=0;it<6;it++)if(S.mipmaps&&S.mipmaps.length>0)for(let rt=0;rt<S.mipmaps.length;rt++)J(H.__webglFramebuffer[it][rt],b,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+it,rt);else J(H.__webglFramebuffer[it],b,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+it,0);p(S)&&f(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(vt){for(let it=0,rt=K.length;it<rt;it++){const Rt=K[it],Q=i.get(Rt);e.bindTexture(n.TEXTURE_2D,Q.__webglTexture),ut(n.TEXTURE_2D,Rt),J(H.__webglFramebuffer,b,Rt,n.COLOR_ATTACHMENT0+it,n.TEXTURE_2D,0),p(Rt)&&f(n.TEXTURE_2D)}e.unbindTexture()}else{let it=n.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(it=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(it,Y.__webglTexture),ut(it,S),S.mipmaps&&S.mipmaps.length>0)for(let rt=0;rt<S.mipmaps.length;rt++)J(H.__webglFramebuffer[rt],b,S,n.COLOR_ATTACHMENT0,it,rt);else J(H.__webglFramebuffer,b,S,n.COLOR_ATTACHMENT0,it,0);p(S)&&f(it),e.unbindTexture()}b.depthBuffer&&Pt(b)}function L(b){const S=b.textures;for(let H=0,Y=S.length;H<Y;H++){const K=S[H];if(p(K)){const j=b.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,vt=i.get(K).__webglTexture;e.bindTexture(j,vt),f(j),e.unbindTexture()}}}const Bt=[],Nt=[];function jt(b){if(b.samples>0){if(Ht(b)===!1){const S=b.textures,H=b.width,Y=b.height;let K=n.COLOR_BUFFER_BIT;const j=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,vt=i.get(b),it=S.length>1;if(it)for(let rt=0;rt<S.length;rt++)e.bindFramebuffer(n.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+rt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,vt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+rt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,vt.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,vt.__webglFramebuffer);for(let rt=0;rt<S.length;rt++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),it){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,vt.__webglColorRenderbuffer[rt]);const Rt=i.get(S[rt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Rt,0)}n.blitFramebuffer(0,0,H,Y,0,0,H,Y,K,n.NEAREST),l===!0&&(Bt.length=0,Nt.length=0,Bt.push(n.COLOR_ATTACHMENT0+rt),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Bt.push(j),Nt.push(j),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Nt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Bt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),it)for(let rt=0;rt<S.length;rt++){e.bindFramebuffer(n.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+rt,n.RENDERBUFFER,vt.__webglColorRenderbuffer[rt]);const Rt=i.get(S[rt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,vt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+rt,n.TEXTURE_2D,Rt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,vt.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const S=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[S])}}}function St(b){return Math.min(r.maxSamples,b.samples)}function Ht(b){const S=i.get(b);return b.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function It(b){const S=a.render.frame;d.get(b)!==S&&(d.set(b,S),b.update())}function Tt(b,S){const H=b.colorSpace,Y=b.format,K=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||H!==Xn&&H!==In&&(Xt.getTransfer(H)===Yt?(Y!==nn||K!==Vn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),S}function ne(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=A,this.setTexture2D=V,this.setTexture2DArray=$,this.setTexture3D=k,this.setTextureCube=Z,this.rebindTextures=Ct,this.setupRenderTarget=zt,this.updateRenderTargetMipmap=L,this.updateMultisampleRenderTarget=jt,this.setupDepthRenderbuffer=Pt,this.setupFrameBufferTexture=J,this.useMultisampledRTT=Ht}function Wg(n,t){function e(i,r=In){let s;const a=Xt.getTransfer(r);if(i===Vn)return n.UNSIGNED_BYTE;if(i===Tc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===bc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===bu)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===wu)return n.BYTE;if(i===Tu)return n.SHORT;if(i===fs)return n.UNSIGNED_SHORT;if(i===wc)return n.INT;if(i===Vi)return n.UNSIGNED_INT;if(i===Dn)return n.FLOAT;if(i===bs)return n.HALF_FLOAT;if(i===Au)return n.ALPHA;if(i===Cu)return n.RGB;if(i===nn)return n.RGBA;if(i===Ru)return n.LUMINANCE;if(i===Lu)return n.LUMINANCE_ALPHA;if(i===Fi)return n.DEPTH_COMPONENT;if(i===Xi)return n.DEPTH_STENCIL;if(i===Pu)return n.RED;if(i===Ac)return n.RED_INTEGER;if(i===Iu)return n.RG;if(i===Cc)return n.RG_INTEGER;if(i===Rc)return n.RGBA_INTEGER;if(i===Os||i===Bs||i===zs||i===Hs)if(a===Yt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Os)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===zs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Hs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Os)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Bs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===zs)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Hs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Co||i===Ro||i===Lo||i===Po)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Co)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ro)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Lo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Po)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Io||i===Do||i===Uo)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Io||i===Do)return a===Yt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Uo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===No||i===Fo||i===Oo||i===Bo||i===zo||i===Ho||i===ko||i===Go||i===Vo||i===Wo||i===Xo||i===$o||i===qo||i===Yo)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===No)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Fo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Oo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Bo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===zo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ho)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ko)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Go)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Vo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Wo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Xo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$o)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===qo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Yo)return a===Yt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ks||i===Ko||i===jo)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===ks)return a===Yt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ko)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===jo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Du||i===Zo||i===Jo||i===Qo)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===ks)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Zo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Jo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Qo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Wi?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class Xg extends Oe{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class li extends ae{constructor(){super(),this.isGroup=!0,this.type="Group"}}const $g={type:"move"};class pa{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new li,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new li,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new li,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,i),f=this._getHandJoint(c,_);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}const d=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],h=d.position.distanceTo(u.position),m=.02,g=.005;c.inputState.pinching&&h>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&h<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent($g)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new li;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const qg=`
void main() {
...
`).replace(/\n{2,}/g,`
`).trim();if(e.split(`
`).length===0)return t;const r=/\$[A-Z0-9]{2}GGA,[^\r\n]*?\*[0-9A-Fa-f]{2}/g,s=e.match(r);if(!s)return t;let a={};const o=250,l=.5;for(const c of s){if(c.length>82&&c.length<86)continue;const d=c.split(",");if(!(d.length<15))try{const u=c.substring(1,3),h=d[1],m=d[2],g=d[3],_=d[4],p=d[5],f=parseInt(d[6]),M=parseInt(d[7]),y=d[8],w=d[9],U=d[10],T=d[11];if(!m||!_||!g||!p||!w||m.length<4||_.length<5||U!=="M"||isNaN(f)||f===0||isNaN(M)||M<3)continue;const C=parseFloat(y);if(isNaN(C)||C>5)continue;const D=parseFloat(m.substring(0,2)),v=parseFloat(m.substring(2));if(isNaN(D)||isNaN(v))continue;let x=D+v/60;g==="S"&&(x=-x);const A=parseFloat(_.substring(0,3)),B=parseFloat(_.substring(3));if(isNaN(A)||isNaN(B))continue;let F=A+B/60;if(p==="W"&&(F=-F),Math.abs(x)>360||Math.abs(F)>360)continue;const V=parseFloat(w),$=parseFloat(T)||0,k=parseInt(h.slice(0,2))||0,Z=parseInt(h.slice(2,4))||0,G=parseFloat(h.slice(4))||0,dt=k*3600+Z*60+G,ct={lat:x,lon:F,alt:V,time:dt,satellites:M,undulation:$,talkerId:u},ut=a[u];if(ut){const Dt=Math.abs(ct.lat-ut.lat),Gt=Math.abs(ct.lon-ut.lon);if(Dt>l||Gt>l)continue;const W=ct.time-ut.time;if(W>0&&os(ut.lat,ut.lon,ct.lat,ct.lon)/W>o)continue}t.push(ct),a[u]=ct}catch{continue}}return t}function os(n,t,e,i){const s=c=>c*(Math.PI/180),a=s(e-n),o=s(i-t),l=Math.sin(a/2)**2+Math.cos(s(n))*Math.cos(s(e))*Math.sin(o/2)**2;return 2*6371e3*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}function E_(n){return n.reduce((t,e)=>{const{talkerId:i}=e;return t[i]||(t[i]=[]),t[i].push(e),t},{})}function w_(n){if(!n||n.length===0)return null;const t=n[n.length-1],e=n[0],i=n.length,r=t.time-e.time,s=r>0?i/r:0,a=os(e.lat,e.lon,t.lat,t.lon),o=t.alt-e.alt,l=Math.sqrt(Math.pow(a,2)+Math.pow(o,2)),c=t.alt,d=t.alt+(t.undulation||0),u=t.lat,h=t.lon,m=t.satellites||0;let g=0;if(n.length>=2){const f=n[n.length-2],M=t,y=os(f.lat,f.lon,M.lat,M.lon),w=M.time-f.time;w>0&&(g=y/w)}let _=0,p=0;for(let f=1;f<n.length;f++){const M=n[f-1],y=n[f],w=os(M.lat,M.lon,y.lat,y.lon);_+=w;const U=y.alt-M.alt,T=Math.sqrt(Math.pow(w,2)+Math.pow(U,2));p+=T}return{totalPoints:i,totalDuration:r,currentAltitude:c,currentAltWsg84:d,currentLat:u,currentLon:h,currentSatellites:m,latestSpeed:g,total2DDistance:_,total3DDistance:p,rthDistance3D:l,updateRate:s,startTime:e.time,endTime:t.time}}function T_(n){const t=n.trim().split(`
...
`)+`
`),await a.close()}}catch(e){console.error("Error saving sorted files:",e),alert(`Error saving sorted files: ${e.message}`)}}updateRateDisplay(){if(!this.rateInterval)return;const t=performance.now(),e=(t-this.lastTime)/1e3;if(e>0){const i=[this.formatBytesPerSecond(this.bytesReceived/e),this.formatFileSize(this.totalBytesWritten)];this.urlActive&&i.push(`${this.trafficData.length} pkts`),this.statusMessage.textContent=i.join(" | ")}this.lastTime=t,this.bytesReceived=0}formatBytesPerSecond(t){if(t<1024)return`${t.toFixed(0)} B/s`;const e=t/1024;return e<1024?`${e.toFixed(2)} KB/s`:`${(e/1024).toFixed(2)} MB/s`}formatFileSize(t){if(t<1024)return`${t.toFixed(0)} B`;const e=t/1024;if(e<1024)return`${e.toFixed(2)} KB`;const i=e/1024;return i<1024?`${i.toFixed(2)} MB`:`${(i/1024).toFixed(2)} GB`}handleBeforeUnload(t){if(this.isRecording||this._isSurveying)return t.preventDefault(),t.returnValue="Operation in progress. Are you sure you want to leave?",t.returnValue}handlePageHide(){this._isSurveying&&this._survey?.abort(),this.isRecording&&(this.weatherRecorder.stopEmergency(),clearInterval(this.rateInterval),this.rateInterval=null,this.stopUrlPolling(),this.reader?.cancel().catch(()=>{}),this.reader=null,this.writableStream?.close().catch(()=>{}),this.writableStream=null,this.trafficWritableStream?.close().catch(()=>{}),this.trafficWritableStream=null,this.port?.close().catch(()=>{}),this.port=null,this.isRecording=!1)}}document.addEventListener("DOMContentLoaded",()=>new yx);const Ex={invincible:{head:"#ffe753",tail:"#4c9cbf",line:"#3a3b3d",showLines:!0},neon:{head:"#00FFFF",tail:"#FF00FF",line:"#00FF00",showLines:!0},elevation:{showLines:!0,isElevationBased:!0},classify:{showLines:!0,isClassifyBased:!0}},On={head:document.getElementById("trail-head-color").value,tail:document.getElementById("trail-tail-color").value,line:document.getElementById("trail-line-color").value,showLines:document.getElementById("show-lines-toggle").checked};function Mc(n){document.getElementById("trail-head-color").value=n.head,document.getElementById("trail-tail-color").value=n.tail,document.getElementById("trail-line-color").value=n.line,document.getElementById("show-lines-toggle").checked=n.showLines,ao()}function wx(n){const t=Ex[n];t&&(t.isElevationBased?u0()||(console.warn("Elevation mode failed, falling back to preset colors."),Mc(t)):t.isClassifyBased?o0():Mc(t))}document.getElementById("trail-preset").addEventListener("change",function(){const n=this.value;n?wx(n):(document.getElementById("trail-head-color").value=On.head,document.getElementById("trail-tail-color").value=On.tail,document.getElementById("trail-line-color").value=On.line,document.getElementById("show-lines-toggle").checked=On.showLines,ao())});["trail-head-color","trail-tail-color","trail-line-color"].forEach(n=>{document.getElementById(n).addEventListener("input",function(){document.getElementById("trail-preset").value="",On.head=document.getElementById("trail-head-color").value,On.tail=document.getElementById("trail-tail-color").value,On.line=document.getElementById("trail-line-color").value,ao()})});document.getElementById("show-lines-toggle").addEventListener("change",function(){On.showLines=this.checked});console.log("Trail controls with centralized refresh logic initialized");
